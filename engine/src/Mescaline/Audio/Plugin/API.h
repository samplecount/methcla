...
struct MescalineHost
{
    ...
    void (*fRegisterSynthDef)(MescalineHost* self, const char* name, MescalineSynthDef* synthDef);
};
...
static inline void MescalineHostRegisterSynthDef(MescalineHost* self, const char* name, MescalineSynthDef* synthDef)
{
    (*self->fRegisterSynthDef)(self, name, synthDef);
}
