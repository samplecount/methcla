#ifndef MESCALINE_UTILITY_HASH_HPP_INCLUDED
#define MESCALINE_UTILITY_HASH_HPP_INCLUDED

#include <boost/functional/hash.hpp>
#include <cstring>

namespace Mescaline { namespace Utility { namespace Hash
{
...
#endif // MESCALINE_UTILITY_HASH_HPP_INCLUDED