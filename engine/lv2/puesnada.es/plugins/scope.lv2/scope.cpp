...
#include <lv2/puesnada.es/plugins/scope.lv2/scope.hpp>

#define SCOPE_URI "http://mescaline.puesnada.es/lv2/plugins/sine"
...
puesnada_sine_lv2_descriptor(uint32_t index)
{
    switch (index) {
    case 0:
        return &descriptor;
