...
static NSArray* openFiles()
{
    ...
    [panel setAllowedFileTypes:[NSArray arrayWithObjects:@"aif", @"aiff",
                                                         @"mp3", @"wav", nil]];
...
static const std::vector<unichar> keys = {
    122, 97,  113, 120, 115, 119, 99, 100, 101, 118, 102, 114, 98, 103, 116,
    110, 104, 121, 109, 106, 117, 44, 107, 105, 46,  108, 111, 47, 59,  112};

static const std::vector<float> rates = {0.25, 0.5,  0.75, 0.9, 1.0,
                                         1.1,  1.25, 1.5,  2};
...
- (void)applicationDidFinishLaunching:(NSNotification*)aNotification
{
    ...
    KeyboardView* view =
        [[KeyboardView alloc] initWithFrame:NSMakeRect(100, 100, 100, 100)];
