...
namespace
    ...
    clone_msvc_exception( void * src, cpp_exception_type const & et, size_t image_base )
        ...
        if( void * dst = malloc(ti.size) )
            ...
            return methcla_boost::shared_ptr<void>(dst,exception_object_deleter(et,image_base));
            }
        else
            throw std::bad_alloc();
        }
    ...
    class
    cloned_exception:
        public methcla_boost::exception_detail::clone_base
        {
        ...
        cpp_exception_type const & et_;
        size_t image_base_;
        methcla_boost::shared_ptr<void> exc_;
        ...
        methcla_boost::exception_detail::clone_base const *
        clone() const
            {
    ...
    unsigned long
    exception_cloning_filter( int & result, methcla_boost::exception_detail::clone_base const * & ptr, void * info_ )
        {
        ...
        if( is_cpp_exception(record) )
            ...
            if( is_cpp_exception(record) && record->ExceptionInformation[2] )
                try
                    ...
                    result = methcla_boost::exception_detail::clone_current_exception_result::success;
                    }
                catch(
                std::bad_alloc & )
                    {
                    result = methcla_boost::exception_detail::clone_current_exception_result::bad_alloc;
                    }
                catch(
                ... )
                    {
                    result = methcla_boost::exception_detail::clone_current_exception_result::bad_exception;
                    }
            }
