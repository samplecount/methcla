...
extern "C" {
    ...
    void (* after_ctors )() __attribute__((section(".ctors")))     = methcla_boost::methcla_booston_process_enter;
    void (* before_dtors)() __attribute__((section(".dtors")))     = methcla_boost::methcla_booston_thread_exit;
    void (* after_dtors )() __attribute__((section(".dtors.zzz"))) = methcla_boost::methcla_booston_process_exit;
...
#pragma warning(pop)
        ...
        {
            //Schedule methcla_booston_thread_exit() to be called for the main
            ...
            atexit(methcla_boost::methcla_booston_thread_exit);
