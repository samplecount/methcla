...
BOOST_FILESYSTEM_DECL methcla_boost::system::error_category const& codecvt_error_category() noexcept
{
    static
...
{
    codecvt_error_category_initializer() { methcla_boost::filesystem::codecvt_error_category(); }
};
