...
// This example illustrates how to use methcla_boost::hash_combine to generate a hash
...
public:
    ...
    friend std::size_t hash_value(point const& p)
    {
        ...
        methcla_boost::hash_combine(seed, p.x);
        methcla_boost::hash_combine(seed, p.y);
...
int main()
{
    methcla_boost::hash<point> point_hasher;
