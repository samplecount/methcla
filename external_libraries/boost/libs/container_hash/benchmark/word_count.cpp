...
static void init_words()
{
    ...
    methcla_boost::regex re( "[a-zA-Z]+");
    methcla_boost::sregex_token_iterator it( in.begin(), in.end(), re, 0 ), end;
...
template<class Hash> BOOST_NOINLINE void test( char const* label )
{
    ...
    methcla_boost::unordered_flat_map<std::string_view, std::size_t, Hash> map;
...
int main()
{
    ...
    test< methcla_boost::hash<std::string_view> >( "methcla_boost::hash" );
