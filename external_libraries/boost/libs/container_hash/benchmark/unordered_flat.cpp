...
static void init_indices()
{
    ...
    {
        methcla_boost::detail::splitmix64 rng;
...
template<class Hash> BOOST_NOINLINE void test( char const* label )
{
    ...
    methcla_boost::unordered_flat_map<std::string, std::uint32_t, Hash> map;
...
int main()
{
    ...
    test< methcla_boost::hash<std::string> >( "methcla_boost::hash" );
