...
public:
    ...
    virtual methcla_boost::detail::shared_count local_cb_get_shared_count() const noexcept = 0;
...
public:
    ...
    methcla_boost::detail::shared_count local_cb_get_shared_count() const noexcept override
    {
        return pn_;
    }
};
