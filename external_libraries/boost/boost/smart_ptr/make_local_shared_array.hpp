...
make_local_shared()
{
    return methcla_boost::allocate_local_shared<T>(methcla_boost::default_allocator<typename
...
{
    return methcla_boost::allocate_local_shared_noinit<T>(methcla_boost::
