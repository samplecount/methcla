...
make_shared()
{
    return methcla_boost::allocate_shared<T>(methcla_boost::default_allocator<typename
...
make_shared_noinit()
{
    return methcla_boost::allocate_shared_noinit<T>(methcla_boost::default_allocator<typename
        detail::sp_array_element<T>::type>());
}
