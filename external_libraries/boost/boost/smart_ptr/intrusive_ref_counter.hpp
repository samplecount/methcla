...
{
    typedef methcla_boost::detail::atomic_count type;

    static unsigned int load(methcla_boost::detail::atomic_count const& counter) noexcept
    {
        return static_cast< unsigned int >(static_cast< long >(counter));
    }

    static void increment(methcla_boost::detail::atomic_count& counter) noexcept
    {
        ++counter;
    }

    static unsigned int decrement(methcla_boost::detail::atomic_count& counter) noexcept
    {
