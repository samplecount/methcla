...
private:
    ...
    methcla_boost::shared_ptr<basic_chset<CharT> > ptr;
};
...
//////////////////////////////////
inline chset< ::methcla_boost::long_long_type>
chset_p( ::methcla_boost::long_long_type ch)
{ return chset< ::methcla_boost::long_long_type>(ch); }

//////////////////////////////////
inline chset< ::methcla_boost::ulong_long_type>
chset_p( ::methcla_boost::ulong_long_type ch)
{ return chset< ::methcla_boost::ulong_long_type>(ch); }
#endif
