...
public:
    ...
    ref_wrapper(T& value) noexcept :
        m_value(methcla_boost::addressof(value))
    {
    }
...
public:
    ...
    {
        internal_resource_type* p = methcla_boost::addressof(m_resource);
...
private:
    ...
    {
        methcla_boost::core::invoke_swap(get_internal_resource(), that.get_internal_resource());
        methcla_boost::core::invoke_swap(get_internal_deleter(), that.get_internal_deleter());
    }
...
private:
    ...
    void swap_impl(unique_resource_data& that, std::true_type, std::true_type) noexcept
    {
        methcla_boost::core::invoke_swap(get_internal_resource(), that.get_internal_resource());
        methcla_boost::core::invoke_swap(get_internal_deleter(), that.get_internal_deleter());
        methcla_boost::core::invoke_swap(m_allocated, that.m_allocated);
    }
