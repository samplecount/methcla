...
inline bool std_category::equivalent( int code, const std::error_condition & condition ) const noexcept
{
    ...
    {
        methcla_boost::system::error_condition bn( condition.value(), *pc_ );
        return pc_->equivalent( code, bn );
    }
    else if( condition.category() == std::generic_category() || condition.category() == methcla_boost::system::generic_category() )
    {
        methcla_boost::system::error_condition bn( condition.value(), methcla_boost::system::generic_category() );
        return pc_->equivalent( code, bn );
    }
    ...
    {
        methcla_boost::system::error_condition bn( condition.value(), *pc2->pc_ );
        return pc_->equivalent( code, bn );
    }
...
inline bool std_category::equivalent( const std::error_code & code, int condition ) const noexcept
{
    ...
    {
        methcla_boost::system::error_code bc( code.value(), *pc_ );
        return pc_->equivalent( bc, condition );
    }
    else if( code.category() == std::generic_category() || code.category() == methcla_boost::system::generic_category() )
    {
        methcla_boost::system::error_code bc( code.value(), methcla_boost::system::generic_category() );
        return pc_->equivalent( bc, condition );
    }
    ...
    {
        methcla_boost::system::error_code bc( code.value(), *pc2->pc_ );
        return pc_->equivalent( bc, condition );
    }

#endif

    else if( *pc_ == methcla_boost::system::generic_category() )
    {
