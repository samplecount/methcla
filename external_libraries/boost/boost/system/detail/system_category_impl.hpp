...
inline methcla_boost::system::error_condition methcla_boost::system::detail::system_error_category::default_error_condition( int ev ) const noexcept
{
    ...
    {
        return error_condition( methcla_boost::system::detail::generic_value_tag( e2 ) );
    }
}
...
inline methcla_boost::system::error_condition methcla_boost::system::detail::system_error_category::default_error_condition( int ev ) const noexcept
{
    return error_condition( methcla_boost::system::detail::generic_value_tag( ev ) );
}

#endif // #if defined(BOOST_WINDOWS_API)

inline std::string methcla_boost::system::detail::system_error_category::message( int ev ) const
{
    return system_error_category_message( ev );
}

inline char const * methcla_boost::system::detail::system_error_category::message( int ev, char * buffer, std::size_t len ) const noexcept
{
