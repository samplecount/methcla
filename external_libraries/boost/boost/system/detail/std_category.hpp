...
private:
    ...
    methcla_boost::system::error_category const * pc_;

public:

    methcla_boost::system::error_category const & original_category() const noexcept
    {
        return *pc_;
    }
...
public:
    ...
    explicit std_category( methcla_boost::system::error_category const * pc, id_wrapper<Id> ): pc_( pc )
    {
