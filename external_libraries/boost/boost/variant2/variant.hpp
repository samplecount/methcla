...
BOOST_NORETURN inline void throw_bad_variant_access()
{
    ...
    methcla_boost::throw_exception( bad_variant_access() );
...
{
    return mp11::mp_with_index<sizeof...(T)>( v.index(), detail::hash_value_L< methcla_boost::hash, variant<T...> >{ v } );
}
...
template<class... T> struct hash< ::methcla_boost::variant2::variant<T...> >: public ::methcla_boost::variant2::detail::std_hash_impl< ::methcla_boost::variant2::variant<T...> >
{
};

template<> struct hash< ::methcla_boost::variant2::monostate >
{
    std::size_t operator()( ::methcla_boost::variant2::monostate const & v ) const
    {
        return hash_value( v );
    }
};
...
template<class T>
typename result_for<T, value>::type
result_from_errno( int e, methcla_boost::source_location const* loc ) noexcept;
...
template<class... T>
    void tag_invoke( methcla_boost::json::value_from_tag const&, methcla_boost::json::value& v, variant<T...> const & w )
{
...
{
    methcla_boost::json::value const& v;
    typename methcla_boost::json::result_for<V, methcla_boost::json::value>::type& r;
    ...
    template<class I> void operator()( I /*i*/ ) const
    {
        if( !r )
        {
            ...
            auto r2 = methcla_boost::json::try_value_to<Ti>( v );
...
template<class... T>
    typename methcla_boost::json::result_for<variant<T...>, methcla_boost::json::value>::type
    tag_invoke( methcla_boost::json::try_value_to_tag<variant<T...>> const&, methcla_boost::json::value const& v )
{
    static constexpr methcla_boost::source_location loc = BOOST_CURRENT_LOCATION;
    auto r = methcla_boost::json::result_from_errno< variant<T...> >( EINVAL, &loc );
