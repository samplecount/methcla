    ...
    namespace function {
      ...
      struct member_invoker
      {
...

        {
          ...
          return methcla_boost::mem_fn(*f)(static_cast<T&&>(a)...);
        }
      };
      ...
      struct void_member_invoker
      {
...

        {
          MemberPtr* f =
            reinterpret_cast<MemberPtr*>(function_obj_ptr.data);
          methcla_boost::mem_fn(*f)(static_cast<T&&>(a)...);
        }
      };
      ...
      /**
       * vtable for a specific methcla_boost::function instance. This
       * structure must be an aggregate so that we can use static
       * initialization in methcla_boost::function's assign_to and assign_to_a
...
# pragma GCC diagnostic pop
      ...
      private:
        ...
        bool assign_to(MemberPtr f, function_buffer& functor, member_ptr_tag) const
        {
          ...
          if (f) {
            this->assign_to(methcla_boost::mem_fn(f), functor);
            return true;
          } else {
            return false;
          }
        ...
        bool assign_to_a(MemberPtr f, function_buffer& functor, Allocator a, member_ptr_tag) const
        {
          ...
          // right target_type() values.
          if (f) {
            this->assign_to_a(methcla_boost::mem_fn(f), functor, a);
            return true;
          } else {
            return false;
          }
        ...
        {
          if (!methcla_boost::detail::function::has_empty_target(methcla_boost::addressof(f))) {
  ...
  private:
    typedef methcla_boost::detail::function::basic_vtable<
              R, T...>
      vtable_type;
  ...
  public:
    // add signature for methcla_boost::lambda
    ...
    {
      if (this->empty())
        methcla_boost::throw_exception(bad_function_call());
...
#           endif
#         endif
          std::memcpy(this->functor.data, f.functor.data, sizeof(methcla_boost::detail::function::function_buffer));
#         if defined(BOOST_GCC) && (BOOST_GCC >= 40700)
#           pragma GCC diagnostic pop
#         endif
        } else
          get_vtable()->base.manager(f.functor, this->functor,
                                     methcla_boost::detail::function::clone_functor_tag);
      }
    }
    ...
    {
      using methcla_boost::detail::function::vtable_base;

      typedef typename methcla_boost::detail::function::get_function_tag<Functor>::type tag;
      typedef methcla_boost::detail::function::get_invoker<tag> get_invoker;
      ...
      if (stored_vtable.assign_to(std::move(f), functor)) {
        ...
        if (methcla_boost::detail::function::is_trivially_copyable<Functor>::value &&
            methcla_boost::detail::function::function_allows_small_object_optimization<Functor>::value)
          value |= static_cast<std::size_t>(0x01);
        vtable = reinterpret_cast<methcla_boost::detail::function::vtable_base *>(value);
      } else
        vtable = 0;
    }
...
#endif
            get_vtable()->base.manager(f.functor, this->functor,
                                     methcla_boost::detail::function::move_functor_tag);
#if defined(BOOST_GCC) && (__GNUC__ >= 11)
# pragma GCC diagnostic pop
#endif
          f.vtable = 0;
...
// Poison comparisons between methcla_boost::function objects of the same type.
template<typename R, typename... T>
