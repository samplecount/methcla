...
namespace methcla_boost {
  namespace detail {
    namespace function {
       ...
       * methcla_boost::function. It is a union containing function pointers,
      ...
      union function_buffer_members
      {
        ...
        struct type_t {
          ...
          const methcla_boost::core::typeinfo* type;
...
# pragma warning(pop)
      ...
      /**
       * Determine if methcla_boost::function can use the small-object
...
public:
  ...
  /** Retrieve the type of the stored function object, or type_id<void>()
      if this is empty. */
  const methcla_boost::core::typeinfo& target_type() const
  {
...
#endif
/**
 * The bad_function_call exception class is thrown when a methcla_boost::function
 * object is invoked
 */
class BOOST_SYMBOL_VISIBLE bad_function_call : public std::runtime_error
{
public:
  bad_function_call() : std::runtime_error("call to empty methcla_boost::function") {}
};
#if defined(BOOST_CLANG)
...
// Comparisons between methcla_boost::function objects and arbitrary function
// objects.
