  ...
  namespace chrono
  {
    ...
    process_real_cpu_clock::time_point process_real_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        ...
        {
          methcla_boost::throw_exception(system::system_error(errno, ::methcla_boost::system::system_category(), "chrono::process_real_cpu_clock"));
        } else
        {
    ...
    process_user_cpu_clock::time_point process_user_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        if (::methcla_boost::chrono::is_throws(ec))
        {
          methcla_boost::throw_exception(system::system_error(errno, ::methcla_boost::system::system_category(), "chrono::process_user_cpu_clock"));
        } else
        {
          ec.assign(errno, ::methcla_boost::system::system_category());
          return time_point();
    ...
    process_system_cpu_clock::time_point process_system_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        if (::methcla_boost::chrono::is_throws(ec))
        {
          methcla_boost::throw_exception(system::system_error(errno, ::methcla_boost::system::system_category(), "chrono::process_system_cpu_clock"));
        } else
        {
          ec.assign(errno, ::methcla_boost::system::system_category());
          return time_point();
    ...
    process_cpu_clock::time_point process_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        if (::methcla_boost::chrono::is_throws(ec))
        {
          methcla_boost::throw_exception(system::system_error(errno, ::methcla_boost::system::system_category(), "chrono::process_clock"));
        } else
        {
          ec.assign(errno, ::methcla_boost::system::system_category());
          return time_point();
