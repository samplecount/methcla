...
process_user_cpu_clock::time_point process_user_cpu_clock::now() BOOST_NOEXCEPT
{
    ...
    if ( methcla_boost::winapi::GetProcessTimes(
            methcla_boost::winapi::GetCurrentProcess(), &creation, &exit,
        ...
        system::error_code & ec)
{
    ...
    {
        methcla_boost::winapi::DWORD_ cause = methcla_boost::winapi::GetLastError();
        if (::methcla_boost::chrono::is_throws(ec))
        {
            methcla_boost::throw_exception(
                    system::system_error(
