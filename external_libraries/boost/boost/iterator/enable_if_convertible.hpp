...
// meta functions like methcla_boost::is_convertible do not return false positives,
...
//
// The operators implementation relies on methcla_boost::is_convertible not returning
...
struct enable_if_convertible :
    public std::enable_if<
        ...
        methcla_boost::iterators::detail::enable_type
    >
{};
