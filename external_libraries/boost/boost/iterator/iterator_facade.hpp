...
struct iterator_facade_types
{
    ...
    using pointer = typename std::add_pointer<
        typename std::conditional<
            methcla_boost::iterators::detail::iterator_writability_disabled< ValueParam, Reference >::value,
            const value_type,
            value_type
        >::type
    >::type;
...
#define BOOST_ITERATOR_FACADE_INTEROP_HEAD(prefix, op, result_type)       \
    BOOST_ITERATOR_FACADE_INTEROP_HEAD_IMPL(prefix, op, result_type, methcla_boost::iterators::detail::enable_if_interoperable)

#define BOOST_ITERATOR_FACADE_INTEROP_RANDOM_ACCESS_HEAD(prefix, op, result_type)       \
    BOOST_ITERATOR_FACADE_INTEROP_HEAD_IMPL(prefix, op, result_type, methcla_boost::iterators::detail::enable_if_interoperable_and_random_access_traversal)

#define BOOST_ITERATOR_FACADE_PLUS_HEAD(prefix,args)                \
    template< typename Derived, typename V, typename TC, typename R, typename D >   \
    prefix typename std::enable_if<                                 \
        methcla_boost::iterators::detail::is_traversal_at_least<            \
            TC,                                                     \
            methcla_boost::iterators::random_access_traversal_tag           \
        >::value,                                                   \
        Derived                                                     \
    >::type operator+ args
...
#define BOOST_ITERATOR_FACADE_RELATION(op)                                \
    BOOST_ITERATOR_FACADE_INTEROP_HEAD(friend, op, methcla_boost::iterators::detail::always_bool_t);
...
#define BOOST_ITERATOR_FACADE_RANDOM_ACCESS_RELATION(op)                                \
    BOOST_ITERATOR_FACADE_INTEROP_RANDOM_ACCESS_HEAD(friend, op, methcla_boost::iterators::detail::always_bool_t);
...
#undef BOOST_ITERATOR_FACADE_RANDOM_ACCESS_RELATION
    ...
    BOOST_ITERATOR_FACADE_INTEROP_RANDOM_ACCESS_HEAD(friend, -, methcla_boost::iterators::detail::choose_difference_type_t);
...
{
private:
    using associated_types = methcla_boost::iterators::detail::iterator_facade_types<
        Value, CategoryOrTraversal, Reference, Difference
    >;

    using operator_arrow_dispatch_ = methcla_boost::iterators::detail::operator_arrow_dispatch<
        Reference,
...
template< typename I, typename V, typename TC, typename R, typename D >
inline typename methcla_boost::iterators::detail::postfix_increment_result< I, V, R, TC >::type
operator++(iterator_facade< I, V, TC, R, D >& i, int)
{
    typename methcla_boost::iterators::detail::postfix_increment_result< I, V, R, TC >::type
        tmp(*static_cast< I* >(&i));
...
// (aka. enable_if) and methcla_boost::is_convertible is required.
//
...
#define BOOST_ITERATOR_FACADE_RELATION(op, return_prefix, base_op) \
    BOOST_ITERATOR_FACADE_INTEROP(                                 \
        op,                                                        \
        methcla_boost::iterators::detail::always_bool_t,                   \
        return_prefix,                                             \
        base_op                                                    \
    )
...
BOOST_ITERATOR_FACADE_INTEROP_RANDOM_ACCESS(
    -,
    methcla_boost::iterators::detail::choose_difference_type_t,
    return,
    distance_from
)
