    ...
    namespace detail
    {
            ...
            , const CharT opening_brace, const CharT closing_brace) noexcept
        {
            ...
            if (lc_iequal(begin, lc_nan, lc_NAN, 3)) {
                ...
                else value = methcla_boost::core::copysign(std::numeric_limits<T>::quiet_NaN(), static_cast<T>(-1));
                return true;
            } else if (
                ( /* 'INF' or 'inf' */
        ...
        {
            if (methcla_boost::core::isnan(value)) {
                if (methcla_boost::core::signbit(value)) {
                    return lc_minus_nan;
                }
                return lc_nan;
            } else if (methcla_boost::core::isinf(value)) {
                if (methcla_boost::core::signbit(value)) {
