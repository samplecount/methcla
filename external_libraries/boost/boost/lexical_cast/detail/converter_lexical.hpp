...
namespace methcla_boost {
    ...
    namespace detail // stream_char_common<T>
    {
        ...
        struct stream_char_common: public std::conditional<
            methcla_boost::detail::is_character< Type >::value,
            Type,
            methcla_boost::detail::deduce_character_type_later< Type >
        > {};

        template < typename Char >
        struct stream_char_common< Char* >: public std::conditional<
            methcla_boost::detail::is_character< Char >::value,
            Char,
            methcla_boost::detail::deduce_character_type_later< Char* >
        > {};
        ...
        struct stream_char_common< const Char* >: public std::conditional<
            methcla_boost::detail::is_character< Char >::value,
            Char,
            methcla_boost::detail::deduce_character_type_later< const Char* >
        > {};

        template < typename Char >
        struct stream_char_common< methcla_boost::conversion::detail::buffer_view< Char > >
        {
            using type = Char;
        };

        template < typename Char >
        struct stream_char_common< methcla_boost::iterator_range< Char* > >: public std::conditional<
            methcla_boost::detail::is_character< Char >::value,
            Char,
            methcla_boost::detail::deduce_character_type_later< methcla_boost::iterator_range< Char* > >
        > {};

        template < typename Char >
        struct stream_char_common< methcla_boost::iterator_range< const Char* > >: public std::conditional<
            methcla_boost::detail::is_character< Char >::value,
            Char,
            methcla_boost::detail::deduce_character_type_later< methcla_boost::iterator_range< const Char* > >
        > {};
        ...
        template < class Char, class Traits, class Alloc >
        struct stream_char_common< methcla_boost::container::basic_string< Char, Traits, Alloc > >
        {
            using type = Char;
        };

        template < typename Char, std::size_t N >
        struct stream_char_common< methcla_boost::array< Char, N > >: public std::conditional<
            methcla_boost::detail::is_character< Char >::value,
            Char,
            methcla_boost::detail::deduce_character_type_later< methcla_boost::array< Char, N > >
        > {};

        template < typename Char, std::size_t N >
        struct stream_char_common< methcla_boost::array< const Char, N > >: public std::conditional<
            methcla_boost::detail::is_character< Char >::value,
            Char,
            methcla_boost::detail::deduce_character_type_later< methcla_boost::array< const Char, N > >
        > {};
        ...
        struct stream_char_common< std::array<Char, N > >: public std::conditional<
            methcla_boost::detail::is_character< Char >::value,
            Char,
            methcla_boost::detail::deduce_character_type_later< std::array< Char, N > >
        > {};
        ...
        struct stream_char_common< std::array< const Char, N > >: public std::conditional<
            methcla_boost::detail::is_character< Char >::value,
            Char,
            methcla_boost::detail::deduce_character_type_later< std::array< const Char, N > >
        > {};
#endif
...
#endif
        template < class Char, class Traits >
        struct stream_char_common< methcla_boost::basic_string_view< Char, Traits > >
        {
            using type = Char;
        };

#ifdef BOOST_HAS_INT128
        template <> struct stream_char_common< methcla_boost::int128_type >
        {
            using type = char;
        };
        template <> struct stream_char_common< methcla_boost::uint128_type >
        {
            using type = char;
        };
#endif
    ...
    namespace detail // deduce_source_char_impl<T>
    {
        ...
        {
            typedef typename methcla_boost::detail::normalize_single_byte_char< Char >::type type;
        };
    ...
    {
        // If type T is `deduce_character_type_later` type, then tries to deduce
        // character type using methcla_boost::has_right_shift<T> metafunction.
        // Otherwise supplied type T is a character type, that must be normalized
        // using normalize_single_byte_char<Char>.
        // Executed at Stage 2  (See deduce_source_char<T> and deduce_target_char<T>)
        template < class Char >
    ...
    namespace detail // lcast_src_length
    {
        ...
        struct lcast_src_length<
                    Source, typename std::enable_if<methcla_boost::detail::lcast::is_integral<Source>::value >::type
                >
        {
    ...
    namespace detail // lexical_cast_stream_traits<Source, Target>
    {
        ...
        struct lexical_cast_stream_traits {
            ...
            typedef methcla_boost::detail::deduce_source_char<no_cv_src>                           deduce_src_char_metafunc;
            typedef typename deduce_src_char_metafunc::type           src_char_t;
            typedef typename methcla_boost::detail::deduce_target_char<Target>::type target_char_t;

            typedef typename methcla_boost::detail::widest_char<
            ...
            typedef methcla_boost::detail::lcast_src_length<no_cv_src> len_t;
        };
    }
