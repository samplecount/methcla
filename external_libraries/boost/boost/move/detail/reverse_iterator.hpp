...
{
   public:
   typedef typename methcla_boost::movelib::iterator_traits<It>::pointer             pointer;
   typedef typename methcla_boost::movelib::iterator_traits<It>::reference           reference;
   typedef typename methcla_boost::movelib::iterator_traits<It>::difference_type     difference_type;
   typedef typename methcla_boost::movelib::iterator_traits<It>::iterator_category   iterator_category;
   typedef typename methcla_boost::movelib::iterator_traits<It>::value_type          value_type;
   ...
   inline
      reverse_iterator( const reverse_iterator<OtherIt>& r
                      , typename methcla_boost::move_detail::enable_if_convertible<OtherIt, It>::type* =0
                   )
      : m_current(r.base())
   {}
   ...
   template<class OtherIt>
   inline typename methcla_boost::move_detail::enable_if_convertible<OtherIt, It, reverse_iterator &>::type
