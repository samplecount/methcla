...
{
   typedef typename methcla_boost::movelib::detail::first_param<Ptr>::type type;
};
...
{
   typedef typename ::methcla_boost::movelib::detail::pointer_element_impl<Ptr>::type type;
};
