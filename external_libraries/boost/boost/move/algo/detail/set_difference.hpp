   ...
   (InputIt1 first1, InputIt1 last1, InputIt2 first2, InputIt2 last2, OutputIt result, Compare comp)
{
   while (first1 != last1) {
      if (first2 == last2)
         return methcla_boost::move_detail::copy(first1, last1, result);
   ...
   while (first1 != last1) {
      ...
      if (first2 == last2){
         ...
         if (!comp(*first2, *first1)) {
            ...
            return methcla_boost::movelib::set_difference
               ( methcla_boost::make_move_iterator(++first1)
               , methcla_boost::make_move_iterator(last1)
      ...
      if (first2 == last2){
         ...
         while (++first1 != last1) {
            if (comp(*result, *first1) && ++result != first1) {
               *result = methcla_boost::move(*first1);
            }
         }
         return ++result;
      }
         ...
         if (++first1 != last1 && !comp(*result, *first1)) {
            ...
            return methcla_boost::movelib::set_unique_difference
               ( methcla_boost::make_move_iterator(first1)
               , methcla_boost::make_move_iterator(last1)
               , first2, last2, ++result, comp);
         }
