...
namespace bmupmu = ::methcla_boost::move_upmu;
...
template<class T, class U>
struct missing_virtual_destructor< ::methcla_boost::movelib::default_delete<T>, U >
...
namespace bmupd = methcla_boost::move_upd;
namespace bmupmu = ::methcla_boost::move_upmu;
