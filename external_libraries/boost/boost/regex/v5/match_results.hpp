...
public:
                         ...
                         const RegexT& re) const
   {
      if(m_is_singular)
         raise_logic_error();
      typedef ::methcla_boost::regex_traits_wrapper<typename RegexT::traits_type> traits_type;
...
private:
   ...
   {
      std::logic_error e("Attempt to access an uninitialized methcla_boost::match_results<> class.");
