...
public:
   ...
   explicit regex_error(regex_constants::error_type err)
      : std::runtime_error(::methcla_boost::BOOST_REGEX_DETAIL_NS::get_default_error_string(err))
      , m_error_code(err)
      , m_position(0)
   {
   }
...
{
#ifndef BOOST_REGEX_STANDALONE
   ::methcla_boost::throw_exception(ex);
#else
   throw ex;
#endif
}
...
void raise_error(const traits& t, regex_constants::error_type code)
{
   ...
   ::methcla_boost::BOOST_REGEX_DETAIL_NS::raise_runtime_error(e);
}
