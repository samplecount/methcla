...
namespace methcla_boost{ namespace BOOST_REGEX_DETAIL_NS{
...
inline const char*  get_default_error_string(regex_constants::error_type n)
{
   ...
   return (n > ::methcla_boost::regex_constants::error_unknown) ? s_default_error_messages[::methcla_boost::regex_constants::error_unknown] : s_default_error_messages[n];
}
