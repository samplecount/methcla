...
#ifndef BOOST_REGEX_STANDALONE
#  define BOOST_REGEX_DETAIL_THROW(ex) methcla_boost::throw_exception(ex)
#else
...
// error checking API:
//
inline void verify_options(methcla_boost::regex_constants::syntax_option_type, match_flag_type mf)
{
...
{   
   ...
   const ::methcla_boost::regex_traits_wrapper<traits_type>& traits_inst = *(e.m_ptraits);
...
private:
   ...
   {
      return ::methcla_boost::is_random_access_iterator<BidiIterator>::value ? match_dot_repeat_fast() : match_dot_repeat_slow();
   }
   bool match_backstep();
...
private:
   ...
   const ::methcla_boost::regex_traits_wrapper<traits>& traits_inst;
