...
BOOST_LEXICAL_CAST_BEGIN_MODULE_EXPORT
    ...
    inline Target lexical_cast(const Source &arg)
    {
        ...
        if (!methcla_boost::conversion::detail::try_lexical_convert(arg, result)) {
            methcla_boost::conversion::detail::throw_bad_cast<Source, Target>();
        }
    ...
    {
        return ::methcla_boost::lexical_cast<Target>(
