...
#define BOOST_BITMASK(Bitmask)                                                                                  \
  ...
  { return static_cast< Bitmask >(static_cast< ::methcla_boost::detail::bitmask::underlying_type_t< Bitmask > >(x)      \
      | static_cast< ::methcla_boost::detail::bitmask::underlying_type_t< Bitmask > >(y)); }                            \
                                                                                                                \
  inline BOOST_CONSTEXPR Bitmask operator& (Bitmask x, Bitmask y) BOOST_NOEXCEPT                                \
  { return static_cast< Bitmask >(static_cast< ::methcla_boost::detail::bitmask::underlying_type_t< Bitmask > >(x)      \
      & static_cast< ::methcla_boost::detail::bitmask::underlying_type_t< Bitmask > >(y)); }                            \
  ...
  { return !static_cast< ::methcla_boost::detail::bitmask::underlying_type_t< Bitmask > >(x); }                         \
                                                                                                                \
