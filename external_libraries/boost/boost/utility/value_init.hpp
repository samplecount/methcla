...
// Note: The implementation of methcla_boost::value_initialized had to deal with the
// fact that various compilers haven't fully implemented value-initialization.
// The constructor of methcla_boost::value_initialized<T> works around these compiler
...
#endif
{
  ...
  public :
    ...
    {
      ::methcla_boost::core::invoke_swap( this->data(), arg.data() );
    }
