...
struct space_info
{
    ...
    methcla_boost::uintmax_t capacity;
    methcla_boost::uintmax_t free;      // <= capacity
    methcla_boost::uintmax_t available; // <= free
};
...
BOOST_FILESYSTEM_DECL
methcla_boost::uintmax_t file_size(path const& p, system::error_code* ec = nullptr);
BOOST_FILESYSTEM_DECL
methcla_boost::uintmax_t hard_link_count(path const& p, system::error_code* ec = nullptr);
BOOST_FILESYSTEM_DECL
...
BOOST_FILESYSTEM_DECL
methcla_boost::uintmax_t remove_all(path const& p, system::error_code* ec = nullptr);
BOOST_FILESYSTEM_DECL
...
inline methcla_boost::uintmax_t file_size(path const& p)
{
    return detail::file_size(p);
}

inline methcla_boost::uintmax_t file_size(path const& p, system::error_code& ec) noexcept
{
    return detail::file_size(p, &ec);
}

inline methcla_boost::uintmax_t hard_link_count(path const& p)
{
    return detail::hard_link_count(p);
}

inline methcla_boost::uintmax_t hard_link_count(path const& p, system::error_code& ec) noexcept
{
...
inline methcla_boost::uintmax_t remove_all(path const& p)
{
    return detail::remove_all(p);
}

inline methcla_boost::uintmax_t remove_all(path const& p, system::error_code& ec) noexcept
{
