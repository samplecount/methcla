...
struct BOOST_TEST_DECL context_frame {
    explicit    context_frame( ::methcla_boost::unit_test::lazy_ostream const& context_descr );
    ~context_frame();
...
#define BOOST_TEST_INFO( context_descr )                                                        \
    ::methcla_boost::unit_test::framework::add_context( BOOST_TEST_LAZY_MSG( context_descr ) , false )  \
/**/

#define BOOST_TEST_INFO_SCOPE( context_descr )                                                 \
    ::methcla_boost::test_tools::tt_detail::context_frame BOOST_JOIN( context_frame_, __LINE__ ) =      \
       ::methcla_boost::test_tools::tt_detail::context_frame(BOOST_TEST_LAZY_MSG( context_descr ) )     \
/**/
...
#define BOOST_CONTEXT_PARAM(r, ctx, i, context_descr)  \
  if( ::methcla_boost::test_tools::tt_detail::context_frame BOOST_PP_CAT(ctx, i) =                       \
        ::methcla_boost::test_tools::tt_detail::context_frame(BOOST_TEST_LAZY_MSG( context_descr ) ) )   \
/**/
