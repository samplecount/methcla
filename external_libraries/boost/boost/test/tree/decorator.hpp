...
class base;
typedef methcla_boost::shared_ptr<base> base_ptr;
...
inline fixture_t
fixture( methcla_boost::function<void()> const& setup, methcla_boost::function<void()> const& teardown = methcla_boost::function<void()>() )
{
...
public:
    typedef methcla_boost::function<test_tools::assertion_result (test_unit_id)>   predicate_t;
