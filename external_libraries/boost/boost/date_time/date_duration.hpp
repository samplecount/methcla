...
namespace date_time {
  ...
  class BOOST_SYMBOL_VISIBLE date_duration : private
              methcla_boost::less_than_comparable1< date_duration< duration_rep_traits >
            , methcla_boost::equality_comparable1< date_duration< duration_rep_traits >
            , methcla_boost::addable1< date_duration< duration_rep_traits >
            , methcla_boost::subtractable1< date_duration< duration_rep_traits >
            , methcla_boost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  {
  public:
  ...
  {
    typedef long int_type;
    typedef methcla_boost::date_time::int_adapter<long> impl_type;
