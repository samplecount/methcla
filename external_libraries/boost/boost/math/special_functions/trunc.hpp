...
BOOST_MATH_GPU_ENABLED inline tools::promote_args_t<T> trunc(const T& v, const Policy& pol, const std::false_type&)
{
   ...
   if(!(methcla_boost::math::isfinite)(v))
   {
      return policies::raise_rounding_error("methcla_boost::math::trunc<%1%>(%1%)", nullptr, static_cast<result_type>(v), static_cast<result_type>(v), pol);
   }
...
BOOST_MATH_GPU_ENABLED inline int itrunc(const T& v, const Policy& pol)
{
   BOOST_MATH_STD_USING
   using result_type = tools::promote_args_t<T>;
   result_type r = methcla_boost::math::trunc(v, pol);
   ...
   {
      constexpr result_type max_val = methcla_boost::math::ccmath::ldexp(static_cast<result_type>(1), std::numeric_limits<int>::digits);
      
      if (r >= max_val || r < -max_val)
      {
         return static_cast<int>(methcla_boost::math::policies::raise_rounding_error("methcla_boost::math::itrunc<%1%>(%1%)", nullptr, v, static_cast<int>(0), pol));
      }
   }
   else
   {
...
BOOST_MATH_GPU_ENABLED inline long ltrunc(const T& v, const Policy& pol)
{
   ...
   {
      constexpr result_type max_val = methcla_boost::math::ccmath::ldexp(static_cast<result_type>(1), std::numeric_limits<long>::digits);
      
      if (r >= max_val || r < -max_val)
      {
         return static_cast<long>(methcla_boost::math::policies::raise_rounding_error("methcla_boost::math::ltrunc<%1%>(%1%)", nullptr, v, static_cast<long>(0), pol));
      }
   }
   else
   {
...
BOOST_MATH_GPU_ENABLED inline long long lltrunc(const T& v, const Policy& pol)
{
   ...
   {
      constexpr result_type max_val = methcla_boost::math::ccmath::ldexp(static_cast<result_type>(1), std::numeric_limits<long long>::digits);
      
      if (r >= max_val || r < -max_val)
      {
         return static_cast<long long>(methcla_boost::math::policies::raise_rounding_error("methcla_boost::math::lltrunc<%1%>(%1%)", nullptr, v, static_cast<long long>(0), pol));
      }
   }
   else
   {
...
{
   double r = methcla_boost::math::trunc(v);

   const double max_val = ldexp(1.0, methcla_boost::math::numeric_limits<TargetType>::digits);
...
template <class T, class Policy>
BOOST_MATH_GPU_ENABLED inline methcla_boost::math::enable_if_t<methcla_boost::math::is_constructible_v<int, T>, int>
...
template <class T, class Policy>
BOOST_MATH_GPU_ENABLED inline methcla_boost::math::enable_if_t<methcla_boost::math::is_constructible_v<long, T>, long>
...
template <class T, class Policy>
BOOST_MATH_GPU_ENABLED inline methcla_boost::math::enable_if_t<methcla_boost::math::is_constructible_v<long long, T>, long long>
...
template <class T, class Policy>
BOOST_MATH_GPU_ENABLED inline typename methcla_boost::math::enable_if_t<!methcla_boost::math::is_constructible_v<long long, T>, long long>
   llconvert(const T& v, const Policy& pol)
{
   using methcla_boost::math::lltrunc;
   return lltrunc(v, pol);
}

template <class T, class Policy>
BOOST_MATH_GPU_ENABLED [[deprecated("Use llconvert")]] inline methcla_boost::math::enable_if_t<methcla_boost::math::is_constructible_v<long long, T>, long long>
...
template <class T, class Policy>
BOOST_MATH_GPU_ENABLED [[deprecated("Use llconvert")]] inline typename methcla_boost::math::enable_if_t<!methcla_boost::math::is_constructible_v<long long, T>, long long>
