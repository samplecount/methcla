...
namespace methcla_boost { namespace math { namespace tools { namespace meta_programming {
...
// Size_t
template<methcla_boost::math::size_t N> 
using mp_size_t = methcla_boost::math::integral_constant<methcla_boost::math::size_t, N>;

// Boolean
template<bool B>
using mp_bool = methcla_boost::math::integral_constant<bool, B>;
...
{
    using type = methcla_boost::math::integral_constant<methcla_boost::math::size_t, sizeof...(T)>;
};
}
...
template<typename L, methcla_boost::math::size_t>
struct mp_at_c {};
...
template<typename L, methcla_boost::math::size_t Index>
...
template<methcla_boost::math::size_t... Index>
using index_sequence = integer_sequence<methcla_boost::math::size_t, Index...>;
...
template<methcla_boost::math::size_t N>
using make_index_sequence = make_integer_sequence<methcla_boost::math::size_t, N>;

template<typename... T>
using index_sequence_for = make_integer_sequence<methcla_boost::math::size_t, sizeof...(T)>;
