...
/*
This header defines two traits classes, both in namespace methcla_boost::math::tools.
...
namespace methcla_boost{ namespace math{ namespace tools{
...
{
   static constexpr bool value = (::methcla_boost::math::tools::detail::is_scaled_distribution_helper<D, ::methcla_boost::math::tools::detail::is_distribution_imp<D>::value>::value);
};

} // namespace detail

template <typename T> struct is_distribution : public std::integral_constant<bool, ::methcla_boost::math::tools::detail::is_distribution_imp<T>::value> {};
template <typename T> struct is_scaled_distribution : public std::integral_constant<bool, ::methcla_boost::math::tools::detail::is_scaled_distribution_imp<T>::value> {};
