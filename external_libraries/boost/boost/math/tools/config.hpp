...
namespace methcla_boost { namespace math { namespace tools { namespace detail {
template <typename T>
struct type {};
...
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)              methcla_boost::math::tools::detail::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)         methcla_boost::math::tools::detail::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)       methcla_boost::math::tools::detail::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  methcla_boost::math::tools::detail::non_type<t, v>*
...
#    define BOOST_FPU_EXCEPTION_GUARD methcla_boost::math::detail::fpu_guard local_guard_object;
...
#define BOOST_MATH_NOEXCEPT(T) noexcept(methcla_boost::math::is_floating_point_v<T>)
#define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T) 
#define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(T) 
#define BOOST_MATH_APPEND_EXPLICIT_TEMPLATE_TYPE_SPEC(T) 
...
#define BOOST_MATH_IF_CONSTEXPR if
#define BOOST_MATH_IS_FLOAT(T) (methcla_boost::math::is_floating_point<T>::value)
#define BOOST_MATH_CONSTEXPR_TABLE_FUNCTION constexpr
#define BOOST_MATH_NO_EXCEPTIONS
#define BOOST_MATH_PREVENT_MACRO_SUBSTITUTION 
