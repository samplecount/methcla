...
template <class T>
BOOST_MATH_GPU_ENABLED constexpr T epsilon(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T)) noexcept(methcla_boost::math::is_floating_point<T>::value);
...
#define BOOST_MATH_META_INT(Type, name, Default)                                                \
   ...
   class name : public methcla_boost::math::integral_constant<Type, N> { };                             \
                                                                                                \
   namespace detail{                                                                            \
   template <Type N>                                                                            \
   ...
   {                                                                                            \
   public:                                                                                      \
      static constexpr bool value = methcla_boost::math::policies::detail::is_##name##_imp<T>::value;   \
      using type = methcla_boost::math::integral_constant<bool, value>;                                 \
   };

#define BOOST_MATH_META_BOOL(name, Default)                                                     \
   template <bool N = Default>                                                                  \
   class name : public methcla_boost::math::integral_constant<bool, N>{};                               \
                                                                                                \
   namespace detail{                                                                            \
   template <bool N>                                                                            \
   BOOST_MATH_GPU_ENABLED char test_is_valid_arg(const name<N>* = nullptr);                     \
...
struct precision
{
   ...
   //
   using digits2_type = typename methcla_boost::math::conditional<
      (Digits10::value == 0),
      digits2<0>,
...
public:
   ...
   using type = typename methcla_boost::math::conditional<
      (Digits2::value > ::methcla_boost::math::policies::detail::precision<Digits10,Digits2>::digits2_type::value),
...
{
public:
   static constexpr bool value = sizeof(methcla_boost::math::policies::detail::test_is_valid_arg(static_cast<T*>(nullptr))) == sizeof(char);
};
...
{
public:
   static constexpr bool value = methcla_boost::math::policies::detail::is_valid_policy_imp<T>::value;
};
...
{
public:
   static constexpr bool value = sizeof(methcla_boost::math::policies::detail::test_is_default_arg(static_cast<T*>(nullptr))) == sizeof(char);
};
...
{
public:
   static constexpr bool value = methcla_boost::math::policies::detail::is_default_policy_imp<T>::value;
   using type = methcla_boost::math::integral_constant<bool, value>;
...
template <class Seq, class T, methcla_boost::math::size_t N>
struct append_N
{
...
private:
   ...
   //
   static_assert(::methcla_boost::math::policies::detail::is_valid_policy<A1>::value, "::methcla_boost::math::policies::detail::is_valid_policy<A1>::value");
   static_assert(::methcla_boost::math::policies::detail::is_valid_policy<A2>::value, "::methcla_boost::math::policies::detail::is_valid_policy<A2>::value");
   static_assert(::methcla_boost::math::policies::detail::is_valid_policy<A3>::value, "::methcla_boost::math::policies::detail::is_valid_policy<A3>::value");
   static_assert(::methcla_boost::math::policies::detail::is_valid_policy<A4>::value, "::methcla_boost::math::policies::detail::is_valid_policy<A4>::value");
   static_assert(::methcla_boost::math::policies::detail::is_valid_policy<A5>::value, "::methcla_boost::math::policies::detail::is_valid_policy<A5>::value");
   static_assert(::methcla_boost::math::policies::detail::is_valid_policy<A6>::value, "::methcla_boost::math::policies::detail::is_valid_policy<A6>::value");
   static_assert(::methcla_boost::math::policies::detail::is_valid_policy<A7>::value, "::methcla_boost::math::policies::detail::is_valid_policy<A7>::value");
   static_assert(::methcla_boost::math::policies::detail::is_valid_policy<A8>::value, "::methcla_boost::math::policies::detail::is_valid_policy<A8>::value");
   static_assert(::methcla_boost::math::policies::detail::is_valid_policy<A9>::value, "::methcla_boost::math::policies::detail::is_valid_policy<A9>::value");
   static_assert(::methcla_boost::math::policies::detail::is_valid_policy<A10>::value, "::methcla_boost::math::policies::detail::is_valid_policy<A10>::value");
   static_assert(::methcla_boost::math::policies::detail::is_valid_policy<A11>::value, "::methcla_boost::math::policies::detail::is_valid_policy<A11>::value");
   static_assert(::methcla_boost::math::policies::detail::is_valid_policy<A12>::value, "::methcla_boost::math::policies::detail::is_valid_policy<A12>::value");
   static_assert(::methcla_boost::math::policies::detail::is_valid_policy<A13>::value, "::methcla_boost::math::policies::detail::is_valid_policy<A13>::value");
   //
   // Typelist of the arguments:
   //
   using arg_list = mp::mp_list<A1,A2,A3,A4,A5,A6,A7,A8,A9,A10,A11,A12,A13>;
   static constexpr methcla_boost::math::size_t arg_list_size = mp::mp_size<arg_list>::value;
...
{
   using type = typename methcla_boost::math::conditional<Policy::promote_float_type::value, double, float>::type;
};

template <class Policy>
struct evaluation<double, Policy>
{
   using type = typename methcla_boost::math::conditional<Policy::promote_double_type::value, long double, double>::type;
};

template <class Real, class Policy>
struct precision
{
   static_assert((methcla_boost::math::numeric_limits<Real>::radix == 2) || ((methcla_boost::math::numeric_limits<Real>::is_specialized == 0) || (methcla_boost::math::numeric_limits<Real>::digits == 0)),
   "(methcla_boost::math::numeric_limits<Real>::radix == 2) || ((methcla_boost::math::numeric_limits<Real>::is_specialized == 0) || (methcla_boost::math::numeric_limits<Real>::digits == 0))");
#ifndef BOOST_BORLANDC
   using precision_type = typename Policy::precision_type;
   using type = typename methcla_boost::math::conditional<
      ((methcla_boost::math::numeric_limits<Real>::is_specialized == 0) || (methcla_boost::math::numeric_limits<Real>::digits == 0)),
      // Possibly unknown precision:
      precision_type,
      typename methcla_boost::math::conditional<
         ((methcla_boost::math::numeric_limits<Real>::digits <= precision_type::value)
         || (Policy::precision_type::value <= 0)),
         // Default case, full precision for RealType:
         digits2< methcla_boost::math::numeric_limits<Real>::digits>,
...
#else
   using precision_type = typename Policy::precision_type;
   using digits_t = methcla_boost::math::integral_constant<int, methcla_boost::math::numeric_limits<Real>::digits>;
   using spec_t = methcla_boost::math::integral_constant<bool, methcla_boost::math::numeric_limits<Real>::is_specialized>;
   using type = typename methcla_boost::math::conditional<
      (spec_t::value == true methcla_boost::math::true_type || digits_t::value == 0),
      // Possibly unknown precision:
      precision_type,
      typename methcla_boost::math::conditional<
...
{
   typedef methcla_boost::math::integral_constant<int, 113> type;
};
...
BOOST_MATH_GPU_ENABLED constexpr int digits_imp(methcla_boost::math::true_type const&) noexcept
{
   static_assert( methcla_boost::math::numeric_limits<T>::is_specialized, "methcla_boost::math::numeric_limits<T>::is_specialized");
   typedef typename methcla_boost::math::policies::precision<T, Policy>::type p_t;
   return p_t::value;
}

template <class T, class Policy>
BOOST_MATH_GPU_ENABLED constexpr int digits_imp(methcla_boost::math::false_type const&) noexcept
{
...
BOOST_MATH_GPU_ENABLED constexpr int digits(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T)) noexcept
{
   typedef methcla_boost::math::integral_constant<bool, methcla_boost::math::numeric_limits<T>::is_specialized > tag_type;
   return detail::digits_imp<T, Policy>(tag_type());
}
template <class T, class Policy>
BOOST_MATH_GPU_ENABLED constexpr int digits_base10(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T)) noexcept
{
   return methcla_boost::math::policies::digits<T, Policy>() * 301 / 1000L;
}
...
{
   BOOST_MATH_GPU_ENABLED static T get() noexcept(methcla_boost::math::is_floating_point<T>::value)
   {
...
struct series_factor_calc<T, Digits, methcla_boost::math::true_type, methcla_boost::math::true_type>
{
   BOOST_MATH_GPU_ENABLED static constexpr T get() noexcept(methcla_boost::math::is_floating_point<T>::value)
   {
      return methcla_boost::math::tools::epsilon<T>();
   }
};
template <class T, class Digits>
struct series_factor_calc<T, Digits, methcla_boost::math::true_type, methcla_boost::math::false_type>
{
   BOOST_MATH_GPU_ENABLED static constexpr T get() noexcept(methcla_boost::math::is_floating_point<T>::value)
   {
      return 1 / static_cast<T>(static_cast<methcla_boost::math::uintmax_t>(1u) << (Digits::value - 1));
   }
};
template <class T, class Digits>
struct series_factor_calc<T, Digits, methcla_boost::math::false_type, methcla_boost::math::true_type>
{
   BOOST_MATH_GPU_ENABLED static constexpr T get() noexcept(methcla_boost::math::is_floating_point<T>::value)
   {
      return methcla_boost::math::tools::epsilon<T>();
...
template <class T, class Policy>
BOOST_MATH_GPU_ENABLED constexpr T get_epsilon_imp(methcla_boost::math::true_type const&) noexcept(methcla_boost::math::is_floating_point<T>::value)
{
   static_assert(methcla_boost::math::numeric_limits<T>::is_specialized, "methcla_boost::math::numeric_limits<T>::is_specialized");
   static_assert(methcla_boost::math::numeric_limits<T>::radix == 2, "methcla_boost::math::numeric_limits<T>::radix == 2");

   typedef typename methcla_boost::math::policies::precision<T, Policy>::type p_t;
   typedef methcla_boost::math::integral_constant<bool, p_t::value <= methcla_boost::math::numeric_limits<methcla_boost::math::uintmax_t>::digits> is_small_int;
   typedef methcla_boost::math::integral_constant<bool, p_t::value >= methcla_boost::math::numeric_limits<T>::digits> is_default_value;
   return series_factor_calc<T, p_t, is_small_int, is_default_value>::get();
}

template <class T, class Policy>
BOOST_MATH_GPU_ENABLED constexpr T get_epsilon_imp(methcla_boost::math::false_type const&) noexcept(methcla_boost::math::is_floating_point<T>::value)
{
...
template <class T, class Policy>
BOOST_MATH_GPU_ENABLED constexpr T get_epsilon(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(T)) noexcept(methcla_boost::math::is_floating_point<T>::value)
{
   typedef methcla_boost::math::integral_constant<bool, (methcla_boost::math::numeric_limits<T>::is_specialized && (methcla_boost::math::numeric_limits<T>::radix == 2)) > tag_type;
...
{
public:
   static constexpr bool value = (sizeof(detail::test_is_policy(static_cast<methcla_boost::math::remove_reference_t<methcla_boost::math::remove_cv_t<P>>*>(nullptr))) == sizeof(char));
};
...
{
public:
   static constexpr bool value = methcla_boost::math::policies::detail::is_policy_imp<P>::value;
   using type = methcla_boost::math::integral_constant<bool, value>;
};
...
struct constructor_error_check
{
   ...
   using type = typename methcla_boost::math::conditional<
      ...
      methcla_boost::math::true_type,
      methcla_boost::math::false_type>::type;
};
...
struct method_error_check
{
   ...
   using type = typename methcla_boost::math::conditional<
      ...
      methcla_boost::math::false_type,
      methcla_boost::math::true_type>::type;
};
//
