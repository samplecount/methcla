...
//
// Exposes a methcla_boost::variant with recursive_variant_ tags (below) substituted
// with the variant itself (wrapped as needed with methcla_boost::recursive_wrapper).
//
