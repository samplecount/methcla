...
//
template <class T>          struct is_constructible<recursive_wrapper<T>, T>                            : methcla_boost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, const T>                      : methcla_boost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, T&>                           : methcla_boost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, const T&>                     : methcla_boost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, recursive_wrapper<T> >        : methcla_boost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, const recursive_wrapper<T> >  : methcla_boost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, recursive_wrapper<T>& >       : methcla_boost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, const recursive_wrapper<T>& > : methcla_boost::true_type{};

template <class T, class U> struct is_constructible<recursive_wrapper<T>, U >                           : methcla_boost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, const U >                     : methcla_boost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, U& >                          : methcla_boost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, const U& >                    : methcla_boost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, recursive_wrapper<U> >        : methcla_boost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, const recursive_wrapper<U> >  : methcla_boost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, recursive_wrapper<U>& >       : methcla_boost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, const recursive_wrapper<U>& > : methcla_boost::false_type{};
...
template <class T> struct is_nothrow_move_constructible<recursive_wrapper<T> > : methcla_boost::false_type{};
...
template< typename T > struct is_recursive_wrapper
    : public ::methcla_boost::integral_constant<bool,(::methcla_boost::detail::is_recursive_wrapper_impl<T>::value)>
{
public:
