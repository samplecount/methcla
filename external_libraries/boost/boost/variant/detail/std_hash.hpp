...
namespace std {
    ...
    struct hash<methcla_boost::variant< BOOST_VARIANT_ENUM_PARAMS(T) > > {
        std::size_t operator()(const methcla_boost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >& val) const {
