...
public: // visitor interfaces
    ...
    operator()(Value1&& value1)
    {
        apply_visitor_binary_invoke<
              Visitor
            , Value1
            , ! ::methcla_boost::is_lvalue_reference<Value1>::value
            > invoker(visitor_, value1);

        return methcla_boost::apply_visitor(invoker, std::move(visitable2_));
    }
    ...
    operator()(Value1&& value1)
    {
        ...
        return methcla_boost::apply_visitor(invoker, visitable2_);
    }
...
{
    ::methcla_boost::detail::variant::apply_visitor_binary_unwrap<
          Visitor, Visitable2, ! ::methcla_boost::is_lvalue_reference<Visitable2>::value
        > unwrapper(visitor, visitable2);

    return methcla_boost::apply_visitor(unwrapper, std::forward<Visitable1>(visitable1));
}
...
{
    ::methcla_boost::detail::variant::apply_visitor_binary_unwrap<
          const Visitor, Visitable2, ! ::methcla_boost::is_lvalue_reference<Visitable2>::value
        > unwrapper(visitor, visitable2);
...
inline decltype(auto) apply_visitor(Visitor& visitor, Visitable1&& visitable1, Visitable2&& visitable2,
    ...
    >::type = true)
{
    ::methcla_boost::detail::variant::apply_visitor_binary_unwrap_cpp14<
          Visitor, Visitable2, ! ::methcla_boost::is_lvalue_reference<Visitable2>::value
        > unwrapper(visitor, visitable2);
