...
struct add_alignment
{
    ...
    struct apply
        : mpl::size_t<
              ::methcla_boost::integer::static_lcm<
                  BOOST_MPL_AUX_VALUE_WKND(State)::value
                , ::methcla_boost::alignment_of<Item>::value
                >::value
            >
    {};
};
...
//
// This implementation is designed to prefer methcla_boost::blank over other potential
...
private: // helpers, for metafunction result (below)
    ...
    // [...now search the rest of the sequence for methcla_boost::blank...]

    typedef typename mpl::iter_fold_if<
          mpl::iterator_range< first_result_it,end_it >
        , first_result_index, mpl::protect< mpl::next<> >
        , mpl::protect< mpl::not_same_as<methcla_boost::blank> >
        >::type second_result_;
...
struct is_variant_move_noexcept_constructible {
    typedef typename methcla_boost::mpl::find_if<
        Types, mpl::not_<methcla_boost::is_nothrow_move_constructible<methcla_boost::mpl::_1> >
    >::type iterator_t;

    typedef typename methcla_boost::mpl::end<Types>::type end_t;
    typedef typename methcla_boost::is_same<
        iterator_t, end_t
    >::type type;
};
...
struct is_variant_move_noexcept_assignable {
    typedef typename methcla_boost::mpl::find_if<
        Types, mpl::not_<methcla_boost::is_nothrow_move_assignable<methcla_boost::mpl::_1> >
    >::type iterator_t;
...
struct is_constructible_ext:
    methcla_boost::mpl::or_<
        methcla_boost::is_constructible<
            T1,
            T2
        >,
        methcla_boost::is_constructible<
            T1,
            typename methcla_boost::add_lvalue_reference<T2>::type
        >
    >
{};
...
struct is_variant_constructible_from:
    methcla_boost::mpl::not_< methcla_boost::is_same<
        typename methcla_boost::mpl::find_if<
            Types,
            is_constructible_ext<methcla_boost::mpl::_1, T>
        >::type,
        typename methcla_boost::mpl::end<Types>::type
    > >
{};

template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from< methcla_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types >:
    methcla_boost::is_same<
        typename methcla_boost::mpl::find_if<
            typename methcla_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>::recursive_enabled_types,
            mpl::not_< is_variant_constructible_from< methcla_boost::mpl::_1, Types> >
        >::type,
        typename methcla_boost::mpl::end< typename methcla_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>::recursive_enabled_types >::type
    >
{};

template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from< const methcla_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>& , Types >:
    is_variant_constructible_from<methcla_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types >
{};
...
template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from< methcla_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const && , Types >:
    is_variant_constructible_from<methcla_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types >
{};
...
public: // metafunction result
    ...
    typedef ::methcla_boost::aligned_storage<
...
public: // visitor interface
    ...
    T& operator()(U&) const
    {
        ...
        return ::methcla_boost::detail::variant::forced_return< T& >();
    }
};
...
public: // internal visitor interface
    ...
    template <typename T>
    void internal_visit(methcla_boost::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( operand.get() );
    }

    template <typename T>
    void internal_visit(const methcla_boost::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( operand.get() );
    }
...
public: // internal visitor interface
    ...
    void internal_visit(methcla_boost::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( ::methcla_boost::detail::variant::move(operand.get()) );
    }

    template <typename T>
    void internal_visit(T& operand, int) const BOOST_NOEXCEPT_IF(BOOST_NOEXCEPT_EXPR(T(methcla_boost::declval<T>())))
    {
        new(storage_) T(::methcla_boost::detail::variant::move(operand));
    }
};
...
public: // internal visitor interfaces
    ...
    {
        lhs_content.get()
            = ::methcla_boost::detail::variant::move(static_cast<backup_holder<T>* >(rhs_storage_)->get());
    }
    ...
    void internal_visit(T& lhs_content, int) const
    {
        ...
        // Hint: Are any of the bounded types const-qualified or references?
        //
        lhs_content = ::methcla_boost::detail::variant::move(*static_cast<T* >(rhs_storage_));
    }
...
public: // visitor interface
    ...
    bool operator()(T& lhs)
    {
        lhs = ::methcla_boost::detail::variant::move(rhs_);
        return true;
    }
...
private: // helpers, for visitor interface (below)
        ...
        )
    {
        ...
        LhsT backup_lhs_content(
              ::methcla_boost::detail::variant::move(lhs_content)
            ); // nothrow
        ...
        BOOST_CATCH (...)
        {
            ...
            new(lhs_.storage_.address())
                LhsT(
                      ::methcla_boost::detail::variant::move(backup_lhs_content)
                    ); // nothrow
...
public: // internal visitor interfaces
    ...
    void operator()(T& operand) const
    {
        ...
        // ...and swap:
        ::methcla_boost::detail::variant::move_swap( operand, other );
    }
...
class reflect
    : public static_visitor<const methcla_boost::typeindex::type_info&>
{
public: // visitor interfaces

    template <typename T>
    const methcla_boost::typeindex::type_info& operator()(const T&) const BOOST_NOEXCEPT
    {
        return methcla_boost::typeindex::type_id<T>().type_info();
    }
...
public: // internal visitor interfaces, cont.
    ...
    template <typename T>
    result_type internal_visit(methcla_boost::recursive_wrapper<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(const methcla_boost::recursive_wrapper<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(methcla_boost::detail::reference_content<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(const methcla_boost::detail::reference_content<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(methcla_boost::detail::variant::backup_holder<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }

    template <typename T>
    result_type internal_visit(const methcla_boost::detail::variant::backup_holder<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
...
private: // helpers, for typedefs (below)
    ...
    BOOST_STATIC_ASSERT((
          ::methcla_boost::mpl::not_< mpl::empty<specified_types> >::value
        ));
...
public: // structors
    ...
    variant()
              ...
              BOOST_NOEXCEPT_IF(methcla_boost::has_nothrow_constructor<internal_T0>::value)
#endif
    {
#ifdef _MSC_VER
#pragma warning( push )
...
#   endif
        ...
        template <typename T>
        int internal_visit(methcla_boost::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const methcla_boost::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(methcla_boost::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const methcla_boost::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(methcla_boost::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const methcla_boost::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }
...
private: // helpers, for structors, below
    ...
    template <typename T>
    typename methcla_boost::enable_if<methcla_boost::is_rvalue_reference<T&&> >::type convert_construct(
          T&& operand
        , int
        , mpl::false_ = mpl::false_() // is_foreign_variant
        )
    ...
    template <typename Variant>
    typename methcla_boost::enable_if<methcla_boost::is_rvalue_reference<Variant&&> >::type convert_construct(
          Variant&& operand
        , long
        , mpl::true_// is_foreign_variant
        )
    ...
    template <typename Variant>
    typename methcla_boost::enable_if<methcla_boost::is_rvalue_reference<Variant&&> >::type convert_construct_variant(Variant&& operand)
    {
        // [Determine if the given variant is itself a bounded type, or if its
        //  content needs to be converted (i.e., it is a 'foreign' variant):]
        //
    ...
    typename methcla_boost::enable_if<mpl::or_<
        methcla_boost::is_same<methcla_boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>, variant>,
        methcla_boost::detail::variant::is_variant_constructible_from<methcla_boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>&, internal_types>
    > >::type convert_construct(
          methcla_boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>& operand
        , long
        )
    {
    ...
    typename methcla_boost::enable_if<mpl::or_<
        methcla_boost::is_same<methcla_boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>, variant>,
        methcla_boost::detail::variant::is_variant_constructible_from<const methcla_boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>&, internal_types>
    > >::type convert_construct(
          const methcla_boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>& operand
        , long
        )
    {
        convert_construct_variant(operand);
...
public: // structors, cont.
    ...
    variant(const T& operand,
        typename methcla_boost::enable_if<mpl::or_<
            mpl::and_<
                mpl::not_< methcla_boost::is_same<T, variant> >,
                methcla_boost::detail::variant::is_variant_constructible_from<const T&, internal_types>
            >,
            methcla_boost::is_same<T, methcla_boost::recursive_variant_> >,
            bool >::type = true)
    {
    ...
    variant(
        ...
        , typename methcla_boost::enable_if<mpl::or_<
            mpl::and_<
                mpl::not_< is_const<T> >,
                mpl::not_< methcla_boost::is_same<T, variant> >,
                methcla_boost::detail::variant::is_variant_constructible_from<T&, internal_types>
            >,
            methcla_boost::is_same<T, methcla_boost::recursive_variant_> >,
            bool >::type = true
        )
    ...
    variant(T&& operand,
        typename methcla_boost::enable_if<mpl::or_<
            mpl::and_<
                methcla_boost::is_rvalue_reference<T&&>,
                mpl::not_< methcla_boost::is_const<T> >,
                mpl::not_< methcla_boost::is_same<T, variant> >,
                methcla_boost::detail::variant::is_variant_constructible_from<T&&, internal_types>
            >,
            methcla_boost::is_same<T, methcla_boost::recursive_variant_> >,
...
public: // modifiers
    ...
    typename methcla_boost::enable_if<
        mpl::or_<
            methcla_boost::is_same<T, variant>,
            methcla_boost::detail::variant::is_variant_constructible_from<const T&, internal_types>
        >,
        variant&
...
public: // queries
    ...
    const methcla_boost::typeindex::type_info& type() const
    {
...
private: // precondition assertions
    ...
    BOOST_STATIC_ASSERT(( ::methcla_boost::mpl::is_sequence<Types>::value ));
    typedef typename methcla_boost::mpl::insert_range<
      methcla_boost::mpl::list<>
    , methcla_boost::mpl::end< methcla_boost::mpl::list<> >::type
    , Types
