...
MultiByteToWideChar(
    methcla_boost::winapi::UINT_ CodePage,
    methcla_boost::winapi::DWORD_ dwFlags,
    methcla_boost::winapi::LPCSTR_ lpMultiByteStr,
    int cbMultiByte,
    methcla_boost::winapi::LPWSTR_ lpWideCharStr,
    int cchWideChar);
...
WideCharToMultiByte(
    methcla_boost::winapi::UINT_ CodePage,
    methcla_boost::winapi::DWORD_ dwFlags,
    methcla_boost::winapi::LPCWSTR_ lpWideCharStr,
    int cchWideChar,
    methcla_boost::winapi::LPSTR_ lpMultiByteStr,
    int cbMultiByte,
    methcla_boost::winapi::LPCSTR_ lpDefaultChar,
    methcla_boost::winapi::LPBOOL_ lpUsedDefaultChar);
