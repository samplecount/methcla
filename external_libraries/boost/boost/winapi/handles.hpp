...
CloseHandle(methcla_boost::winapi::HANDLE_ handle);

BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
DuplicateHandle(
    methcla_boost::winapi::HANDLE_ hSourceProcessHandle,
    methcla_boost::winapi::HANDLE_ hSourceHandle,
    methcla_boost::winapi::HANDLE_ hTargetProcessHandle,
    methcla_boost::winapi::HANDLE_* lpTargetHandle,
    methcla_boost::winapi::DWORD_ dwDesiredAccess,
    methcla_boost::winapi::BOOL_ bInheritHandle,
    methcla_boost::winapi::DWORD_ dwOptions);
} // extern "C"
#endif
...
CompareObjectHandles(
    methcla_boost::winapi::HANDLE_ hFirstObjectHandle,
    methcla_boost::winapi::HANDLE_ hSecondObjectHandle);
} // extern "C"
#endif
