...
typedef methcla_boost::winapi::VOID_ (BOOST_WINAPI_NTAPI_CC *WAITORTIMERCALLBACKFUNC)
    (methcla_boost::winapi::PVOID_, methcla_boost::winapi::BOOLEAN_);
typedef WAITORTIMERCALLBACKFUNC WAITORTIMERCALLBACK;

BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
RegisterWaitForSingleObject(
    methcla_boost::winapi::PHANDLE_ phNewWaitObject,
    methcla_boost::winapi::HANDLE_ hObject,
    WAITORTIMERCALLBACK Callback,
    methcla_boost::winapi::PVOID_ Context,
    methcla_boost::winapi::ULONG_ dwMilliseconds,
...
#if BOOST_WINAPI_PARTITION_DESKTOP
BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
UnregisterWait(methcla_boost::winapi::HANDLE_ WaitHandle);
#endif

#if BOOST_WINAPI_PARTITION_DESKTOP || BOOST_WINAPI_PARTITION_SYSTEM
BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
UnregisterWaitEx(
    methcla_boost::winapi::HANDLE_ WaitHandle,
    methcla_boost::winapi::HANDLE_ CompletionEvent);
#endif
} // extern "C"
#endif
