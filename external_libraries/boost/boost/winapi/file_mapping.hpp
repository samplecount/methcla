...
CreateFileMappingA(
    ...
    methcla_boost::winapi::DWORD_ flProtect,
    methcla_boost::winapi::DWORD_ dwMaximumSizeHigh,
    methcla_boost::winapi::DWORD_ dwMaximumSizeLow,
    methcla_boost::winapi::LPCSTR_ lpName);

BOOST_WINAPI_IMPORT methcla_boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC
OpenFileMappingA(
    methcla_boost::winapi::DWORD_ dwDesiredAccess,
    methcla_boost::winapi::BOOL_ bInheritHandle,
    methcla_boost::winapi::LPCSTR_ lpName);
...
CreateFileMappingW(
    ...
    methcla_boost::winapi::DWORD_ dwMaximumSizeHigh,
    methcla_boost::winapi::DWORD_ dwMaximumSizeLow,
    methcla_boost::winapi::LPCWSTR_ lpName);

BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::LPVOID_ BOOST_WINAPI_WINAPI_CC
MapViewOfFile(
    methcla_boost::winapi::HANDLE_ hFileMappingObject,
    methcla_boost::winapi::DWORD_ dwDesiredAccess,
    methcla_boost::winapi::DWORD_ dwFileOffsetHigh,
    methcla_boost::winapi::DWORD_ dwFileOffsetLow,
    methcla_boost::winapi::SIZE_T_ dwNumberOfBytesToMap);

BOOST_WINAPI_IMPORT methcla_boost::winapi::LPVOID_ BOOST_WINAPI_WINAPI_CC
MapViewOfFileEx(
    methcla_boost::winapi::HANDLE_ hFileMappingObject,
    methcla_boost::winapi::DWORD_ dwDesiredAccess,
    methcla_boost::winapi::DWORD_ dwFileOffsetHigh,
    methcla_boost::winapi::DWORD_ dwFileOffsetLow,
    methcla_boost::winapi::SIZE_T_ dwNumberOfBytesToMap,
    methcla_boost::winapi::LPVOID_ lpBaseAddress);
...
FlushViewOfFile(
    methcla_boost::winapi::LPCVOID_ lpBaseAddress,
    methcla_boost::winapi::SIZE_T_ dwNumberOfBytesToFlush);

BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
UnmapViewOfFile(methcla_boost::winapi::LPCVOID_ lpBaseAddress);
