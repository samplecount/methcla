...
BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
AreFileApisANSI(BOOST_WINAPI_DETAIL_VOID);

BOOST_WINAPI_IMPORT methcla_boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC
CreateFileA(
    methcla_boost::winapi::LPCSTR_ lpFileName,
    methcla_boost::winapi::DWORD_ dwDesiredAccess,
    methcla_boost::winapi::DWORD_ dwShareMode,
    ::_SECURITY_ATTRIBUTES* lpSecurityAttributes,
    methcla_boost::winapi::DWORD_ dwCreationDisposition,
    methcla_boost::winapi::DWORD_ dwFlagsAndAttributes,
    methcla_boost::winapi::HANDLE_ hTemplateFile);

struct _WIN32_FIND_DATAA;
BOOST_WINAPI_IMPORT methcla_boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC
FindFirstFileA(methcla_boost::winapi::LPCSTR_ lpFileName, ::_WIN32_FIND_DATAA* lpFindFileData);

BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
FindNextFileA(methcla_boost::winapi::HANDLE_ hFindFile, ::_WIN32_FIND_DATAA* lpFindFileData);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC
CreateFileW(
    methcla_boost::winapi::LPCWSTR_ lpFileName,
    methcla_boost::winapi::DWORD_ dwDesiredAccess,
    methcla_boost::winapi::DWORD_ dwShareMode,
    ::_SECURITY_ATTRIBUTES* lpSecurityAttributes,
    methcla_boost::winapi::DWORD_ dwCreationDisposition,
...
BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC
FindFirstFileW(methcla_boost::winapi::LPCWSTR_ lpFileName, ::_WIN32_FIND_DATAW* lpFindFileData);

BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
FindNextFileW(methcla_boost::winapi::HANDLE_ hFindFile, ::_WIN32_FIND_DATAW* lpFindFileData);

struct _BY_HANDLE_FILE_INFORMATION;
BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
GetFileInformationByHandle(
    methcla_boost::winapi::HANDLE_ hFile,
    ::_BY_HANDLE_FILE_INFORMATION* lpFileInformation);

BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
LockFile(
    methcla_boost::winapi::HANDLE_ hFile,
    methcla_boost::winapi::DWORD_ dwFileOffsetLow,
    methcla_boost::winapi::DWORD_ dwFileOffsetHigh,
    methcla_boost::winapi::DWORD_ nNumberOfBytesToLockLow,
    methcla_boost::winapi::DWORD_ nNumberOfBytesToLockHigh);

BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
LockFileEx(
    methcla_boost::winapi::HANDLE_ hFile,
    methcla_boost::winapi::DWORD_ dwFlags,
    methcla_boost::winapi::DWORD_ dwReserved,
    methcla_boost::winapi::DWORD_ nNumberOfBytesToLockLow,
    methcla_boost::winapi::DWORD_ nNumberOfBytesToLockHigh,
...
SetFileValidData(
    methcla_boost::winapi::HANDLE_ hFile, 
    methcla_boost::winapi::LONGLONG_ ValidDataLength);
#endif
...
UnlockFile(
    ...
    methcla_boost::winapi::DWORD_ dwFileOffsetLow,
    methcla_boost::winapi::DWORD_ dwFileOffsetHigh,
    methcla_boost::winapi::DWORD_ nNumberOfBytesToUnlockLow,
    methcla_boost::winapi::DWORD_ nNumberOfBytesToUnlockHigh);
...
#if !defined( BOOST_NO_ANSI_APIS )
BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
DeleteFileA(methcla_boost::winapi::LPCSTR_ lpFileName);

BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
MoveFileExA(
    methcla_boost::winapi::LPCSTR_ lpExistingFileName,
    methcla_boost::winapi::LPCSTR_ lpNewFileName,
    methcla_boost::winapi::DWORD_ dwFlags);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
DeleteFileW(methcla_boost::winapi::LPCWSTR_ lpFileName);

BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
FindClose(methcla_boost::winapi::HANDLE_ hFindFile);

BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
MoveFileExW(
    methcla_boost::winapi::LPCWSTR_ lpExistingFileName,
    methcla_boost::winapi::LPCWSTR_ lpNewFileName,
    methcla_boost::winapi::DWORD_ dwFlags);

BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
ReadFile(
    methcla_boost::winapi::HANDLE_ hFile,
    methcla_boost::winapi::LPVOID_ lpBuffer,
    methcla_boost::winapi::DWORD_ nNumberOfBytesToRead,
    methcla_boost::winapi::LPDWORD_ lpNumberOfBytesRead,
    ::_OVERLAPPED* lpOverlapped);

BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
SetEndOfFile(methcla_boost::winapi::HANDLE_ hFile);

BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
WriteFile(
    methcla_boost::winapi::HANDLE_ hFile,
    methcla_boost::winapi::LPCVOID_ lpBuffer,
    methcla_boost::winapi::DWORD_ nNumberOfBytesToWrite,
    methcla_boost::winapi::LPDWORD_ lpNumberOfBytesWritten,
    ::_OVERLAPPED* lpOverlapped);
...
GetFileAttributesA(methcla_boost::winapi::LPCSTR_ lpFileName);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
GetFileAttributesW(methcla_boost::winapi::LPCWSTR_ lpFileName);

BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
GetFileSizeEx(methcla_boost::winapi::HANDLE_ hFile, ::_LARGE_INTEGER* lpFileSize);

BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
SetFilePointer(
    methcla_boost::winapi::HANDLE_ hFile,
    methcla_boost::winapi::LONG_ lpDistanceToMove,
    methcla_boost::winapi::PLONG_ lpDistanceToMoveHigh,
    methcla_boost::winapi::DWORD_ dwMoveMethod);
