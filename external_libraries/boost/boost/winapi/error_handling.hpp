...
FormatMessageA(
    ...
    methcla_boost::winapi::LPCVOID_ lpSource,
    methcla_boost::winapi::DWORD_ dwMessageId,
    methcla_boost::winapi::DWORD_ dwLanguageId,
    methcla_boost::winapi::LPSTR_ lpBuffer,
...
FormatMessageW(
    ...
    methcla_boost::winapi::DWORD_ dwMessageId,
    methcla_boost::winapi::DWORD_ dwLanguageId,
    methcla_boost::winapi::LPWSTR_ lpBuffer,
    methcla_boost::winapi::DWORD_ nSize,
    va_list *Arguments);

#if BOOST_WINAPI_PARTITION_DESKTOP || BOOST_WINAPI_PARTITION_SYSTEM
BOOST_WINAPI_IMPORT methcla_boost::winapi::UINT_ BOOST_WINAPI_WINAPI_CC
SetErrorMode(methcla_boost::winapi::UINT_ uMode);
#endif
} // extern "C"
#endif
