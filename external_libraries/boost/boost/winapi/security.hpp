...
#else
typedef methcla_boost::winapi::PVOID_ PSECURITY_DESCRIPTOR;
#endif

BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
InitializeSecurityDescriptor(
    PSECURITY_DESCRIPTOR pSecurityDescriptor,
    methcla_boost::winapi::DWORD_ dwRevision);
BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
SetSecurityDescriptorDacl(
    PSECURITY_DESCRIPTOR pSecurityDescriptor,
    methcla_boost::winapi::BOOL_ bDaclPresent,
    ::_ACL* pDacl,
    methcla_boost::winapi::BOOL_ bDaclDefaulted);
}
#endif
