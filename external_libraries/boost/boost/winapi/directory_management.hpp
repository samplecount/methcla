...
BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
    CreateDirectoryA(methcla_boost::winapi::LPCSTR_, ::_SECURITY_ATTRIBUTES*);
#if BOOST_WINAPI_PARTITION_APP_SYSTEM
BOOST_WINAPI_IMPORT methcla_boost::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
    GetTempPathA(methcla_boost::winapi::DWORD_ length, methcla_boost::winapi::LPSTR_ buffer);
#endif
BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
    RemoveDirectoryA(methcla_boost::winapi::LPCSTR_);
#endif
BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
    CreateDirectoryW(methcla_boost::winapi::LPCWSTR_, ::_SECURITY_ATTRIBUTES*);
#if BOOST_WINAPI_PARTITION_APP_SYSTEM
BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
    GetTempPathW(methcla_boost::winapi::DWORD_ length, methcla_boost::winapi::LPWSTR_ buffer);
#endif
BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
    RemoveDirectoryW(methcla_boost::winapi::LPCWSTR_);
} // extern "C"
#endif
