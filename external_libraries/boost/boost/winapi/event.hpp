...
CreateEventA(
    ...
    methcla_boost::winapi::BOOL_ bManualReset,
    methcla_boost::winapi::BOOL_ bInitialState,
...
SetEvent(methcla_boost::winapi::HANDLE_ hEvent);

BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
ResetEvent(methcla_boost::winapi::HANDLE_ hEvent);
#endif
} // extern "C"
#endif
