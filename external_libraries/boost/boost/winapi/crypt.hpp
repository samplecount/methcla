...
CryptEnumProvidersA(
    methcla_boost::winapi::DWORD_ dwIndex,
    methcla_boost::winapi::DWORD_ *pdwReserved,
    methcla_boost::winapi::DWORD_ dwFlags,
    methcla_boost::winapi::DWORD_ *pdwProvType,
    methcla_boost::winapi::LPSTR_ szProvName,
    methcla_boost::winapi::DWORD_ *pcbProvName);

BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
CryptAcquireContextA(
    methcla_boost::winapi::HCRYPTPROV_ *phProv,
    methcla_boost::winapi::LPCSTR_ pszContainer,
    methcla_boost::winapi::LPCSTR_ pszProvider,
    methcla_boost::winapi::DWORD_ dwProvType,
    methcla_boost::winapi::DWORD_ dwFlags);
...
CryptEnumProvidersW(
    ...
    methcla_boost::winapi::DWORD_ dwFlags,
    methcla_boost::winapi::DWORD_ *pdwProvType,
    methcla_boost::winapi::LPWSTR_ szProvName,
    methcla_boost::winapi::DWORD_ *pcbProvName);

BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
CryptAcquireContextW(
    methcla_boost::winapi::HCRYPTPROV_ *phProv,
    methcla_boost::winapi::LPCWSTR_ szContainer,
    methcla_boost::winapi::LPCWSTR_ szProvider,
    methcla_boost::winapi::DWORD_ dwProvType,
    methcla_boost::winapi::DWORD_ dwFlags);

BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
CryptGenRandom(
    methcla_boost::winapi::HCRYPTPROV_ hProv,
    methcla_boost::winapi::DWORD_ dwLen,
    methcla_boost::winapi::BYTE_ *pbBuffer);
...
CryptReleaseContext(
    methcla_boost::winapi::HCRYPTPROV_ hProv,
    methcla_boost::winapi::ULONG_PTR_ dwFlags);
#else
BOOST_WINAPI_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
CryptReleaseContext(
    methcla_boost::winapi::HCRYPTPROV_ hProv,
