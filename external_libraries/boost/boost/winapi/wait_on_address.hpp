...
methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
WaitOnAddress(
    volatile methcla_boost::winapi::VOID_* addr,
    methcla_boost::winapi::PVOID_ compare_addr,
    methcla_boost::winapi::SIZE_T_ size,
    methcla_boost::winapi::DWORD_ timeout_ms);

methcla_boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
WakeByAddressSingle(methcla_boost::winapi::PVOID_ addr);

methcla_boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
WakeByAddressAll(methcla_boost::winapi::PVOID_ addr);
