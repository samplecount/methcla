...
#endif // _WIN64
}} // namespace methcla_boost::winapi

extern "C" {
#if !defined(UNDER_CE)
BOOST_WINAPI_IMPORT methcla_boost::winapi::FARPROC_ BOOST_WINAPI_WINAPI_CC
GetProcAddress(methcla_boost::winapi::HMODULE_ hModule, methcla_boost::winapi::LPCSTR_ lpProcName);
#else
...
BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::FARPROC_ BOOST_WINAPI_WINAPI_CC
GetProcAddressA(methcla_boost::winapi::HMODULE_ hModule, methcla_boost::winapi::LPCSTR_ lpProcName);
BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::FARPROC_ BOOST_WINAPI_WINAPI_CC
GetProcAddressW(methcla_boost::winapi::HMODULE_ hModule, methcla_boost::winapi::LPCWSTR_ lpProcName);
#endif
} // extern "C"
...
#endif
    return reinterpret_cast< FuncPtr >(methcla_boost::winapi::get_proc_address(hModule, lpProcName));
#if defined(BOOST_GCC) && BOOST_GCC >= 80000
