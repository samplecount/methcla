...
CreateSemaphoreA(
    ...
    methcla_boost::winapi::LONG_ lInitialCount,
    methcla_boost::winapi::LONG_ lMaximumCount,
...
ReleaseSemaphore(
    methcla_boost::winapi::HANDLE_ hSemaphore,
    methcla_boost::winapi::LONG_ lReleaseCount,
    methcla_boost::winapi::LPLONG_ lpPreviousCount);
