...
BOOST_WINAPI_IMPORT methcla_boost::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
LoadLibraryA(methcla_boost::winapi::LPCSTR_ lpFileName);
...
BOOST_WINAPI_IMPORT methcla_boost::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
GetModuleHandleA(methcla_boost::winapi::LPCSTR_ lpFileName);

BOOST_WINAPI_IMPORT methcla_boost::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
GetModuleFileNameA(
    methcla_boost::winapi::HMODULE_ hModule,
    methcla_boost::winapi::LPSTR_ lpFilename,
    methcla_boost::winapi::DWORD_ nSize
);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
LoadLibraryW(methcla_boost::winapi::LPCWSTR_ lpFileName);
...
BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
GetModuleHandleW(methcla_boost::winapi::LPCWSTR_ lpFileName);

BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
GetModuleFileNameW(
    methcla_boost::winapi::HMODULE_ hModule,
    methcla_boost::winapi::LPWSTR_ lpFilename,
    methcla_boost::winapi::DWORD_ nSize
);
...
BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::SIZE_T_ BOOST_WINAPI_WINAPI_CC
VirtualQuery(
    methcla_boost::winapi::LPCVOID_ lpAddress,
    ::_MEMORY_BASIC_INFORMATION* lpBuffer,
    methcla_boost::winapi::SIZE_T_ dwLength
);
...
VirtualQuery(
    methcla_boost::winapi::LPCVOID_ lpAddress,
    ::_MEMORY_BASIC_INFORMATION* lpBuffer,
    methcla_boost::winapi::DWORD_ dwLength
);
...
FreeLibrary(methcla_boost::winapi::HMODULE_ hModule);
}
#endif
