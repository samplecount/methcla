...
BOOST_WINAPI_IMPORT_EXCEPT_WM methcla_boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
...
BOOST_WINAPI_IMPORT methcla_boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
...
BOOST_WINAPI_IMPORT methcla_boost::winapi::ULONGLONG_ BOOST_WINAPI_WINAPI_CC
...
{
    methcla_boost::winapi::SYSTEMTIME_ st;
    methcla_boost::winapi::GetSystemTime(&st);
    methcla_boost::winapi::SystemTimeToFileTime(&st, lpFileTime);
}
#endif
