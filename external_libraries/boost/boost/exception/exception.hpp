...
#include  <memory>
namespace methcla_boost { namespace exception_detail { using std::shared_ptr; } }
#else
namespace methcla_boost { template <class T> class shared_ptr; }
namespace methcla_boost { namespace exception_detail { using methcla_boost::shared_ptr; } }
#endif
...
methcla_boost
    ...
    exception_detail
        ...
        methcla_boost::source_location get_exception_throw_location( exception const & );
        }
    ...
    exception
...
#ifdef __HP_aCC
        //On HP aCC, this protected copy constructor prevents throwing methcla_boost::exception.
        ...
        friend methcla_boost::source_location exception_detail::get_exception_throw_location( exception const & );
    ...
    exception_detail
        ...
        inline methcla_boost::source_location get_exception_throw_location( exception const & x )
            {
