...
methcla_boost
    ...
    exception_detail
        ...
        wrap_exception_ptr( std::exception_ptr const & e )
            {
            exception_detail::clone_base const & base = methcla_boost::enable_current_exception(std_exception_ptr_wrapper(e));
    ...
    exception_ptr
        {
        typedef methcla_boost::shared_ptr<exception_detail::clone_base const> impl;
        impl ptr_;
    ...
    exception_detail
        ...
        copy_exception_impl( E const & e )
            {
            return exception_ptr(methcla_boost::make_shared<E>(e));
            }
        }
    ...
    copy_exception( E const & e )
        {
        return exception_detail::copy_exception_impl(methcla_boost::enable_current_exception(e));
        }
    ...
    make_exception_ptr( T const & e )
        {
        return methcla_boost::copy_exception(e);
        }
...
# endif
    ...
    class
    unknown_exception:
        public methcla_boost::exception,
        ...
        explicit
        unknown_exception( methcla_boost::exception const & e ):
            methcla_boost::exception(e)
            {
            add_original_type(e);
            }
...
# endif
    ...
    exception_detail
        ...
        current_exception_std_exception_wrapper:
            ...
            current_exception_std_exception_wrapper( T const & e1, methcla_boost::exception const & e2 ):
                T(e1),
                methcla_boost::exception(e2)
                {
                add_original_type(e1);
                }
        ...
        get_boost_exception( T const * x )
            {
            return dynamic_cast<methcla_boost::exception const *>(x);
            }
#endif
        ...
        current_exception_std_exception( T const & e1 )
            {
            if( methcla_boost::exception const * e2 = get_boost_exception(&e1) )
                return methcla_boost::copy_exception(current_exception_std_exception_wrapper<T>(e1,*e2));
            else
                return methcla_boost::copy_exception(current_exception_std_exception_wrapper<T>(e1));
            }
        ...
        current_exception_unknown_exception()
            {
            return methcla_boost::copy_exception(unknown_exception());
            }

        inline
        exception_ptr
        current_exception_unknown_boost_exception( methcla_boost::exception const & e )
            {
            return methcla_boost::copy_exception(unknown_exception(e));
            }
        ...
        current_exception_unknown_std_exception( std::exception const & e )
            {
            if( methcla_boost::exception const * be = get_boost_exception(&e) )
