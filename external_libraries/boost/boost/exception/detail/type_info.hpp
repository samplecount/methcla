...
#define BOOST_EXCEPTION_P(P) (sizeof(char[1 + exception_detail::check_prefix(BOOST_EXCEPTION_PRETTY_FUNCTION, P)]) - 1)
            // clang style:
            std::size_t const p01 = BOOST_EXCEPTION_P("r methcla_boost::n::p() [T = ");
            std::size_t const p02 = BOOST_EXCEPTION_P("r __cdecl methcla_boost::n::p(void) [T = ");
            // old clang style:
            std::size_t const p03 = BOOST_EXCEPTION_P("methcla_boost::n::r methcla_boost::n::p() [T = ");
            std::size_t const p04 = BOOST_EXCEPTION_P("methcla_boost::n::r __cdecl methcla_boost::n::p(void) [T = ");
            // gcc style:
            std::size_t const p05 = BOOST_EXCEPTION_P("methcla_boost::n::r methcla_boost::n::p() [with T = ");
            std::size_t const p06 = BOOST_EXCEPTION_P("methcla_boost::n::r __cdecl methcla_boost::n::p() [with T = ");
            // msvc style, struct:
            std::size_t const p07 = BOOST_EXCEPTION_P("struct methcla_boost::n::r __cdecl methcla_boost::n::p<struct ");
            // msvc style, class:
            std::size_t const p08 = BOOST_EXCEPTION_P("struct methcla_boost::n::r __cdecl methcla_boost::n::p<class ");
            // msvc style, enum:
            std::size_t const p09 = BOOST_EXCEPTION_P("struct methcla_boost::n::r __cdecl methcla_boost::n::p<enum ");
            // msvc style, built-in type:
            std::size_t const p10 = BOOST_EXCEPTION_P("struct methcla_boost::n::r __cdecl methcla_boost::n::p<");
...
#define BOOST_EXCEPTION_STATIC_TYPEID(T) ::methcla_boost::exception_detail::type_info_(BOOST_CORE_TYPEID(T))

#ifndef BOOST_NO_RTTI
#define BOOST_EXCEPTION_DYNAMIC_TYPEID(x) ::methcla_boost::exception_detail::type_info_(typeid(x))
#endif
