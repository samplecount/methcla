...
#pragma warning(disable : 4714) /* marked as __forceinline not inlined */
    ...
    class unordered_flat_map
    {
      ...
      using table_type = detail::foa::table<map_types, Hash, KeyEqual,
        typename methcla_boost::allocator_rebind<Allocator,
    ...
    public:
      ...
      using hasher = typename methcla_boost::unordered::detail::type_identity<Hash>::type;
      using key_equal = typename methcla_boost::unordered::detail::type_identity<KeyEqual>::type;
      using allocator_type = typename methcla_boost::unordered::detail::type_identity<Allocator>::type;
      using reference = value_type&;
      using const_reference = value_type const&;
      using pointer = typename methcla_boost::allocator_pointer<allocator_type>::type;
      using const_pointer =
        typename methcla_boost::allocator_const_pointer<allocator_type>::type;
      ...
      typename std::enable_if<
        methcla_boost::unordered::detail::are_transparent<K, hasher, key_equal>::value,
      ...
      BOOST_FORCEINLINE typename std::enable_if<
        methcla_boost::unordered::detail::transparent_non_iterable<K,
      ...
      mapped_type& at(key_type const& key)
      {
        ...
        //
        methcla_boost::unordered::detail::throw_out_of_range(
...
#pragma warning(pop) /* C4714 */
    ...
    template <class InputIterator,
      class Hash =
        methcla_boost::hash<methcla_boost::unordered::detail::iter_key_t<InputIterator> >,
      class Pred =
        std::equal_to<methcla_boost::unordered::detail::iter_key_t<InputIterator> >,
      class Allocator = std::allocator<
        methcla_boost::unordered::detail::iter_to_alloc_t<InputIterator> >,
    ...
    unordered_flat_map(InputIterator, InputIterator,
      std::size_t = methcla_boost::unordered::detail::foa::default_bucket_count,
      Hash = Hash(), Pred = Pred(), Allocator = Allocator())
      -> unordered_flat_map<methcla_boost::unordered::detail::iter_key_t<InputIterator>,
        methcla_boost::unordered::detail::iter_val_t<InputIterator>, Hash, Pred,
        Allocator>;

    template <class Key, class T,
      class Hash = methcla_boost::hash<std::remove_const_t<Key> >,
    ...
    unordered_flat_map(InputIterator, InputIterator, std::size_t, Allocator)
      -> unordered_flat_map<methcla_boost::unordered::detail::iter_key_t<InputIterator>,
        methcla_boost::unordered::detail::iter_val_t<InputIterator>,
        methcla_boost::hash<methcla_boost::unordered::detail::iter_key_t<InputIterator> >,
        std::equal_to<methcla_boost::unordered::detail::iter_key_t<InputIterator> >,
        Allocator>;
    ...
    unordered_flat_map(
      ...
      -> unordered_flat_map<methcla_boost::unordered::detail::iter_key_t<InputIterator>,
        methcla_boost::unordered::detail::iter_val_t<InputIterator>, Hash,
        std::equal_to<methcla_boost::unordered::detail::iter_key_t<InputIterator> >,
        Allocator>;
    ...
    unordered_flat_map(std::initializer_list<std::pair<Key, T> >, std::size_t,
      ...
      methcla_boost::hash<std::remove_const_t<Key> >,
