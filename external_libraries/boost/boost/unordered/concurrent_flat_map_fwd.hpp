...
namespace methcla_boost {
  namespace unordered {
    ...
    template <class Key, class T, class Hash = methcla_boost::hash<Key>,
    ...
    namespace pmr {
      template <class Key, class T, class Hash = methcla_boost::hash<Key>,
        class Pred = std::equal_to<Key> >
      using concurrent_flat_map = methcla_boost::unordered::concurrent_flat_map<Key, T,
  ...
  using methcla_boost::unordered::concurrent_flat_map;
} // namespace methcla_boost
