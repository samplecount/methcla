  ...
  namespace unordered {
    ...
    public:
      ...
      unordered_set(InputIt, InputIt,
        size_type = methcla_boost::unordered::detail::default_bucket_count,
      ...
      unordered_set(unordered_set&& other)
        noexcept(table::nothrow_move_constructible)
          : table_(other.table_, methcla_boost::unordered::detail::move_tag())
      {
      ...
      template <class Key>
      typename methcla_boost::enable_if_c<
      ...
      void merge(methcla_boost::unordered_set<T, H2, P2, A>& source);

      template <typename H2, typename P2>
      void merge(methcla_boost::unordered_set<T, H2, P2, A>&& source);

      template <typename H2, typename P2>
      void merge(methcla_boost::unordered_multiset<T, H2, P2, A>& source);
      ...
      template <class Key>
      typename methcla_boost::enable_if_c<detail::are_transparent<Key, H, P>::value,
        const_iterator>::type
    ...
    template <class InputIterator,
      class Hash =
        methcla_boost::hash<typename std::iterator_traits<InputIterator>::value_type>,
      class Pred =
    ...
    unordered_set(InputIterator, InputIterator,
      std::size_t = methcla_boost::unordered::detail::default_bucket_count,
      Hash = Hash(), Pred = Pred(), Allocator = Allocator())
      -> unordered_set<typename std::iterator_traits<InputIterator>::value_type,
        Hash, Pred, Allocator>;

    template <class T, class Hash = methcla_boost::hash<T>,
    ...
    unordered_set(std::initializer_list<T>, std::size_t, Allocator)
      -> unordered_set<T, methcla_boost::hash<T>, std::equal_to<T>, Allocator>;
    ...
    public:
      ...
      template <class... Args> iterator emplace(Args&&... args)
      {
        return iterator(table_.emplace_equiv(
          methcla_boost::unordered::detail::func::construct_node_from_args(
      ...
      iterator emplace_hint(const_iterator hint, Args&&... args)
      {
        return iterator(table_.emplace_hint_equiv(
          hint, methcla_boost::unordered::detail::func::construct_node_from_args(
                  table_.node_alloc(), std::forward<Args>(args)...)));
      }
    ...
    unordered_multiset(std::initializer_list<T>, std::size_t, Allocator)
      -> unordered_multiset<T, methcla_boost::hash<T>, std::equal_to<T>, Allocator>;
    ...
    unordered_set<T, H, P, A>::unordered_set(InputIt f, InputIt l, size_type n,
      const hasher& hf, const key_equal& eql, const allocator_type& a)
        : table_(methcla_boost::unordered::detail::initial_size(f, l, n), hf, eql, a)
    {
      this->insert(f, l);
    }
    ...
    unordered_set<T, H, P, A>::unordered_set(allocator_type const& a)
        : table_(methcla_boost::unordered::detail::default_bucket_count, hasher(),
            key_equal(), a)
    {
    }
    ...
    unordered_set<T, H, P, A>::unordered_set(
      unordered_set&& other, allocator_type const& a)
        : table_(other.table_, a, methcla_boost::unordered::detail::move_tag())
    {
    ...
    unordered_set<T, H, P, A>::unordered_set(
      ...
      const key_equal& eql, const allocator_type& a)
        : table_(
            methcla_boost::unordered::detail::initial_size(list.begin(), list.end(), n),
            hf, eql, a)
    {
    ...
    unordered_set<T, H, P, A>::unordered_set(
      InputIterator f, InputIterator l, const allocator_type& a)
        : table_(methcla_boost::unordered::detail::initial_size(
    ...
    unordered_set<T, H, P, A>::unordered_set(
      InputIt f, InputIt l, size_type n, const allocator_type& a)
        : table_(methcla_boost::unordered::detail::initial_size(f, l, n), hasher(),
            key_equal(), a)
    {
      this->insert(f, l);
    }
    ...
    unordered_set<T, H, P, A>::unordered_set(InputIt f, InputIt l, size_type n,
      const hasher& hf, const allocator_type& a)
        : table_(
            methcla_boost::unordered::detail::initial_size(f, l, n), hf, key_equal(), a)
    {
      this->insert(f, l);
    }
    ...
    std::size_t unordered_set<T, H, P, A>::max_size() const noexcept
    {
      ...
      // size < mlf_ * count
      return methcla_boost::unordered::detail::double_to_size(
    ...
    void unordered_set<T, H, P, A>::merge(
      methcla_boost::unordered_set<T, H2, P2, A>& source)
    {
    ...
    template <typename H2, typename P2>
    void unordered_set<T, H, P, A>::merge(
      methcla_boost::unordered_multiset<T, H2, P2, A>& source)
    {
      table_.merge_unique(source.table_);
    }
    ...
    {
      template <typename Types> friend struct ::methcla_boost::unordered::detail::table;
      template <class T2, class H2, class P2, class A2>
      friend class unordered_set;
      template <class T2, class H2, class P2, class A2>
      friend class unordered_multiset;

      typedef typename methcla_boost::unordered::detail::rebind_wrap<A, T>::type
        value_allocator;
      typedef methcla_boost::unordered::detail::allocator_traits<value_allocator>
        value_allocator_traits;
      typedef N node;
      typedef typename methcla_boost::unordered::detail::rebind_wrap<A, node>::type
        node_allocator;
      typedef methcla_boost::unordered::detail::allocator_traits<node_allocator>
    ...
    private:
      node_pointer ptr_;
      bool has_alloc_;
      methcla_boost::unordered::detail::optional<value_allocator> alloc_;
    ...
    public:
      ...
      ~node_handle_set()
      {
        if (ptr_) {
          ...
          methcla_boost::unordered::detail::node_tmp<node_allocator> tmp(
            ptr_, node_alloc);
        }
      }
                 ...
                 value_allocator_traits::is_always_equal::value)
      {
        ...
        if (value_allocator_traits::propagate_on_container_swap::value ||
            !alloc_.has_value() || !n.alloc_.has_value()) {
          methcla_boost::core::invoke_swap(alloc_, n.alloc_);
        }
        methcla_boost::core::invoke_swap(ptr_, n.ptr_);
      }
    };
    ...
    {
      methcla_boost::core::invoke_swap(x.node, y.node);
      methcla_boost::core::invoke_swap(x.inserted, y.inserted);
      methcla_boost::core::invoke_swap(x.position, y.position);
    }
  } // namespace unordered

  namespace serialization {
    template <class K, class H, class P, class A>
    struct version<methcla_boost::unordered_set<K, H, P, A> >
    {
      BOOST_STATIC_CONSTANT(int, value = 1);
    };

    template <class K, class H, class P, class A>
    struct version<methcla_boost::unordered_multiset<K, H, P, A> >
    {
      BOOST_STATIC_CONSTANT(int, value = 1);
    };
  } // namespace serialization
