...
/* methcla_boost::serialization::load_construct_adl(ar,t,version) requires user code
...
struct serialization_version
{
  serialization_version():
    value(methcla_boost::serialization::version<serialization_version>::value){}
...
template<typename T>
struct version<methcla_boost::unordered::detail::serialization_version<T> >
{
