...
namespace methcla_boost {
  namespace unordered {
    namespace detail {
      ...
      {
        typedef typename methcla_boost::pointer_traits<VoidPtr>::template rebind_to<
      ...
      template <class Bucket> struct bucket_group
      {
        ...
        typedef
          typename methcla_boost::pointer_traits<bucket_pointer>::template rebind_to<
      ...
      public:
        ...
        typedef typename methcla_boost::pointer_traits<bucket_pointer>::difference_type
          difference_type;
      ...
      public:
        ...
        pointer operator->() const noexcept { return methcla_boost::to_address(p); }
      ...
      private:
        ...
        void increment() noexcept
        {
          ...
          std::size_t n = std::size_t(methcla_boost::core::countr_zero(
          ...
          if (n < N) {
            ...
            std::ptrdiff_t x = methcla_boost::core::countr_zero(pbg->bitmask);
            p = pbg->buckets + x;
          }
        }
      ...
      class grouped_bucket_array
          : methcla_boost::empty_value<typename methcla_boost::allocator_rebind<Allocator,
              node<typename methcla_boost::allocator_value_type<Allocator>::type,
                typename methcla_boost::allocator_void_pointer<Allocator>::type> >::
                type>
      {
        typedef typename methcla_boost::allocator_value_type<Allocator>::type
          allocator_value_type;
        typedef
          typename methcla_boost::allocator_void_pointer<Allocator>::type void_pointer;
        typedef typename methcla_boost::allocator_difference_type<Allocator>::type
          difference_type;

      public:
        typedef typename methcla_boost::allocator_rebind<Allocator,
      ...
      private:
        typedef typename methcla_boost::allocator_rebind<Allocator, Bucket>::type
          bucket_allocator_type;
        typedef typename methcla_boost::allocator_pointer<bucket_allocator_type>::type
          bucket_pointer;
        typedef methcla_boost::pointer_traits<bucket_pointer> bucket_pointer_traits;

        typedef bucket_group<Bucket> group;
        typedef typename methcla_boost::allocator_rebind<Allocator, group>::type
          group_allocator_type;
        typedef typename methcla_boost::allocator_pointer<group_allocator_type>::type
          group_pointer;
        typedef typename methcla_boost::pointer_traits<group_pointer>
      ...
      public:
              ...
              size_index_(0), size_(0), buckets(), groups()
        {
          ...
          buckets = methcla_boost::allocator_allocate(bucket_alloc, num_buckets);
          BOOST_TRY
          {
            groups = methcla_boost::allocator_allocate(group_alloc, num_groups);

            bucket_type* pb = methcla_boost::to_address(buckets);
            for (size_type i = 0; i < num_buckets; ++i) {
              new (pb + i) bucket_type();
            }

            group* pg = methcla_boost::to_address(groups);
          ...
          BOOST_CATCH(...)
          {
            methcla_boost::allocator_deallocate(bucket_alloc, buckets, num_buckets);
            BOOST_RETHROW
          }
          BOOST_CATCH_END
...
#pragma warning(disable : 4100) // unreferenced formal parameter (dtor calls)
        ...
        void deallocate() noexcept
        {
          ...
          if (groups) {
            ...
            group_allocator_type group_alloc = this->get_group_allocator();
            methcla_boost::allocator_deallocate(group_alloc, groups, num_groups);
...
#pragma warning(pop)
        ...
        span<Bucket> raw()
        {
          ...
          return span<Bucket>(methcla_boost::to_address(buckets), size_);
        }
        ...
        void append_bucket_group(iterator itb) noexcept
        {
          ...
          if (is_empty_bucket) {
            ...
            std::size_t n =
              static_cast<std::size_t>(methcla_boost::to_address(pb) - &buckets[0]);
      ...
      private:
        ...
        void swap_allocator_if_pocs(grouped_bucket_array& other)
        {
          using allocator_pocs =
            typename methcla_boost::allocator_propagate_on_container_swap<
              allocator_type>::type;
        ...
        {
          methcla_boost::core::invoke_swap(
