  ...
  namespace unordered {
    ...
    namespace detail {
      ...
      struct enable_if_forward
          : std::enable_if<methcla_boost::unordered::detail::is_forward<I>::value,
              ReturnType>
      {
      };
...
namespace methcla_boost {
  namespace unordered {
    namespace detail {
      ...
      template <class I>
      inline typename methcla_boost::unordered::detail::enable_if_forward<I,
        std::size_t>::type
      insert_size(I i, I j)
      {
      ...
      template <class I>
      inline typename methcla_boost::unordered::detail::disable_if_forward<I,
        std::size_t>::type
      insert_size(I, I)
      {
        return 1;
      ...
      inline std::size_t initial_size(I i, I j,
        std::size_t num_buckets =
          methcla_boost::unordered::detail::default_bucket_count)
      {
        return (std::max)(
          methcla_boost::unordered::detail::insert_size(i, j), num_buckets);
      }
      ...
      struct compressed_base : methcla_boost::empty_value<T>
      {
        compressed_base(T const& x) : empty_value<T>(methcla_boost::empty_init_t(), x)
        {
        }
        compressed_base(T& x, move_tag)
            : empty_value<T>(methcla_boost::empty_init_t(), std::move(x))
        {
        }
      ...
      template <typename T, int Index>
      struct generate_base : methcla_boost::unordered::detail::compressed_base<T, Index>
      {
      ...
      struct compressed
          : private methcla_boost::unordered::detail::generate_base<T1, 1>::type,
            private methcla_boost::unordered::detail::generate_base<T2, 2>::type
      {
        ...
        {
          methcla_boost::core::invoke_swap(first(), x.first());
          methcla_boost::core::invoke_swap(second(), x.second());
        }
...
#pragma warning(pop)
      ...
      {
        methcla_boost::unordered::detail::value_base<T> value_;
        bool has_value_;

        void destroy()
        {
          if (has_value_) {
            methcla_boost::unordered::detail::func::destroy(value_.value_ptr());
            has_value_ = false;
          }
        }
        ...
        void move(optional<T>& x)
        {
          ...
          methcla_boost::unordered::detail::func::destroy(x.value_.value_ptr());
          has_value_ = true;
          x.has_value_ = false;
        }
      ...
      public:
        ...
        void swap(optional<T>& x)
        {
          if (has_value_ != x.has_value_) {
            ...
            methcla_boost::core::invoke_swap(value_.value(), x.value_.value());
          }
        }
...
namespace methcla_boost {
  namespace unordered {
    namespace detail {
      ...
      struct allocator_traits : methcla_boost::allocator_traits<Alloc>
      {
      };

      template <typename Alloc, typename T>
      struct rebind_wrap : methcla_boost::allocator_rebind<Alloc, T>
      {
      };
    } // namespace detail
  } // namespace unordered
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        template <typename A0> struct use_piecewise
        {
          ...
          enum
          {
            value = sizeof(choice1::type) ==
                    sizeof(test(choose(), methcla_boost::unordered::detail::make<A0>()))
          };
        };
        ...
        to_std_tuple_impl(methcla_boost::mp11::mp_list<Args...>,
          Tuple<TupleArgs...>& tuple, methcla_boost::mp11::index_sequence<Is...>)
        {
          (void)tuple;
          using std::get;
        ...
        template <template <class...> class Tuple, class... Args>
        methcla_boost::mp11::mp_transform<add_lvalue_reference_t,
          methcla_boost::mp11::mp_remove<std::tuple<Args...>,
            methcla_boost::tuples::null_type> >
        to_std_tuple(Tuple<Args...>& tuple)
        {
          using list = methcla_boost::mp11::mp_remove<methcla_boost::mp11::mp_list<Args...>,
            methcla_boost::tuples::null_type>;
          using list_size = methcla_boost::mp11::mp_size<list>;
          using index_seq = methcla_boost::mp11::make_index_sequence<list_size::value>;
        ...
        {
          methcla_boost::allocator_construct(alloc, address, std::piecewise_construct,
  ...
  namespace unordered {
    namespace detail {
      ...
      template <typename NodeAlloc> struct node_constructor
      {
        ...
        typedef methcla_boost::unordered::detail::allocator_traits<NodeAlloc>
      ...
      {
        if (node_) {
          methcla_boost::unordered::detail::func::destroy(methcla_boost::to_address(node_));
      ...
      template <typename Alloc> void node_constructor<Alloc>::create_node()
      {
        ...
        new ((void*)methcla_boost::to_address(node_)) node();
      }

      template <typename NodeAlloc> struct node_tmp
      {
        typedef typename methcla_boost::allocator_value_type<NodeAlloc>::type node;
        typedef typename methcla_boost::allocator_pointer<NodeAlloc>::type node_pointer;
        typedef typename node::value_type value_type;
        typedef typename methcla_boost::allocator_rebind<NodeAlloc, value_type>::type
          value_allocator;
      ...
      template <typename Alloc> node_tmp<Alloc>::~node_tmp()
      {
        if (node_) {
          ...
          methcla_boost::allocator_destroy(val_alloc, node_->value_ptr());
          methcla_boost::allocator_deallocate(alloc_, node_, 1);
        }
      }
    } // namespace detail
  } // namespace unordered
  ...
  namespace unordered {
    namespace detail {
      namespace func {
        ...
        inline typename methcla_boost::allocator_pointer<Alloc>::type
        construct_node_from_args(Alloc& alloc, Args&&... args)
        {
          typedef typename methcla_boost::allocator_value_type<Alloc>::type node;
          typedef typename node::value_type value_type;
          typedef typename methcla_boost::allocator_rebind<Alloc, value_type>::type
            value_allocator;
        ...
        inline typename methcla_boost::allocator_pointer<Alloc>::type construct_node(
          Alloc& alloc, U&& x)
        {
          node_constructor<Alloc> a(alloc);
          a.create_node();
        ...
        construct_node_pair(Alloc& alloc, Key&& k)
        {
          ...
          methcla_boost::allocator_construct(val_alloc, a.node_->value_ptr(),
    ...
    namespace detail {
      ...
      public:
        ...
        static const bool nothrow_swappable =
          methcla_boost::unordered::detail::is_nothrow_swappable<H>::value &&
          methcla_boost::unordered::detail::is_nothrow_swappable<P>::value;
      ...
      public:
        ...
        functions(functions& bf, methcla_boost::unordered::detail::move_tag)
            : current_(0)
        {
          construct_functions(current_, bf.current_functions(),
        ...
        {
          return *::methcla_boost::unordered::detail::launder(
      ...
      private:
          ...
          unsigned char which, function_pair& f, std::true_type)
        {
          ...
          new ((void*)&funcs_[which])
            function_pair(f, methcla_boost::unordered::detail::move_tag());
        }

        void destroy_functions(unsigned char which)
        {
          BOOST_ASSERT(!(which & 2));
          methcla_boost::unordered::detail::func::destroy(
...
#pragma warning(disable : 4127) // conditional expression is constant
      ...
      namespace iterator_detail {
        ...
        public:
          ...
          bool operator==(
            methcla_boost::unordered::detail::iterator_detail::c_iterator<Node,
        ...
        private:
          ...
          template <class Types> friend struct methcla_boost::unordered::detail::table;
          ...
          bool equal(
            const methcla_boost::unordered::detail::iterator_detail::c_iterator<Node,
        ...
        public:
          ...
          bool operator==(
            methcla_boost::unordered::detail::iterator_detail::iterator<Node,
              Bucket> const& other) const noexcept
          {
            return equal(other);
          }
      ...
      struct table : methcla_boost::unordered::detail::functions<typename Types::hasher,
      ...
      public:
        ...
        typedef methcla_boost::unordered::detail::functions<typename Types::hasher,
          typename Types::key_equal>
          functions;
        ...
        typedef methcla_boost::unordered::detail::grouped_bucket_array<
        ...
        typedef typename methcla_boost::allocator_pointer<node_allocator_type>::type
          node_pointer;

        typedef methcla_boost::unordered::detail::node_constructor<node_allocator_type>
          node_constructor;
        typedef methcla_boost::unordered::detail::node_tmp<node_allocator_type>
          node_tmp;
      ...
      public:
        ...
        std::size_t max_bucket_count() const
        {
          ...
          return size_policy::size(size_policy::size_index(
            methcla_boost::allocator_max_size(this->node_alloc())));
        }
        ...
        void recalculate_max_load()
        {
          ...
          max_load_ =
            bc == 0 ? 0
                    : methcla_boost::unordered::detail::double_to_size(
        ...
        table(table& x, methcla_boost::unordered::detail::move_tag m)
        ...
        table(table& x, value_allocator const& a,
          methcla_boost::unordered::detail::move_tag m)
        ...
        {
          methcla_boost::unordered::detail::func::ignore_unused_variable_warning(other);
        ...
        void swap(table& x, std::false_type)
        {
          ...
          methcla_boost::core::invoke_swap(size_, x.size_);
        ...
        void swap(table& x)
        {
          BOOST_ASSERT(methcla_boost::allocator_propagate_on_container_swap<
        ...
        void delete_node(node_pointer p)
        {
          ...
          value_allocator val_alloc(alloc);
          methcla_boost::allocator_destroy(val_alloc, p->value_ptr());
          methcla_boost::unordered::detail::func::destroy(methcla_boost::to_address(p));
          methcla_boost::allocator_deallocate(alloc, p, 1);
        }
        ...
        {
          typedef
            typename methcla_boost::allocator_propagate_on_container_copy_assignment<
          ...
          if (this != &x) {
            move_assign(x, is_unique,
              std::integral_constant<bool,
                methcla_boost::allocator_propagate_on_container_move_assignment<
                  node_allocator_type>::type::value>());
          }
        }
        ...
        emplace_return emplace_unique(const_key_type& k, Args&&... args)
        {
          ...
          if (pos) {
            ...
            node_tmp b(methcla_boost::unordered::detail::func::construct_node_from_args(
        ...
        emplace_return try_emplace_unique(Key&& k, Args&&... args)
        {
          ...
          node_tmp b(
            methcla_boost::unordered::detail::func::construct_node_pair_from_args(
        ...
        emplace_return insert_or_assign_unique(Key&& k, M&& obj)
        {
          ...
          node_tmp b(
            methcla_boost::unordered::detail::func::construct_node_pair(
        ...
        void merge_unique(methcla_boost::unordered::detail::table<Types2>& other)
        {
          typedef methcla_boost::unordered::detail::table<Types2> other_table;
        ...
        // safety. Strong otherwise
        template <class I>
        typename methcla_boost::unordered::detail::enable_if_forward<I, void>::type
        insert_range_equiv(I i, I j)
        {
          ...
          if (distance == 1) {
            emplace_equiv(methcla_boost::unordered::detail::func::construct_node(
              this->node_alloc(), *i));
          } else {
            ...
            for (; i != j; ++i) {
              emplace_no_rehash_equiv(
                methcla_boost::unordered::detail::func::construct_node(
                  this->node_alloc(), *i));
            }
          }
        }
        ...
        template <class I>
        typename methcla_boost::unordered::detail::disable_if_forward<I, void>::type
        insert_range_equiv(I i, I j)
        {
          for (; i != j; ++i) {
            emplace_equiv(methcla_boost::unordered::detail::func::construct_node(
      ...
      inline void table<Types>::rehash_impl(std::size_t num_buckets)
      {
        ...
        BOOST_TRY
        {
          methcla_boost::unordered::detail::span<bucket_type> bspan = buckets_.raw();
...
#pragma warning(pop)
      ...
      template <typename Key, typename T> struct is_key
      {
        ...
        enum
        {
          value = sizeof(test(methcla_boost::unordered::detail::make<T>())) ==
                  sizeof(choice2::type)
        };
      ...
      {
        typedef ValueType value_type;
        typedef typename std::remove_const<typename methcla_boost::unordered::detail::
        ...
        static auto extract(
          ...
          typename std::enable_if<
            !std::is_same<T, methcla_boost::tuples::null_type>::value,
