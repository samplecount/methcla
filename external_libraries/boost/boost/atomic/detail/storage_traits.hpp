...
{
    using type = methcla_boost::uint128_type BOOST_ATOMIC_DETAIL_MAY_ALIAS;

    static constexpr std::size_t native_alignment = atomics::detail::alignment_of< methcla_boost::uint128_type >::value;
    static constexpr std::size_t alignment = 16u;
};
...
union max_align_t
{
    ...
    methcla_boost::float128_type f128;
#endif
};
