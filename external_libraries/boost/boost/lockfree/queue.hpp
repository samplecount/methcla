 ...
 *
 *  \b Policies:
 *  - \ref methcla_boost::lockfree::fixed_sized, defaults to \c methcla_boost::lockfree::fixed_sized<false> \n
 ...
 *
 *  - \ref methcla_boost::lockfree::capacity, optional \n
 ...
 *
 *  - \ref methcla_boost::lockfree::allocator, defaults to \c methcla_boost::lockfree::allocator<std::allocator<void>> \n
...
public:
    ...
    explicit queue( typename methcla_boost::allocator_rebind< node_allocator, U >::type const& alloc ) :
        head_( tagged_node_handle( 0, 0 ) ),
        tail_( tagged_node_handle( 0, 0 ) ),
        pool( alloc, capacity )
    {
     ...
     * */
    template < typename U, typename Enabler = std::enable_if< !has_capacity > >
    queue( size_type n, typename methcla_boost::allocator_rebind< node_allocator, U >::type const& alloc ) :
        head_( tagged_node_handle( 0, 0 ) ),
        tail_( tagged_node_handle( 0, 0 ) ),
        pool( alloc, n + 1 )
    {
    ...
    /** \copydoc methcla_boost::lockfree::stack::reserve
     * */
    ...
    /** \copydoc methcla_boost::lockfree::stack::reserve_unsafe
     * */
    ...
    /// \copydoc methcla_boost::lockfree::queue::push(const T & t)
    bool push( T&& t )
    {
    ...
    /// \copydoc methcla_boost::lockfree::queue::bounded_push(const T & t)
...
public:
    ...
    /// \copydoc methcla_boost::lockfree::queue::unsynchronized_push(const T& t)
