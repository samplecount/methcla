...
typedef parameter::parameters< methcla_boost::parameter::optional< tag::allocator >, methcla_boost::parameter::optional< tag::capacity > >
    stack_signature;
 ...
 *  \b Policies:
 *
 *  - \c methcla_boost::lockfree::fixed_sized<>, defaults to \c methcla_boost::lockfree::fixed_sized<false> <br>
 ...
 *
 *  - \c methcla_boost::lockfree::capacity<>, optional <br>
 ...
 *
 *  - \c methcla_boost::lockfree::allocator<>, defaults to \c methcla_boost::lockfree::allocator<std::allocator<void>> <br>
...
public:
    ...
    explicit stack( typename methcla_boost::allocator_rebind< node_allocator, U >::type const& alloc ) :
        pool( alloc, capacity )
    {
        initialize();
    }
     ...
     * */
    template < typename U, typename Enabler = std::enable_if< !has_capacity > >
    stack( size_type n, typename methcla_boost::allocator_rebind< node_allocator, U >::type const& alloc ) :
        pool( alloc, n )
    {
        initialize();
    }
...
public:
    ...
    /// \copydoc methcla_boost::lockfree::stack::push(const T& t)
    bool push( T&& v )
    {
    ...
    /// \copydoc methcla_boost::lockfree::stack::bounded_push(const T& t)
    ...
    size_type push( methcla_boost::span< const T, Extent > t )
    {
     ...
     */
    template < std::size_t Extent >
    size_type bounded_push( methcla_boost::span< const T, Extent > t )
    {
    ...
    /// \copydoc methcla_boost::lockfree::stack::unsynchronized_push(const T& t)
     ...
     */
    template < std::size_t Extent >
    size_type unsynchronized_push( methcla_boost::span< const T, Extent > t )
    {
