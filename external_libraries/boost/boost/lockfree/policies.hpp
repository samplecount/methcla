...
struct fixed_sized : methcla_boost::parameter::template_keyword< tag::fixed_sized, std::integral_constant< bool, IsFixedSized > >
{};

template < size_t Size >
struct capacity : methcla_boost::parameter::template_keyword< tag::capacity, std::integral_constant< size_t, Size > >
{};

template < class Alloc >
struct allocator : methcla_boost::parameter::template_keyword< tag::allocator, Alloc >
{};

template < bool AllowMultipleReads >
struct allow_multiple_reads :
    methcla_boost::parameter::template_keyword< tag::allow_multiple_reads, std::integral_constant< bool, AllowMultipleReads > >
{};
