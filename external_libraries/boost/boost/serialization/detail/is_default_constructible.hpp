...
#include <boost/config.hpp>
    ...
    // so we fake it by using methcla_boost::has_trivial_construtor.  But this is not
    ...
    template<typename T>
    struct is_default_constructible : public methcla_boost::has_trivial_constructor<T> {};
