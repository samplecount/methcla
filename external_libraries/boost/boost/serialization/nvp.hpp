...
#define BOOST_SERIALIZATION_NVP(name)                       \
    methcla_boost::serialization::make_nvp(BOOST_PP_STRINGIZE(name), name)
/**/

#define BOOST_SERIALIZATION_BASE_OBJECT_NVP(name)           \
    methcla_boost::serialization::make_nvp(                         \
        BOOST_PP_STRINGIZE(name),                           \
        methcla_boost::serialization::base_object<name >(*this)     \
    )
/**/
...
struct is_wrapper<const nvp<T> > {
    typedef methcla_boost::mpl::true_ type;
};
template<class T>
