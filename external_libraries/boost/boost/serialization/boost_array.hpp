...
// implement serialization for methcla_boost::array
template <class Archive, class T, std::size_t N>
void serialize(Archive& ar, methcla_boost::array<T,N>& a, const unsigned int /* version */)
{
    ar & methcla_boost::serialization::make_nvp("elems", a.elems);
}
