    ...
    private methcla_boost::noncopyable
{
    ...
    friend
    BOOST_SERIALIZATION_DECL void const *
    methcla_boost::serialization::void_downcast(
        extended_type_info const & derived,
        extended_type_info const & base,
        void const * const
    );
    ...
    public void_caster
{
    void const * downcast(void const * const t) const BOOST_OVERRIDE {
        const Derived * d =
            methcla_boost::serialization::smart_cast<const Derived *, const Base *>(
    ...
    void const * upcast(void const * const t) const BOOST_OVERRIDE {
        const Base * b =
            methcla_boost::serialization::smart_cast<const Base *, const Derived *>(
...
private:
    static std::ptrdiff_t base_offset() {
        typename methcla_boost::aligned_storage<sizeof(Derived)>::type data;
...
{
    typedef
        typename mpl::eval_if<methcla_boost::is_virtual_base_of<Base,Derived>,
            mpl::identity<
