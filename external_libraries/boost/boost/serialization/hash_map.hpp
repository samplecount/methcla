...
struct archive_input_hash_map
{
    inline void operator()(
        ...
        std::pair<typename Container::const_iterator, bool> result =
            s.insert(methcla_boost::move(t.reference()));
...
inline void save(
    ...
    methcla_boost::serialization::stl::save_hash_collection<
        Archive,
...
inline void load(
    ...
    methcla_boost::serialization::stl::load_hash_collection<
        Archive,
        BOOST_STD_EXTENSION_NAMESPACE::hash_map<
            Key, T, HashFcn, EqualKey, Allocator
        >,
        methcla_boost::serialization::stl::archive_input_hash_map<
            Archive,
            BOOST_STD_EXTENSION_NAMESPACE::hash_map<
                Key, T, HashFcn, EqualKey, Allocator
            >
...
inline void load(
    ...
    methcla_boost::serialization::stl::load_hash_collection<
        ...
        BOOST_STD_EXTENSION_NAMESPACE::hash_multimap<
            Key, T, HashFcn, EqualKey, Allocator
        >,
        methcla_boost::serialization::stl::archive_input_hash_multimap<
            Archive,
            BOOST_STD_EXTENSION_NAMESPACE::hash_multimap<
                Key, T, HashFcn, EqualKey, Allocator
            >
