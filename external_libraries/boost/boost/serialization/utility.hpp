...
inline void serialize(
    ...
    typedef typename methcla_boost::remove_const<F>::type typef;
    ar & methcla_boost::serialization::make_nvp("first", const_cast<typef &>(p.first));
    ar & methcla_boost::serialization::make_nvp("second", p.second);
}
