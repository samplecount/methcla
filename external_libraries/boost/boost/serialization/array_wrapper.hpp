...
private:
    ...
    friend const methcla_boost::serialization::array_wrapper<Tx> make_array(Tx * t, S s);
public:
...
public:
    ...
    void serialize_optimized(Archive &ar, const unsigned int, mpl::false_ ) const
    {
      ...
      T * t = address();
      while(0 < c--)
            ar & methcla_boost::serialization::make_nvp("item", *t++);
    }
    ...
    {
      methcla_boost::serialization::split_member(ar, *this, version);
    }
