...
public:
    ...
    friend void methcla_boost::serialization::load(
        Archive & ar,
        SPT< U > &t,
        const unsigned int file_version
    );
    ...
    std::list<methcla_boost_132::shared_ptr<const void> > * m_pointers_132;
    void
    append(const methcla_boost_132::shared_ptr<const void> & t){
        if(NULL == m_pointers_132)
            m_pointers_132 = new std::list<methcla_boost_132::shared_ptr<const void> >;
    ...
    struct non_polymorphic {
        template<class U>
        static const methcla_boost::serialization::extended_type_info *
        get_object_type(U & ){
            return & methcla_boost::serialization::singleton<
                typename
                methcla_boost::serialization::type_info_implementation< U >::type
            >::get_const_instance();
        }
    };
    struct polymorphic {
...
public:
    ...
    void reset(SPT< T > & s, T * t){
        ...
        const methcla_boost::serialization::extended_type_info * this_type
        ...
        if(NULL == true_type)
            methcla_boost::serialization::throw_exception(
                methcla_boost::archive::archive_exception(
                    methcla_boost::archive::archive_exception::unregistered_class,
        ...
        if(NULL == oid)
            methcla_boost::serialization::throw_exception(
                methcla_boost::archive::archive_exception(
                    methcla_boost::archive::archive_exception::unregistered_cast,
