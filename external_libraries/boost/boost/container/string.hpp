...
class basic_string_base
{
 ...
 public:
   ...
   typedef ::methcla_boost::intrusive::pointer_traits<pointer> pointer_traits;
      ...
      :  public allocator_type
   {
      ...
      inline explicit members_holder(BOOST_FWD_REF(AllocatorConvertible) a)
         :  allocator_type(methcla_boost::forward<AllocatorConvertible>(a))
      { this->init(); }
   ...
   typedef dtl::integral_constant<unsigned,
      methcla_boost::container::dtl::version<allocator_type>::value> alloc_version;
   ...
   size_type next_storage(size_type additional_objects, size_type current_storage) const
   {
      ...
      if ( achievable_additional_obj < min_additional_obj )
         methcla_boost::container::throw_length_error("get_next_capacity, allocator or storage_size_type's max size reached");
   ...
   {
      value_type *raw_p = methcla_boost::movelib::to_raw_pointer(p);
      for(; n--; ++raw_p){
   ...
   inline void destroy(pointer p)
   {
      allocator_traits_type::destroy
         ( this->alloc()
         , methcla_boost::movelib::to_raw_pointer(p)
         );
   }
   ...
   void swap_data(basic_string_base& other)
   {
      if(this->is_short()){
         ...
         if(other.is_short()){
            ...
            methcla_boost::adl_move_swap(*this->members_.plong_repr(), *other.members_.plong_repr());
         }
      }
   }
};
...
//! \tparam Options A type produced from \c methcla_boost::container::string_options.
   ...
   :  private dtl::basic_string_base<typename real_allocator<CharT, Allocator>::type, Options>
{
   ...
   struct Not_within_traits
   {
      ...
      {
         return methcla_boost::container::find_if(m_first, m_last,
                        methcla_boost::container::bind1st(Eq_traits<Tr>(), x)) == m_last;
      }
   };
   #endif   //#ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
   ...
   basic_string(BOOST_RV_REF(basic_string) s) BOOST_NOEXCEPT_OR_NOTHROW
      : base_t(methcla_boost::move(s.alloc()))
   {
                                  ...
                                  || allocator_traits_type::is_always_equal::value)
   {
      if (BOOST_LIKELY(this != &x)) {
         ...
         this->priv_move_assign(methcla_boost::move(x), flag);
      }
      return *this;
   }
   ...
   void shrink_to_fit()
   {
      ...
      if(this->priv_storage() > InternalBufferChars){
         ...
         if(this->priv_size() < InternalBufferChars){
            ...
            Traits::copy( methcla_boost::movelib::to_raw_pointer(this->priv_short_addr())
                        , methcla_boost::movelib::to_raw_pointer(long_addr)
                        , long_size+1);
            BOOST_ASSERT(!this->is_short());
            this->destroy_long();
   ...
   {  return this->operator=(methcla_boost::move(s)); }
   ...
   //! <b>Effects</b>: Equivalent to assign(basic_string(first, last)).
    ...
    basic_string& assign(const CharT* first, const CharT* last)
    {
       ...
       this->reserve(n);
       CharT* const ptr = methcla_boost::movelib::to_raw_pointer(this->priv_addr());
      ...
      )
   {
      size_type cur = 0;
      const pointer addr = this->priv_addr();
      CharT *ptr = methcla_boost::movelib::to_raw_pointer(addr);
      const size_type old_size = this->priv_size();
   ...
   basic_string& insert(size_type pos1, const basic_string& s, size_type pos2, size_type n = npos)
   {
      ...
      if (sz > this->max_size() - len)
         throw_length_error("basic_string::insert max_size() exceeded");
      const CharT *beg_ptr = methcla_boost::movelib::to_raw_pointer(s.begin()) + pos2;
   ...
   basic_string& insert(size_type pos1, BasicStringView<CharT, Traits> sv, size_type pos2, size_type n = npos)
   {
      ...
      if (sz > this->max_size() - len)
         throw_length_error("basic_string::insert max_size() exceeded");
      const CharT *beg_ptr = methcla_boost::movelib::to_raw_pointer(sv.begin()) + pos2;
      const CharT *end_ptr = beg_ptr + len;
      this->insert(this->priv_addr() + pos1, beg_ptr, end_ptr);
      return *this;
   }
      ...
      )
   {
      ...
      if (first != last) {
         const size_type n = methcla_boost::container::iterator_udistance(first, last);
         const size_type old_size = this->priv_size();
         ...
         if(enough_capacity){
            ...
            if (elems_after >= n) {
               ...
               Traits::move(const_cast<CharT*>(methcla_boost::movelib::to_raw_pointer(p + difference_type(n))),
                           methcla_boost::movelib::to_raw_pointer(p),
                           (elems_after - n) + 1u);
               (priv_copy)(first, last, const_cast<CharT*>(methcla_boost::movelib::to_raw_pointer(p)));
               new_size = old_size + n;
            }
            else {
               ForwardIter mid = first;
               methcla_boost::container::iterator_uadvance(mid, elems_after + 1u);
               ...
               (priv_copy)(first, mid, const_cast<CharT*>(methcla_boost::movelib::to_raw_pointer(p)));
            ...
            if(!hint){
               ...
               //than with vector<T>
               value_type * const oldbuf     = methcla_boost::movelib::to_raw_pointer(old_start);
               value_type * const newbuf     = methcla_boost::movelib::to_raw_pointer(new_start);
               const value_type *const pos   = methcla_boost::movelib::to_raw_pointer(p);
   ...
   iterator erase(const_iterator p) BOOST_NOEXCEPT_OR_NOTHROW
   {
      ...
      CharT * const ptr = const_cast<CharT*>(methcla_boost::movelib::to_raw_pointer(p));
      const size_type old_size = this->priv_size();
      Traits::move(ptr,
                   methcla_boost::movelib::to_raw_pointer(p + 1),
   ...
   {
      CharT * f = const_cast<CharT*>(methcla_boost::movelib::to_raw_pointer(first));
      if (first != last) { // The move includes the terminating null.
         const size_type num_erased = size_type(last - first);
         const size_type old_size = this->priv_size();
         Traits::move(f,
                      methcla_boost::movelib::to_raw_pointer(last),
   ...
   basic_string& replace(const_iterator i1, const_iterator i2, size_type n, CharT c)
   {
      ...
      if (len >= n) {
         Traits::assign(const_cast<CharT*>(methcla_boost::movelib::to_raw_pointer(i1)), n, c);
         erase(i1 + difference_type(n), i2);
      }
      else {
         Traits::assign(const_cast<CharT*>(methcla_boost::movelib::to_raw_pointer(i1)), len, c);
         insert(i2, n - len, c);
      }
      return *this;
   }
      ...
      )
   {
      for ( ; i1 != i2 && j1 != j2; ++i1, ++j1){
         Traits::assign(*const_cast<CharT*>(methcla_boost::movelib::to_raw_pointer(i1)), *j1);
      }
   ...
   {
      difference_type n = methcla_boost::container::iterator_distance(j1, j2);
      const difference_type len = i2 - i1;
      if (len >= n) {
         this->priv_copy(j1, j2, const_cast<CharT*>(methcla_boost::movelib::to_raw_pointer(i1)));
         this->erase(i1 + difference_type(n), i2);
      }
      else {
         ForwardIter m = j1;
         methcla_boost::container::iterator_advance(m, len);
         this->priv_copy(j1, m, const_cast<CharT*>(methcla_boost::movelib::to_raw_pointer(i1)));
         this->insert(i2, m, j2);
      }
      return *this;
   }
   ...
   size_type copy(CharT* s, size_type n, size_type pos = 0) const
   {
      ...
      Traits::copy(s, methcla_boost::movelib::to_raw_pointer(this->priv_addr() + pos), len);
      return len;
   }
   ...
   {  return methcla_boost::movelib::to_raw_pointer(this->priv_addr()); }
      ...
      size_type find(const CharT* s, size_type pos, size_type n) const
   {
      ...
      if (pos + n > this->size())
         ...
         const const_iterator result =
            methcla_boost::container::search(methcla_boost::movelib::to_raw_pointer(addr + difference_type(pos)),
                   methcla_boost::movelib::to_raw_pointer(finish),
      ...
      size_type find(CharT c, size_type pos = 0) const
   {
      ...
      if (pos >= sz)
         ...
         const const_iterator result =
            methcla_boost::container::find_if(addr + difference_type(pos), finish,
                  methcla_boost::container::bind2nd(Eq_traits<Traits>(), c));
         return result != finish ? size_type(result - begin()) : npos;
      }
   }
      ...
      size_type rfind(const CharT* s, size_type pos, size_type n) const
   {
      ...
      if (n > len)
         ...
         const const_iterator result = methcla_boost::container::find_end
      ...
      size_type rfind(CharT c, size_type pos = npos) const
   {
      ...
      if (len < 1)
         ...
         const_reverse_iterator rresult =
            methcla_boost::container::find_if(const_reverse_iterator(last), rend(),
                  methcla_boost::container::bind2nd(Eq_traits<Traits>(), c));
      ...
      size_type find_first_of(const CharT* s, size_type pos, size_type n) const
   {
      ...
      if (pos >= sz)
         ...
         const pointer addr    = this->priv_addr();
         pointer finish = addr + difference_type(sz);
         const_iterator result = methcla_boost::container::find_first_of
      ...
      size_type find_last_of(const CharT* s, size_type pos, size_type n) const
   {
      ...
      if (len < 1)
         ...
         const const_reverse_iterator rresult =
            methcla_boost::container::find_first_of(const_reverse_iterator(last), rend(),
                               s, s + difference_type(n), Eq_traits<Traits>());
      ...
      size_type find_first_not_of(const CharT* s, size_type pos, size_type n) const
   {
      ...
      if (pos > this->size())
         ...
         const const_iterator result = methcla_boost::container::find_if
      ...
      size_type find_first_not_of(CharT c, size_type pos = 0) const
   {
      if (pos > this->size())
         ...
         const const_iterator result
            = methcla_boost::container::find_if(addr + difference_type(pos), finish,
                     methcla_boost::container::not1(methcla_boost::container::bind2nd(Eq_traits<Traits>(), c)));
         return result != finish ? size_type(result - begin()) : npos;
      }
   }
   ...
   void priv_move_assign(BOOST_RV_REF(basic_string) x, dtl::bool_<false> /*steal_resources*/)
   {
      ...
      if (this->alloc() == x.alloc()) {
         this->priv_move_assign(methcla_boost::move(x), dtl::true_());
      }
      else {
         this->assign(x.begin(), x.end());
      }
   ...
   static int s_compare(It1 f1, It1 l1, It2 f2, It2 l2)
   {
      ...
      const int cmp = Traits::compare(methcla_boost::movelib::to_raw_pointer(f1),
                                      methcla_boost::movelib::to_raw_pointer(f2),
                                      dtl::min_value(n1, n2));
      ...
      , typename dtl::enable_if<dtl::is_same<AllocVersion, version_1> >::type* = 0)
   {
      ...
      BOOST_CONTAINER_TRY{
         ...
         //Copy and update
         Traits::copy( methcla_boost::movelib::to_raw_pointer(ret)
                     , methcla_boost::movelib::to_raw_pointer(this->priv_long_addr())
                     , long_size+1);
   ...
   inline basic_string& priv_replace_dispatch(const_iterator first, const_iterator last,
                                       ...
                                       dtl::false_)
   {
      typedef typename methcla_boost::container::iterator_traits<InputIter>::iterator_category Category;
...
struct has_trivial_destructor_after_move<methcla_boost::container::basic_string<C, T, Allocator> >
{
   typedef typename methcla_boost::container::basic_string<C, T, Allocator>::allocator_type allocator_type;
   typedef typename ::methcla_boost::container::allocator_traits<allocator_type>::pointer pointer;
   BOOST_STATIC_CONSTEXPR bool value =
      ::methcla_boost::has_trivial_destructor_after_move<allocator_type>::value &&
