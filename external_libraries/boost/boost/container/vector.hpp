...
struct is_version_0_alloc_and_trivially_destructible
   : methcla_boost::move_detail::is_trivially_destructible<typename Alloc::value_type>
{ };
...
struct vec_on_type_overflow
{
   ...
   struct throw_length_error
   {
      ...
      void operator()()
      {
         methcla_boost::container::throw_length_error(m_str);
      }
   };
...
class vec_iterator
{
   ...
   #endif
   typedef typename methcla_boost::intrusive::pointer_traits<Pointer>::element_type         value_type;
   ...
   //Define element_
   typedef typename methcla_boost::intrusive::pointer_traits<Pointer>::element_type         element_type;
   #endif
   typedef typename methcla_boost::intrusive::pointer_traits<Pointer>::difference_type      difference_type;
   typedef typename methcla_boost::intrusive::pointer_traits<Pointer>::size_type            size_type;
   typedef typename dtl::if_c
      < IsConst
      , typename methcla_boost::intrusive::pointer_traits<Pointer>::template
                                 rebind_pointer<const value_type>::type
      , Pointer
      >::type                                                                       pointer;
   typedef typename methcla_boost::intrusive::pointer_traits<pointer>                       ptr_traits;
   ...
   : public Allocator
{
   ...
   typedef methcla_boost::container::allocator_traits<allocator_type>  allocator_traits_type;
   ...
   explicit vector_alloc_holder(BOOST_FWD_REF(AllocConvertible) a) BOOST_NOEXCEPT_OR_NOTHROW
      : allocator_type(methcla_boost::forward<AllocConvertible>(a)), m_start(), m_size(), m_capacity()
   {}
   ...
   vector_alloc_holder(vector_uninitialized_size_t, BOOST_FWD_REF(AllocConvertible) a, SizeType initial_size)
      : allocator_type(methcla_boost::forward<AllocConvertible>(a))
      , m_start()
   ...
   vector_alloc_holder(initial_capacity_t, pointer p, size_type n, BOOST_FWD_REF(AllocFwd) a)
      : allocator_type(::methcla_boost::forward<AllocFwd>(a))
      , m_start(p)
      , m_size()
      , m_capacity(n)
   {}
   ...
   inline pointer allocation_command(methcla_boost::container::allocation_type command,
   ...
   inline pointer allocate(size_type n)
   {
      ...
      if (BOOST_UNLIKELY(max < n) )
         methcla_boost::container::throw_length_error("get_next_capacity, allocator's max size reached");
   ...
   {
      methcla_boost::adl_move_swap(this->m_start, x.m_start);
      methcla_boost::adl_move_swap(this->m_size, x.m_size);
      methcla_boost::adl_move_swap(this->m_capacity, x.m_capacity);
   }
   ...
   pointer priv_allocation_command(version_1, methcla_boost::container::allocation_type command,
   ...
   pointer priv_allocation_command(version_2, methcla_boost::container::allocation_type command,
                         size_type limit_size,
                         size_type &prefer_in_recvd_out_size,
                         pointer &reuse)
   {
   ...
   : public Allocator
{
   ...
   public:
   typedef Allocator                                     allocator_type;
   typedef methcla_boost::container::
   ...
   template<class AllocConvertible>
   explicit vector_alloc_holder(BOOST_FWD_REF(AllocConvertible) a) BOOST_NOEXCEPT_OR_NOTHROW
      : allocator_type(methcla_boost::forward<AllocConvertible>(a)), m_size()
   {}
   ...
   {
      ::methcla_boost::container::uninitialized_move_alloc_n
         (this->alloc(), methcla_boost::movelib::to_raw_pointer(holder.start()), m_size, methcla_boost::movelib::to_raw_pointer(this->start()));
      ::methcla_boost::container::destroy_alloc_n
         (this->alloc(), methcla_boost::movelib::to_raw_pointer(holder.start()), m_size);
      holder.m_size = 0;
   }
      ...
      , m_size(holder.m_size) //Initialize it to m_size as first_allocation can only succeed or abort
   {
      ...
      ::methcla_boost::container::uninitialized_move_alloc_n
         (this->alloc(), methcla_boost::movelib::to_raw_pointer(holder.start()), n, methcla_boost::movelib::to_raw_pointer(this->start()));
   }
   ...
   void priv_deep_swap(vector_alloc_holder<OtherAllocator, OtherStoredSizeType, OtherAllocatorVersion> &x)
   {
      ...
      value_type *const first_this = methcla_boost::movelib::to_raw_pointer(this->start());
      value_type *const first_x = methcla_boost::movelib::to_raw_pointer(x.start());

      if(this->m_size < x.m_size){
         methcla_boost::container::deep_swap_alloc_n<MaxTmpStorage>(this->alloc(), first_this, this->m_size, first_x, x.m_size);
      }
      else{
         methcla_boost::container::deep_swap_alloc_n<MaxTmpStorage>(this->alloc(), first_x, x.m_size, first_this, this->m_size);
      }
      methcla_boost::adl_move_swap(this->m_size, x.m_size);
   }
};
...
//! \tparam Options A type produced from \c methcla_boost::container::vector_options.
...
public:
   ...
   typedef ::methcla_boost::container::allocator_traits<allocator_type>                        allocator_traits_t;
   ...
   typedef BOOST_CONTAINER_IMPDEF(methcla_boost::container::reverse_iterator<iterator>)        reverse_iterator;
   typedef BOOST_CONTAINER_IMPDEF(methcla_boost::container::reverse_iterator<const_iterator>)  const_reverse_iterator;
...
private:
   ...
   typedef typename methcla_boost::container::
   ...
   typedef typename dtl::version<allocator_type>::type alloc_version;
   typedef methcla_boost::container::vector_alloc_holder
   ...
   inline vector(initial_capacity_t, pointer initial_memory, size_type cap, BOOST_FWD_REF(AllocFwd) a)
      : m_holder(initial_capacity_t(), initial_memory, cap, ::methcla_boost::forward<AllocFwd>(a))
   {}
      ...
      : m_holder(initial_capacity_t(), initial_memory, cap, ::methcla_boost::forward<AllocFwd>(a))
   {
      ...
      if (this->template is_propagable_from<true>(x.get_stored_allocator(), x.data(), this_al)) {
         ...
         ::methcla_boost::container::uninitialized_move_alloc_n_source
            ( this_al, x.priv_raw_begin(), sz
            //Use launder to stop false positives from -Warray-bounds
            , methcla_boost::move_detail::launder(this->priv_raw_begin()));
   ...
   inline vector(maybe_initial_capacity_t, pointer p, SizeType initial_capacity, BOOST_FWD_REF(AllocFwd) a)
      : m_holder(maybe_initial_capacity_t(), p, initial_capacity, ::methcla_boost::forward<AllocFwd>(a))
   {
      #ifdef BOOST_CONTAINER_VECTOR_ALLOC_STATS
      ...
      :  m_holder(vector_uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      methcla_boost::container::uninitialized_value_init_alloc_n
      ...
      :  m_holder(vector_uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      methcla_boost::container::uninitialized_default_init_alloc_n
         (this->m_holder.alloc(), n, this->priv_raw_begin());
   }
      ...
      :  m_holder(vector_uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      methcla_boost::container::uninitialized_fill_alloc_n
                 ...
                 , x.size())
   {
      ...
      #endif
      ::methcla_boost::container::uninitialized_copy_alloc_n
   ...
   vector(BOOST_RV_REF(vector) x) BOOST_NOEXCEPT_OR_NOTHROW
      :  m_holder(methcla_boost::move(x.m_holder))
      ...
      :  m_holder(vector_uninitialized_size, a, il.size())
   {
      ...
      #endif
      ::methcla_boost::container::uninitialized_copy_alloc_n_source
   ...
   {
      if (BOOST_LIKELY(&x != this)){
         this->priv_move_assign(methcla_boost::move(x));
      }
      return *this;
   }
      ...
      )
   {
      ...
      if (first == last){
         ...
         const size_type n = static_cast<size_type>(end_pos - methcla_boost::movelib::iterator_to_raw_pointer(cur));
      ...
      )
   {
      ...
      const it_size_type sz = methcla_boost::container::iterator_udistance(first, last);
      ...
      methcla_boost::container::copy_assign_range_alloc_n(this->m_holder.alloc(), first, input_sz, this->priv_raw_begin(), this->size());
   ...
   inline reference emplace_back(BOOST_FWD_REF(Args)...args)
   {
      ...
      if (BOOST_LIKELY(this->room_enough())){
         ...
         allocator_traits_type::construct(this->m_holder.alloc(), p, ::methcla_boost::forward<Args>(args)...);
         ...
         return *this->priv_insert_forward_range_no_capacity
            (p, 1, proxy_t(::methcla_boost::forward<Args>(args)...), alloc_version());
      }
   }
   ...
   inline bool stable_emplace_back(BOOST_FWD_REF(Args)...args)
   {
      ...
      if (BOOST_LIKELY(is_room_enough)){
         //There is more memory, just construct a new object at the end
         allocator_traits_type::construct(this->m_holder.alloc(), this->priv_raw_end(), ::methcla_boost::forward<Args>(args)...);
         ++this->m_holder.m_size;
      }
   ...
   inline iterator emplace(const_iterator position, BOOST_FWD_REF(Args) ...args)
   {
      ...
      return this->priv_insert_forward_range( vector_iterator_get_ptr(position), 1
                                            , proxy_t(::methcla_boost::forward<Args>(args)...));
   }
   ...
   //!
   //! <b>Complexity</b>: Linear to methcla_boost::container::iterator_distance [first, last).
   template <class InIt>
   ...
   //!   be equal to methcla_boost::container::iterator_distance(first, last)
   //!
   //! <b>Effects</b>: Insert a copy of the [first, last) range before pos.
   //!
   //! <b>Returns</b>: an iterator to the first inserted element or pos if first == last.
   ...
   //! <b>Complexity</b>: Linear to methcla_boost::container::iterator_distance [first, last).
   //!
   //! <b>Note</b>: This function avoids a linear operation to calculate methcla_boost::container::iterator_distance[first, last)
   ...
   inline iterator insert(const_iterator pos, size_type num, InIt first, InIt last)
   {
      ...
      BOOST_ASSERT(dtl::is_input_iterator<InIt>::value ||
                   num == methcla_boost::container::iterator_udistance(first, last));
      (void)last;
   ...
   iterator erase(const_iterator position)
   {
      ...
      T *const pos_ptr = methcla_boost::movelib::to_raw_pointer(p);
      T *const end_ptr = this->priv_raw_end();

      //Move elements forward and destroy last
      (void)::methcla_boost::container::move(pos_ptr + 1, end_ptr, pos_ptr);
   ...
   iterator erase(const_iterator first, const_iterator last)
   {
      ...
      if(first != last){
         ...
         T* const first_ptr = methcla_boost::movelib::to_raw_pointer(vector_iterator_get_ptr(first));
         T* const last_ptr  = methcla_boost::movelib::to_raw_pointer(vector_iterator_get_ptr(last));
         T* const new_last_ptr = methcla_boost::movelib::to_raw_pointer(methcla_boost::container::move(last_ptr, old_end_ptr, first_ptr));
         ...
         if(!value_traits::trivial_dctr_after_move || old_end_ptr == last_ptr){
            methcla_boost::container::destroy_alloc_n(this->get_stored_allocator(), new_last_ptr, n);
         }
   ...
   {  return x.size() == y.size() && ::methcla_boost::container::algo_equal(x.begin(), x.end(), y.begin());  }
   ...
   {  return methcla_boost::container::algo_lexicographical_compare(x.begin(), x.end(), y.begin(), y.end());  }
      ...
      merge(InputIt first, InputIt last, Compare comp)
   {
      ...
      if(free_cap < (n = methcla_boost::container::iterator_udistance(first, last))){
      ...
      merge_unique(InputIt first, InputIt last, Compare comp)
   {
      ...
      methcla_boost::movelib::adaptive_merge(raw_beg, raw_pos, raw_end, comp, raw_end, this->capacity() - this->size());
   }
      ...
      merge_unique(InputIt first, InputIt last, Compare comp)
   {
      ...
      const iterator e = methcla_boost::movelib::inplace_set_unique_difference(pos, this->end(), this->begin(), pos, comp);
      this->erase(e, this->end());
      methcla_boost::movelib::adaptive_merge( this->begin(), pos, e, comp
   ...
   void priv_merge_in_new_buffer(FwdIt first, size_type n, Compare comp, Version)
   {
      ...
      T* d_first = methcla_boost::movelib::to_raw_pointer(new_storage);
      size_type added = n;
      //Merge in new buffer loop
      while(1){
         if(!n) {
            ::methcla_boost::container::uninitialized_move_alloc(this->m_holder.alloc(), pbeg, pend, d_first);
            break;
         } 
         else if(pbeg == pend) {
            ::methcla_boost::container::uninitialized_move_alloc_n(this->m_holder.alloc(), first, n, d_first);
            break;
         }
         //maintain stability moving external values only if they are strictly less
            ...
            allocator_traits_type::construct( this->m_holder.alloc(), d_first, methcla_boost::move(*pbeg) );
            new_values_destroyer.increment_size(1u);
            ++pbeg;
            ++d_first;
         }
      ...
      methcla_boost::container::destroy_alloc_n(a, methcla_boost::movelib::to_raw_pointer(old_p), old_size);
      if (old_cap > 0) {
         ...
         < dtl::is_version<typename real_allocator<T, OtherA>::type, 0>::value >::type * = 0)
   {
      ...
      methcla_boost::container::move_assign_range_alloc_n(this->m_holder.alloc(), other_start, other_sz, this_start, this_sz);
   ...
   void priv_move_assign_steal_or_assign(BOOST_RV_REF_BEG vector<T, OtherA, Options> BOOST_RV_REF_END x, dtl::false_type /*data_can_be_always_stolen*/)
   {
      ...
      if (is_buffer_propagable_from_x) {
         this->priv_move_assign_steal_or_assign(methcla_boost::move(x), dtl::true_type());
      }
      //Else do a one by one move. Also, clear the source as users find confusing
      //elements are still alive in the source container.
      else {
         this->assign( methcla_boost::make_move_iterator(methcla_boost::movelib::iterator_to_raw_pointer(x.begin()))
                     , methcla_boost::make_move_iterator(methcla_boost::movelib::iterator_to_raw_pointer(x.end()))   );
         x.clear();
      }
   }
         ...
         >::type * = 0)
   {
      ...
      this->priv_move_assign_steal_or_assign(methcla_boost::move(x), dtl::bool_<data_can_be_always_be_stolen>());
         ...
         < dtl::is_version<typename real_allocator<T, OtherA>::type, 0>::value >::type * = 0)
   {
      ...
      const size_type this_sz  = m_holder.m_size;
      const size_type other_sz = static_cast<size_type>(x.m_holder.m_size);
      methcla_boost::container::copy_assign_range_alloc_n(this->m_holder.alloc(), other_start, other_sz, this_start, this_sz);
      m_holder.set_stored_size(other_sz);
   }
   ...
   void prot_swap_small(Vector &x, std::size_t internal_capacity)  //version_N
   {
      ...
      if(internal_capacity && (is_this_data_propagable || is_that_data_propagable)) {
         ...
         for(size_type i = 0; i != common_elements; ++i){
            methcla_boost::adl_move_swap(sml[i], big[i]);
         }
         ...
         T *const raw_big_nth = methcla_boost::movelib::iterator_to_raw_pointer(big.nth(common_elements));
         sml.insert(sml.cend()
            , methcla_boost::make_move_iterator(raw_big_nth)
            , methcla_boost::make_move_iterator(methcla_boost::movelib::iterator_to_raw_pointer(big.end())));
   ...
   inline dtl::insert_range_proxy<allocator_type, methcla_boost::move_iterator<T*> > priv_dummy_empty_proxy()
   {
      return dtl::insert_range_proxy<allocator_type, methcla_boost::move_iterator<T*> >
         (::methcla_boost::make_move_iterator((T *)0));
   }
   ...
   inline void priv_move_to_new_buffer(size_type new_cap, version_1)
   {
      ...
      this->priv_insert_forward_range_new_allocation
         ( methcla_boost::movelib::to_raw_pointer(p), new_cap, this->priv_raw_end(), 0, this->priv_dummy_empty_proxy());
   }
   ...
   void priv_move_to_new_buffer(size_type new_cap, version_2)
   {
      ...
      if(same_buffer_start){
         ...
         T * const new_mem = methcla_boost::movelib::to_raw_pointer(ret);
   ...
   void priv_destroy_last_n(const size_type n) BOOST_NOEXCEPT_OR_NOTHROW
   {
      ...
      methcla_boost::container::destroy_alloc_n(this->get_stored_allocator(), this->priv_raw_end() - n, n);
      this->m_holder.dec_stored_size(n);
   }
   ...
   void priv_uninitialized_construct_at_end(InpIt first, InpIt last)
   {
      ...
      T* const new_end_pos = methcla_boost::container::uninitialized_copy_alloc(this->m_holder.alloc(), first, last, old_end_pos);
   ...
   {
      return this->emplace(p, ::methcla_boost::forward<U>(u));
   }

   template <class U>
   BOOST_CONTAINER_FORCEINLINE void priv_push_back(BOOST_FWD_REF(U) u)
   {
      this->emplace_back(::methcla_boost::forward<U>(u));
   }

   //Overload to support compiler errors that instantiate too much
   inline void priv_push_back(::methcla_boost::move_detail::nat)
   {}

   inline iterator priv_insert(const_iterator, ::methcla_boost::move_detail::nat)
   {  return iterator();  }
   ...
   void prot_shrink_to_fit_small(pointer const small_buffer, const size_type small_capacity)
   {
      ...
      if (cp && this->m_holder.m_start != small_buffer) {   //Do something only if a dynamic buffer is used
         ...
         if (!sz) {
            ...
            T *const oldbuf = methcla_boost::movelib::to_raw_pointer(this->m_holder.m_start);
            ::methcla_boost::container::uninitialized_move_alloc_n
               ( this->get_stored_allocator()
               , oldbuf
               , sz
               , methcla_boost::movelib::to_raw_pointer(small_buffer)
               );
            methcla_boost::container::destroy_alloc_n(this->get_stored_allocator(), oldbuf, sz);
      ...
      (T *const raw_pos, const size_type n, const InsertionProxy insert_range_proxy, version_1)
   {
      ...
      //Pass the hint so that allocators can take advantage of this.
      T * const new_buf = methcla_boost::movelib::to_raw_pointer(this->m_holder.allocate(new_cap));
      #ifdef BOOST_CONTAINER_VECTOR_ALLOC_STATS
      ++this->num_alloc;
      #endif
      ...
      (T *const raw_pos, const size_type n, const InsertionProxy insert_range_proxy, version_2)
   {
      ...
      if(reuse){
         ...
         //Backwards (and possibly forward) expansion
            ...
            #endif
            this->priv_insert_forward_range_expand_backwards
               (methcla_boost::movelib::to_raw_pointer(ret), real_cap, raw_pos, n, insert_range_proxy);
         }
      }
      //New buffer
      else{
      ...
      (const pointer &pos, const size_type n, const InsertionProxy insert_range_proxy)
   {
      ...
      T *const p = methcla_boost::movelib::to_raw_pointer(pos);
      //Check if we have enough memory or try to expand current memory
      ...
      (size_type first_pos, size_type last_pos, size_type limit_pos, size_type shift_count)
   {
      ...
      if((last_pos + shift_count) <= limit_pos){
         //All move assigned
         methcla_boost::container::move_backward(first_ptr, last_ptr, last_ptr + shift_count);
      }
      //Case B:
      else if((first_pos + shift_count) >= limit_pos){
         //All uninitialized_moved
         ::methcla_boost::container::uninitialized_move_alloc
      ...
      //Case C:
         ...
         ::methcla_boost::container::uninitialized_move_alloc(this->m_holder.alloc(), boundary_ptr, last_ptr, limit_ptr);
         //The rest is move assigned
         methcla_boost::container::move_backward(first_ptr, boundary_ptr, limit_ptr);
      }
      return hole_size;
   }
   ...
   {  return methcla_boost::movelib::to_raw_pointer(m_holder.start());  }
      ...
      (T* const raw_pos, const size_type, InsertionProxy insert_range_proxy, dtl::true_type)
   {
      ...
      if (old_finish == raw_pos){
         ...
         allocator_traits_type::construct(a, old_finish, ::methcla_boost::move(*before_old_finish));
         ++this->m_holder.m_size;
         //Copy previous to last objects to the initialized end
         methcla_boost::container::move_backward(raw_pos, before_old_finish, old_finish);
   ...
   {
      //There is enough memory
      methcla_boost::container::expand_forward_and_insert_alloc
      ...
      (T* const new_start, size_type new_cap, T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      methcla_boost::container::uninitialized_move_and_insert_alloc
      ...
      if(raw_old_buffer){
         BOOST_IF_CONSTEXPR(!has_trivial_destructor_after_move<value_type>::value)
            methcla_boost::container::destroy_alloc_n(a, raw_old_buffer, this->m_holder.m_size);
...
inline typename vector<T, A, O>::size_type erase(vector<T, A, O>& c, const U& v)
{
  ...
  c.erase(methcla_boost::container::remove(c.begin(), c.end(), v), c.end());
...
{
   typename vector<T, A, O>::size_type old_size = c.size();
   c.erase(methcla_boost::container::remove_if(c.begin(), c.end(), pred), c.end());
   return old_size - c.size();
}

}} //namespace methcla_boost::container
...
struct has_trivial_destructor_after_move<methcla_boost::container::vector<T, Allocator, Options> >
{
   typedef typename methcla_boost::container::vector<T, Allocator, Options>::allocator_type allocator_type;
   typedef typename ::methcla_boost::container::allocator_traits<allocator_type>::pointer pointer;
   BOOST_STATIC_CONSTEXPR bool value = ::methcla_boost::has_trivial_destructor_after_move<allocator_type>::value &&
                                                ::methcla_boost::has_trivial_destructor_after_move<pointer>::value;
};
...
template <class Pointer, bool IsConst>
struct pointer_traits< methcla_boost::container::vec_iterator<Pointer, IsConst> >
   : public methcla_boost::intrusive::pointer_traits< methcla_boost::container::vec_iterator<Pointer, IsConst> >
{};
