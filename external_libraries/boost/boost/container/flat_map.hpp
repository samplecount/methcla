...
#define BOOST_CONTAINER_FORCE(DEST_TYPE, SRC) \
   (*::methcla_boost::move_detail::launder_cast<DEST_TYPE*>(&(SRC)))

#define BOOST_CONTAINER_FORCECOPY(DEST_TYPE, SRC) \
   static_cast<DEST_TYPE>(*::methcla_boost::move_detail::launder_cast<const DEST_TYPE*>( \
...
class flat_map
{
   ...
   inline flat_map(BOOST_RV_REF(flat_map) x)
      ...
      : m_flat_tree(methcla_boost::move(x.m_flat_tree))
   {}
   ...
   inline flat_map(BOOST_RV_REF(flat_map) x, const allocator_type &a)
      : m_flat_tree(methcla_boost::move(x.m_flat_tree), BOOST_CONTAINER_FORCE(const impl_allocator_type, a))
   {}
   ...
   {  m_flat_tree = methcla_boost::move(x.m_flat_tree);   return *this;  }
   ...
   inline std::pair<iterator, bool> insert_or_assign(const key_type& k, BOOST_FWD_REF(M) obj)
   {
      return BOOST_CONTAINER_FORCECOPY(iterator_bool_t,
         this->m_flat_tree.insert_or_assign(k, ::methcla_boost::forward<M>(obj)));
   }
   ...
   {
      return BOOST_CONTAINER_FORCECOPY(iterator_bool_t,
         this->m_flat_tree.insert_or_assign(::methcla_boost::move(k), ::methcla_boost::forward<M>(obj)));
   }
   ...
   {
      return BOOST_CONTAINER_FORCECOPY(iterator_bool_t,
         this->m_flat_tree.insert_or_assign(::methcla_boost::forward<K>(k), ::methcla_boost::forward<M>(obj)));
   }
   ...
   inline iterator insert_or_assign(const_iterator hint, const key_type& k, BOOST_FWD_REF(M) obj)
   {
      return BOOST_CONTAINER_FORCECOPY(iterator,
         this->m_flat_tree.insert_or_assign
            ...
            , k, ::methcla_boost::forward<M>(obj)).first
         );
   }
   ...
   inline iterator insert_or_assign(const_iterator hint, BOOST_RV_REF(key_type) k, BOOST_FWD_REF(M) obj)
   {
      return BOOST_CONTAINER_FORCECOPY(iterator,
         this->m_flat_tree.insert_or_assign
            ( BOOST_CONTAINER_FORCECOPY(impl_const_iterator, hint)
            , ::methcla_boost::move(k), ::methcla_boost::forward<M>(obj)).first
         );
   }
      ...
      insert_or_assign(const_iterator hint, BOOST_FWD_REF(K) k, BOOST_FWD_REF(M) obj)
   {
      return BOOST_CONTAINER_FORCECOPY(iterator,
         this->m_flat_tree.insert_or_assign
            ( BOOST_CONTAINER_FORCECOPY(impl_const_iterator, hint)
            , ::methcla_boost::forward<K>(k), ::methcla_boost::forward<M>(obj)).first
         );
   }

   //! @copydoc ::methcla_boost::container::flat_set::nth(size_type)
   BOOST_CONTAINER_NODISCARD inline
      iterator nth(size_type n) BOOST_NOEXCEPT_OR_NOTHROW
   {  return BOOST_CONTAINER_FORCECOPY(iterator, m_flat_tree.nth(n));  }

   //! @copydoc ::methcla_boost::container::flat_set::nth(size_type) const
   BOOST_CONTAINER_NODISCARD inline
      const_iterator nth(size_type n) const BOOST_NOEXCEPT_OR_NOTHROW
   {  return BOOST_CONTAINER_FORCECOPY(const_iterator, m_flat_tree.nth(n));  }

   //! @copydoc ::methcla_boost::container::flat_set::index_of(iterator)
   BOOST_CONTAINER_NODISCARD inline
      size_type index_of(iterator p) BOOST_NOEXCEPT_OR_NOTHROW
   {  return m_flat_tree.index_of(BOOST_CONTAINER_FORCECOPY(impl_iterator, p));  }

   //! @copydoc ::methcla_boost::container::flat_set::index_of(const_iterator) const
   BOOST_CONTAINER_NODISCARD inline
   ...
   {  return BOOST_CONTAINER_FORCECOPY(iterator_bool_t, m_flat_tree.emplace_unique(methcla_boost::forward<Args>(args)...)); }
   ...
   inline iterator emplace_hint(const_iterator hint, BOOST_FWD_REF(Args)... args)
   {
      return BOOST_CONTAINER_FORCECOPY(iterator,
         m_flat_tree.emplace_hint_unique( BOOST_CONTAINER_FORCECOPY(impl_const_iterator, hint)
                                         , methcla_boost::forward<Args>(args)...));
   }
   ...
   {
      return BOOST_CONTAINER_FORCECOPY(iterator_bool_t,
         m_flat_tree.try_emplace(k, methcla_boost::forward<Args>(args)...));
   }
   ...
   inline iterator try_emplace(const_iterator hint, const key_type &k, BOOST_FWD_REF(Args)... args)
   {
      return BOOST_CONTAINER_FORCECOPY(iterator, m_flat_tree.try_emplace
         (BOOST_CONTAINER_FORCECOPY(impl_const_iterator, hint), k, methcla_boost::forward<Args>(args)...).first);
   }
   ...
   {
      return BOOST_CONTAINER_FORCECOPY(iterator_bool_t,
         m_flat_tree.try_emplace(methcla_boost::move(k), methcla_boost::forward<Args>(args)...));
   }
   ...
   inline iterator try_emplace(const_iterator hint, BOOST_RV_REF(key_type) k, BOOST_FWD_REF(Args)... args)
   {
      return BOOST_CONTAINER_FORCECOPY(iterator,
         m_flat_tree.try_emplace(BOOST_CONTAINER_FORCECOPY
            (impl_const_iterator, hint), methcla_boost::move(k), methcla_boost::forward<Args>(args)...).first);
   }
   ...
   {
      return BOOST_CONTAINER_FORCECOPY(iterator_bool_t,
         m_flat_tree.try_emplace(methcla_boost::forward<K>(k), methcla_boost::forward<Args>(args)...));
   }
      ...
      try_emplace(const_iterator hint, BOOST_FWD_REF(K) k, BOOST_FWD_REF(Args)... args)
   {
      return BOOST_CONTAINER_FORCECOPY(iterator,
         m_flat_tree.try_emplace(BOOST_CONTAINER_FORCECOPY
            (impl_const_iterator, hint), methcla_boost::forward<K>(k), methcla_boost::forward<Args>(args)...).first);
   }
   ...
   {\
      return BOOST_CONTAINER_FORCECOPY(iterator_bool_t,\
         m_flat_tree.try_emplace(methcla_boost::move(k) BOOST_MOVE_I##N BOOST_MOVE_FWD##N));\
   }\
   \
   BOOST_MOVE_TMPL_LT##N BOOST_MOVE_CLASS##N BOOST_MOVE_GT##N \
   inline iterator try_emplace(const_iterator hint, BOOST_RV_REF(key_type) k BOOST_MOVE_I##N BOOST_MOVE_UREF##N)\
   {  return BOOST_CONTAINER_FORCECOPY(iterator, m_flat_tree.try_emplace\
      (BOOST_CONTAINER_FORCECOPY(impl_const_iterator, hint), methcla_boost::move(k) BOOST_MOVE_I##N BOOST_MOVE_FWD##N).first); }\
   \
   ...
   { \
      return BOOST_CONTAINER_FORCECOPY(iterator_bool_t, \
         m_flat_tree.try_emplace(methcla_boost::forward<K>(k) BOOST_MOVE_I##N BOOST_MOVE_FWD##N)); \
   } \
   \
   template <class K BOOST_MOVE_I##N BOOST_MOVE_CLASS##N> \
       typename dtl::enable_if_transparent< key_compare \
   ...
   { \
      return BOOST_CONTAINER_FORCECOPY(iterator, \
         m_flat_tree.try_emplace(BOOST_CONTAINER_FORCECOPY \
            (impl_const_iterator, hint) BOOST_MOVE_I methcla_boost::forward<K>(k) BOOST_MOVE_I##N BOOST_MOVE_FWD##N).first); \
   }
   //
   ...
   {
      return BOOST_CONTAINER_FORCECOPY(iterator_bool_t, 
         m_flat_tree.insert_unique(methcla_boost::move(BOOST_CONTAINER_FORCE(impl_value_type, x))));
   }
   ...
   {
      return BOOST_CONTAINER_FORCECOPY(iterator_bool_t,
         m_flat_tree.emplace_unique(methcla_boost::forward<Pair>(x)));
   }
   ...
   inline iterator insert(const_iterator p, BOOST_RV_REF(value_type) x)
   {
      return BOOST_CONTAINER_FORCECOPY(iterator,
         m_flat_tree.insert_unique( BOOST_CONTAINER_FORCECOPY(impl_const_iterator, p)
                                   , methcla_boost::move(BOOST_CONTAINER_FORCE(impl_value_type, x))));
   }
   ...
   {
      return BOOST_CONTAINER_FORCECOPY(iterator,
         m_flat_tree.emplace_hint_unique(BOOST_CONTAINER_FORCECOPY(impl_const_iterator, p), methcla_boost::forward<Pair>(x)));
   }
   ...
   //! @copydoc ::methcla_boost::container::flat_map::merge(flat_map<Key, T, C2, AllocatorOrContainer>&)
   template<class C2>
   ...
   {
      return methcla_boost::move(BOOST_CONTAINER_FORCE(sequence_type, m_flat_tree.get_sequence_ref()));
   }
   ...
   {  this->m_flat_tree.adopt_sequence_unique(methcla_boost::move(BOOST_CONTAINER_FORCE(impl_sequence_type, seq)));  }
   ...
   {  this->m_flat_tree.adopt_sequence_unique(ordered_unique_range_t(), methcla_boost::move(BOOST_CONTAINER_FORCE(impl_sequence_type, seq)));  }
   ...
   inline mapped_type& priv_subscript(BOOST_FWD_REF(K) key)
   {
      ...
      if (i == end() || key_comp()(k, (*i).first)) {
         ...
         impl_get_stored_allocator_noconst_return_t r = m_flat_tree.get_stored_allocator();
         methcla_boost::container::allocator_traits<impl_stored_allocator_type>::construct
            (r, vp, try_emplace_t(), ::methcla_boost::forward<K>(key));
         i = BOOST_CONTAINER_FORCECOPY(iterator, this->m_flat_tree.insert_equal
               (BOOST_CONTAINER_FORCECOPY(impl_iterator, i), ::methcla_boost::move(*vp)));
         vp->~impl_value_type();
      }
      return (*i).second;
   }
...
template <class Key, class T, class Compare, class AllocatorOrContainer>
struct has_trivial_destructor_after_move<methcla_boost::container::flat_map<Key, T, Compare, AllocatorOrContainer> >
{
   typedef typename methcla_boost::container::flat_map<Key, T, Compare, AllocatorOrContainer>::value_type value_t;
   #ifdef BOOST_CONTAINER_STD_PAIR_IS_MOVABLE
   typedef AllocatorOrContainer alloc_or_cont_t;
   #else
   typedef typename ::methcla_boost::container::dtl::container_or_allocator_rebind<AllocatorOrContainer, value_t>::type alloc_or_cont_t;
   #endif
   typedef ::methcla_boost::container::dtl::flat_tree<value_t,::methcla_boost::container::dtl::select1st<Key>, Compare, alloc_or_cont_t> tree;
...
class flat_multimap
{
   ...
   {  return BOOST_CONTAINER_FORCECOPY(iterator, m_flat_tree.emplace_equal(methcla_boost::forward<Args>(args)...)); }
   ...
   iterator emplace_hint(const_iterator hint, BOOST_FWD_REF(Args)... args)
   {
      return BOOST_CONTAINER_FORCECOPY(iterator, m_flat_tree.emplace_hint_equal
         (BOOST_CONTAINER_FORCECOPY(impl_const_iterator, hint), methcla_boost::forward<Args>(args)...));
   }
   ...
   inline BOOST_CONTAINER_DOC1ST
         ...
         , typename dtl::enable_if_c<dtl::is_convertible<Pair BOOST_MOVE_I dtl_pair_t>::value
            BOOST_MOVE_I iterator >::type)
      insert(BOOST_FWD_REF(Pair) x)
   { return BOOST_CONTAINER_FORCECOPY(iterator, m_flat_tree.emplace_equal(methcla_boost::forward<Pair>(x))); }
   ...
   {
      return BOOST_CONTAINER_FORCECOPY(iterator,
         m_flat_tree.emplace_hint_equal(BOOST_CONTAINER_FORCECOPY(impl_const_iterator, p), methcla_boost::forward<Pair>(x)));
   }
   ...
   //! @copydoc ::methcla_boost::container::flat_multimap::merge(flat_multimap<Key, T, C2, AllocatorOrContainer>&)
   template<class C2>
   inline void merge(BOOST_RV_REF_BEG flat_multimap<Key, T, C2, AllocatorOrContainer> BOOST_RV_REF_END source)
   {  return this->merge(static_cast<flat_multimap<Key, T, C2, AllocatorOrContainer>&>(source)); }
   ...
   //! @copydoc ::methcla_boost::container::flat_multimap::merge(flat_map<Key, T, C2, AllocatorOrContainer>&)
   template<class C2>
   inline void merge(BOOST_RV_REF_BEG flat_map<Key, T, C2, AllocatorOrContainer> BOOST_RV_REF_END source)
   {  return this->merge(static_cast<flat_map<Key, T, C2, AllocatorOrContainer>&>(source)); }
   ...
   //! <b>Throws</b>: If the comparison or the move constructor throws
   inline void adopt_sequence(BOOST_RV_REF(sequence_type) seq)
   {  this->m_flat_tree.adopt_sequence_equal(methcla_boost::move(BOOST_CONTAINER_FORCE(impl_sequence_type, seq)));  }
   ...
   {  this->m_flat_tree.adopt_sequence_equal(ordered_range_t(), methcla_boost::move(BOOST_CONTAINER_FORCE(impl_sequence_type, seq)));  }
...
//!specialization for optimizations
template <class Key, class T, class Compare, class AllocatorOrContainer>
struct has_trivial_destructor_after_move< methcla_boost::container::flat_multimap<Key, T, Compare, AllocatorOrContainer> >
{
   typedef typename methcla_boost::container::flat_multimap<Key, T, Compare, AllocatorOrContainer>::value_type value_t;
   #ifdef BOOST_CONTAINER_STD_PAIR_IS_MOVABLE
   typedef AllocatorOrContainer alloc_or_cont_t;
   #else
   typedef typename ::methcla_boost::container::dtl::container_or_allocator_rebind<AllocatorOrContainer, value_t>::type alloc_or_cont_t;
