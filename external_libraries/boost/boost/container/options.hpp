...
struct tree_opt
{
   BOOST_STATIC_CONSTEXPR methcla_boost::container::tree_type_enum tree_type = TreeType;
...
//! by \c methcla_boost::container::set, \c methcla_boost::container::multiset
//! \c methcla_boost::container::map and \c methcla_boost::container::multimap.
//! Supported options are: \c methcla_boost::container::optimize_size and \c methcla_boost::container::tree_type
...
{
   /// @cond
   typedef typename ::methcla_boost::intrusive::pack_options
      < tree_assoc_defaults,
...
template<class ...Options>
using tree_assoc_options_t = typename methcla_boost::container::tree_assoc_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c methcla_boost::container::hash_set, \c methcla_boost::container::hash_multiset
//! \c methcla_boost::container::hash_map and \c methcla_boost::container::hash_multimap.
//! Supported options are: \c methcla_boost::container::store_hash
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
template<class ...Options>
using hash_assoc_options_t = typename methcla_boost::container::hash_assoc_options<Options...>::type;
...
//!\c methcla_boost::container::growth_factor_50,
//!\c methcla_boost::container::growth_factor_60 and
//!\c methcla_boost::container::growth_factor_100
//!
...
//! Helper metafunction to combine options into a single type to be used
//! by \c methcla_boost::container::vector.
//! Supported options are: \c methcla_boost::container::growth_factor and \c methcla_boost::container::stored_size
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! by \c methcla_boost::container::vector.
template<class ...Options>
using vector_options_t = typename methcla_boost::container::vector_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c methcla_boost::container::small_vector.
//! Supported options are: \c methcla_boost::container::growth_factor,
//! \c methcla_boost::container::inplace_alignment and
//! \c methcla_boost::container::stored_size.
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! by \c methcla_boost::container::small_vector.
template<class ...Options>
using small_vector_options_t = typename methcla_boost::container::small_vector_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c methcla_boost::container::static_vector.
//! Supported options are: \c methcla_boost::container::throw_on_overflow, \c methcla_boost::container::inplace_alignment
//! and \c methcla_boost::container::stored_size.
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! by \c methcla_boost::container::static_vector.
template<class ...Options>
using static_vector_options_t = typename methcla_boost::container::static_vector_options<Options...>::type;
...
//!\c methcla_boost::container::relocate_on_66
//!\c methcla_boost::container::relocate_on_75
//!\c methcla_boost::container::relocate_on_80
//!\c methcla_boost::container::relocate_on_85
//!\c methcla_boost::container::relocate_on_90
//!
//!If this option is not specified, a default will be used by the container.
//!
...
//! Helper metafunction to combine options into a single type to be used
//! by \c methcla_boost::container::devector.
//! Supported options are: \c methcla_boost::container::growth_factor, \c methcla_boost::container::stored_size
//! and \c methcla_boost::container::relocate_on
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! by \c methcla_boost::container::devector.
template<class ...Options>
using devector_options_t = typename methcla_boost::container::devector_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c methcla_boost::container::deque.
//! Supported options are: \c methcla_boost::container::block_bytes / \c methcla_boost::container::segment_bytes,
//! \c methcla_boost::container::block_size / \c methcla_boost::container::segment_size,
//! \c methcla_boost::container::stored_size
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
...
//! by \c methcla_boost::container::deque.
template<class ...Options>
using deque_options_t = typename methcla_boost::container::deque_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c methcla_boost::container::segtor.
//! Supported options are: \c methcla_boost::container::block_bytes / \c methcla_boost::container::segment_bytes,
//! \c methcla_boost::container::block_size / \c methcla_boost::container::segment_size,
//! \c methcla_boost::container::stored_size
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
...
//! by \c methcla_boost::container::segtor.
template<class ...Options>
using segtor_options_t = typename methcla_boost::container::segtor_options<Options...>::type;
...
//! Helper metafunction to combine options into a single type to be used
//! by \c methcla_boost::container::string.
//! Supported options are: \c methcla_boost::container::growth_factor and \c methcla_boost::container::stored_size
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
...
//! by \c methcla_boost::container::string.
template<class ...Options>
using string_options_t = typename methcla_boost::container::string_options<Options...>::type;
