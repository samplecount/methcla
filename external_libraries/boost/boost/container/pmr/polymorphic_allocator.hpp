...
class polymorphic_allocator
{
   ...
   polymorphic_allocator() BOOST_NOEXCEPT
      : m_resource(::methcla_boost::container::pmr::get_default_resource())
   {}
   ...
   {  return static_cast<T*>(m_resource->allocate(n*sizeof(T), ::methcla_boost::move_detail::alignment_of<T>::value));  }
   ...
   {  m_resource->deallocate(p, n*sizeof(T), ::methcla_boost::move_detail::alignment_of<T>::value);  }
   ...
   void construct(U* p, BOOST_FWD_REF(Args)...args)
   {
      ...
      dtl::dispatch_uses_allocator
         (na, *this, p, ::methcla_boost::forward<Args>(args)...);
   }
