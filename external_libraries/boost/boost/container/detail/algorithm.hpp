...
using methcla_boost::intrusive::algo_equal;
using methcla_boost::intrusive::algo_lexicographical_compare;
...
{	return methcla_boost::container::binder1st<Func>(func, arg);  }
...
{
   return (methcla_boost::container::binder2nd<Func>(func, arg));
}
...
{
   return methcla_boost::container::unary_negate<Func>(func);
}
