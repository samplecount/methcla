...
#define BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEG namespace methcla_boost { namespace container { namespace is_container_detail {
...
struct is_container
{
   BOOST_STATIC_CONSTEXPR bool value =
      methcla_boost::container::is_container_detail::
