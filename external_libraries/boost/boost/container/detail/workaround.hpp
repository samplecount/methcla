...
//Define this to use std exception types instead of methcla_boost::container's own exception types
...
#define BOOST_CONTAINER_STATIC_ASSERT(B) \
         typedef ::methcla_boost::container::dtl::static_assert_test<\
            (unsigned)sizeof(::methcla_boost::container::dtl::STATIC_ASSERTION_FAILURE<bool(B)>)>\
