...
struct move_insert_range_proxy
{
   ...
   {
      this->first_ = ::methcla_boost::container::uninitialized_move_alloc_n_source
         (a, this->first_, n, p);
   }
   ...
   {
      this->first_ = ::methcla_boost::container::move_n_source(this->first_, n, p);
   }
...
struct insert_range_proxy
{
   ...
   inline void uninitialized_copy_n_and_update(Allocator &a, Iterator p, std::size_t n)
   {
      this->first_ = ::methcla_boost::container::uninitialized_copy_alloc_n_source(a, this->first_, n, p);
   }

   template<class Iterator>
   inline void copy_n_and_update(Allocator &, Iterator p, std::size_t n)
   {
      this->first_ = ::methcla_boost::container::copy_n_source(this->first_, n, p);
   }
...
struct insert_n_copies_proxy
{
   ...
   {  methcla_boost::container::uninitialized_fill_alloc_n(a, v_, n, p);  }
...
{
   typedef ::methcla_boost::container::allocator_traits<Allocator> alloc_traits;
   typedef typename allocator_traits<Allocator>::value_type value_type;
   typedef typename dtl::aligned_storage<sizeof(value_type), dtl::alignment_of<value_type>::value>::type storage_t;

   template<class Iterator>
   inline void uninitialized_copy_n_and_update(Allocator &a, Iterator p, std::size_t n) const
   {  methcla_boost::container::uninitialized_value_init_alloc_n(a, n, p);  }
...
struct insert_default_initialized_n_proxy
{
   ...
   template<class Iterator>
   inline void uninitialized_copy_n_and_update(Allocator &a, Iterator p, std::size_t n) const
   {  methcla_boost::container::uninitialized_default_init_alloc_n(a, n, p);  }
...
struct insert_copy_proxy
{
   ...
   inline void uninitialized_copy_n_and_update(Allocator &a, Iterator p, std::size_t n) const
   {
      ...
      alloc_traits::construct( a, methcla_boost::movelib::iterator_to_raw_pointer(p), v_);
   }
...
struct insert_move_proxy
{
   ...
   {
      BOOST_ASSERT(n == 1);  (void)n;
      alloc_traits::construct( a, methcla_boost::movelib::iterator_to_raw_pointer(p), ::methcla_boost::move(v_) );
   }
...
inline insert_move_proxy<Allocator> get_insert_value_proxy(BOOST_RV_REF(typename methcla_boost::container::iterator_traits<It>::value_type) v)
{
   return insert_move_proxy<Allocator>(v);
}

template<class It, class Allocator>
inline insert_copy_proxy<Allocator> get_insert_value_proxy(const typename methcla_boost::container::iterator_traits<It>::value_type &v)
{
...
struct insert_nonmovable_emplace_proxy
{
   ...
   {
      BOOST_ASSERT(n == 1); (void)n;
      alloc_traits::construct( a, methcla_boost::movelib::iterator_to_raw_pointer(p), ::methcla_boost::forward<Args>(get<IdxPack>(this->args_))... );
   }
   ...
   :  public insert_nonmovable_emplace_proxy<Allocator, Args...>
{
   ...
   inline explicit insert_emplace_proxy(BOOST_FWD_REF(Args)... args)
      : base_t(::methcla_boost::forward<Args>(args)...)
   {}
   ...
   inline void priv_copy_some_and_update(Allocator &a, const index_tuple<IdxPack...>&, Iterator p, std::size_t n)
   {
      BOOST_ASSERT(n ==1); (void)n;
      typename dtl::aligned_storage<sizeof(value_type), dtl::alignment_of<value_type>::value>::type v;
      alloc_traits::construct(a, (value_type*)&v, ::methcla_boost::forward<Args>(get<IdxPack>(this->args_))...);
      value_type *vp = move_detail::launder_cast<value_type *>(&v);
      BOOST_CONTAINER_TRY{
         *p = ::methcla_boost::move(*vp);
      }
...
template<class Allocator>
struct insert_emplace_proxy<Allocator, typename methcla_boost::container::allocator_traits<Allocator>::value_type>
   : public insert_move_proxy<Allocator>
{
   BOOST_STATIC_CONSTEXPR bool single_value = true;

   inline explicit insert_emplace_proxy(typename methcla_boost::container::allocator_traits<Allocator>::value_type &&v)
...
struct insert_emplace_proxy<Allocator
   , typename methcla_boost::container::dtl::add_const<typename methcla_boost::container::allocator_traits<Allocator>::value_type>::type
   >
   : public insert_copy_proxy<Allocator>
{
   ...
   inline explicit insert_emplace_proxy(const typename methcla_boost::container::allocator_traits<Allocator>::value_type &v)
...
{\
   ...
   {\
      BOOST_ASSERT(n == 1); (void)n;\
      alloc_traits::construct(a, methcla_boost::movelib::iterator_to_raw_pointer(p) BOOST_MOVE_I##N BOOST_MOVE_MFWD##N);\
   }\
   \
   template<class Iterator>\
...
//Specializations to avoid an unneeded temporary when emplacing from a single argument o type value_type
template<class Allocator>
struct insert_emplace_proxy_arg1<Allocator, ::methcla_boost::rv<typename methcla_boost::container::allocator_traits<Allocator>::value_type> >
   : public insert_move_proxy<Allocator>
{
   BOOST_STATIC_CONSTEXPR bool single_value = true;

   inline explicit insert_emplace_proxy_arg1(typename methcla_boost::container::allocator_traits<Allocator>::value_type &v)
   : insert_move_proxy<Allocator>(v)
   {}
};

template<class Allocator>
struct insert_emplace_proxy_arg1<Allocator, typename methcla_boost::container::allocator_traits<Allocator>::value_type>
   : public insert_copy_proxy<Allocator>
{
   BOOST_STATIC_CONSTEXPR bool single_value = true;

   inline explicit insert_emplace_proxy_arg1(const typename methcla_boost::container::allocator_traits<Allocator>::value_type &v)
   : insert_copy_proxy<Allocator>(v)
   {}
};
