...
template<class Allocator, unsigned Version = methcla_boost::container::dtl::version<Allocator>::value>
struct allocator_version_traits
{
   typedef ::methcla_boost::container::dtl::integral_constant
      <unsigned, Version> alloc_version;

   typedef typename Allocator::multiallocation_chain multiallocation_chain;

   typedef typename methcla_boost::container::allocator_traits<Allocator>::pointer    pointer;
   typedef typename methcla_boost::container::allocator_traits<Allocator>::size_type  size_type;
...
struct allocator_version_traits<Allocator, 1>
{
   ...
   typedef typename methcla_boost::intrusive::pointer_traits<pointer>::
         template rebind_pointer<void>::type                void_ptr;
   typedef dtl::basic_multiallocation_chain
      <void_ptr>                                            multialloc_cached_counted;
   typedef methcla_boost::container::dtl::
   ...
   static void deallocate_individual(Allocator &a, multiallocation_chain &holder)
   {
      ...
      while(n){
         --n;
         pointer p = methcla_boost::intrusive::pointer_traits<pointer>::pointer_to(*it);
         ++it;
         a.deallocate(p, 1);
      }
   }
