...
namespace methcla_boost_container_is_constructible {
   ...
   struct is_constructible
   {
      ...
      template <typename U>
      static decltype( new U(methcla_boost::move_detail::declval<Args>()...), yes_type() ) test(int);
   ...
   #include <boost/move/detail/fwd_macros.hpp>
      ...
      //    private:
      //    template<typename U>
      //    static char test( typename enable_if< (sizeof( new U(methcla_boost::move_detail::declval<P0>(), methcla_boost::move_detail::declval<P1>()))!= 0), int>::type );
      //
      //    template <typename U>
      //    static no_type test(...);
      //
      ...
      //{
      //    private:
      //    template<typename U, typename E = decltype( new U(methcla_boost::move_detail::declval<P0>(), methcla_boost::move_detail::declval<P1>()) ) >
      ...
      //struct is_constructible
      //  <T, P0, P1>
      //    : methcla_boost_container_is_constructible::is_constructible_impl2<T, P0, P1>
      //{};
      ...
      #define BOOST_INTRUSIVE_IS_CONSTRUCTIBLE(N) \
         ...
         struct is_constructible\
            ...
            : methcla_boost_container_is_constructible::is_constructible_impl##N<T BOOST_MOVE_I##N BOOST_MOVE_TARG##N>\
         {};\
         //
