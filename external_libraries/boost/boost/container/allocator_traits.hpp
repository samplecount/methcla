...
{
   ::new(const_cast<void*>(static_cast<const volatile void*>(p)), boost_container_new_t()) T(::methcla_boost::forward<Args>(args)...);
}
...
typename dtl::enable_if_c
   <  dtl::is_pair<typename dtl::remove_reference<T>::type>::value &&
      !methcla_boost::move_detail::is_reference<U>::value  //This is needed for MSVC10 and ambiguous overloads
   , void >::type
construct_type(T* p, BOOST_RV_REF(U) u)
{
   dtl::construct_type(dtl::addressof(p->first), ::methcla_boost::move(u.first));
   BOOST_CONTAINER_TRY{
      dtl::construct_type(dtl::addressof(p->second), ::methcla_boost::move(u.second));
   }
   BOOST_CONTAINER_CATCH(...) {
      typedef typename T::first_type first_type;
      dtl::addressof(p->first)->~first_type();
...
{
   dtl::construct_type(dtl::addressof(p->first), ::methcla_boost::forward<U>(x));
   BOOST_CONTAINER_TRY{
      dtl::construct_type(dtl::addressof(p->second), ::methcla_boost::forward<V>(y));
   }
   BOOST_CONTAINER_CATCH(...) {
      typedef typename T::first_type first_type;
      dtl::addressof(p->first)->~first_type();
...
struct allocator_traits
{
   ...
   typedef typename allocator_type::value_type value_type;
   ...
   #else
      //pointer
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT(methcla_boost::container::dtl::, Allocator,
         pointer, value_type*)
            pointer;
      //const_pointer
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT(methcla_boost::container::dtl::, Allocator,
         const_pointer, typename methcla_boost::intrusive::pointer_traits<pointer>::template
      ...
      //void_pointer
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT(methcla_boost::container::dtl::, Allocator,
         void_pointer, typename methcla_boost::intrusive::pointer_traits<pointer>::template
            rebind_pointer<void>)
               void_pointer;
      //const_void_pointer
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT(methcla_boost::container::dtl::, Allocator,
         const_void_pointer, typename methcla_boost::intrusive::pointer_traits<pointer>::template
      ...
      //rebind_alloc & rebind_traits
         ...
         //C++11
         template <typename T> using rebind_alloc  = typename methcla_boost::intrusive::pointer_rebind<Allocator, T>::type;
         template <typename T> using rebind_traits = allocator_traits< rebind_alloc<T> >;
      #else    // #if !defined(BOOST_NO_CXX11_TEMPLATE_ALIASES)
         //Some workaround for C++03 or C++11 compilers with no template aliases
         template <typename T>
         struct rebind_alloc : methcla_boost::intrusive::pointer_rebind<Allocator,T>::type
         {
            typedef typename methcla_boost::intrusive::pointer_rebind<Allocator,T>::type Base;
            #if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
               template <typename... Args>
               rebind_alloc(BOOST_FWD_REF(Args)... args) : Base(methcla_boost::forward<Args>(args)...) {}
         ...
         struct rebind_traits
            : allocator_traits<typename methcla_boost::intrusive::pointer_rebind<Allocator, T>::type>
         {};
      ...
      template <class T>
      struct portable_rebind_alloc
      {  typedef typename methcla_boost::intrusive::pointer_rebind<Allocator, T>::type type;  };
   ...
   {  allocator_traits::construct(a, p);  }
      ...
      {
         BOOST_STATIC_CONSTEXPR bool value = ::methcla_boost::move_detail::and_
            < dtl::is_not_std_allocator<Allocator>
            , methcla_boost::container::dtl::has_member_function_callable_with_construct
                  < Allocator, T*, Args... >
            >::value;
         dtl::bool_<value> flag;
         allocator_traits::priv_construct(flag, a, p, ::methcla_boost::forward<Args>(args)...);
      }
   #endif
      ...
      {
         allocator_traits::construct(a, dtl::addressof(p->first), ::methcla_boost::forward<KeyType>(k));
         BOOST_CONTAINER_TRY{
            allocator_traits::construct(a, dtl::addressof(p->second), ::methcla_boost::forward<Args>(args)...);
         }
         BOOST_CONTAINER_CATCH(...) {
   ...
   #pragma GCC diagnostic ignored "-Wdeprecated-declarations"
      ...
      {  a.construct( p, ::methcla_boost::forward<Args>(args)...);  }
      ...
      {
         a.construct(dtl::addressof(p->first), ::methcla_boost::forward<KeyType>(k));
         BOOST_CONTAINER_TRY{
            a.construct(dtl::addressof(p->second), ::methcla_boost::forward<Args>(args)...);
         }
         BOOST_CONTAINER_CATCH(...) {
            typedef typename T::first_type first_type;
            dtl::addressof(p->first)->~first_type();
      ...
      {  dtl::construct_type(p, ::methcla_boost::forward<Args>(args)...); }
   #else // #if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
      public:
   ...
   template<class T>
   inline static void priv_construct(dtl::false_type, Allocator &, T *p, const ::methcla_boost::container::default_init_t&)
   {  ::new((void*)p, boost_container_new_t()) T; }

   template<class T>
   inline static void priv_construct(dtl::false_type, Allocator &, T *p, const ::methcla_boost::container::value_init_t&)
   {  ::new((void*)p, boost_container_new_t()) T(); }
