...
/// \brief Contains methcla_boost::typeindex::stl_type_index class.
///
/// methcla_boost::typeindex::stl_type_index class can be used as a drop-in replacement 
/// for std::type_index.
///
...
/// is defined methcla_boost::typeindex::ctti is usually used instead of methcla_boost::typeindex::stl_type_index.
...
inline std::string stl_type_index::pretty_name() const {
    static const char cvr_saver_name[] = "methcla_boost::typeindex::detail::cvr_saver";
    ...
    if (!begin) {
        methcla_boost::throw_exception(std::runtime_error("Type name demangling failed"));
    }
    ...
    if (len > cvr_saver_name_len) {
        ...
        if (b) {
            ...
            // Trim everything till '<'. In modules the name could be methcla_boost::typeindex::detail::cvr_saver@boost.type_index<
