...
using methcla_boost::movelib::iterator_traits;
using methcla_boost::movelib::iter_difference;
using methcla_boost::movelib::iter_value;
using methcla_boost::movelib::iter_category;
using methcla_boost::movelib::iter_size;
...
////////////////////////////////////////////////////////////////////////////////
//    Conversion from methcla_boost::iterator traversals to std tags
////////////////////////////////////////////////////////////////////////////////
...
struct get_std_category_from_tag
   <methcla_boost::iterators::detail::iterator_category_with_traversal
      <Category, methcla_boost::iterators::incrementable_traversal_tag> >
{
...
struct get_std_category_from_tag
   <methcla_boost::iterators::detail::iterator_category_with_traversal
      <Category, methcla_boost::iterators::single_pass_traversal_tag> >
{
   typedef std::input_iterator_tag type;
};
...
struct get_std_category_from_tag
   <methcla_boost::iterators::detail::iterator_category_with_traversal
      <Category, methcla_boost::iterators::forward_traversal_tag> >
{
   typedef std::input_iterator_tag type;
};
...
struct get_std_category_from_tag
   <methcla_boost::iterators::detail::iterator_category_with_traversal
      <Category, methcla_boost::iterators::bidirectional_traversal_tag> >
{
...
struct get_std_category_from_tag
   <methcla_boost::iterators::detail::iterator_category_with_traversal
      <Category, methcla_boost::iterators::random_access_traversal_tag> >
{
...
struct get_std_category_from_it
   : get_std_category_from_tag< typename methcla_boost::intrusive::iter_category<It>::type >
{};
...
struct iterator_enable_if_tag
   : ::methcla_boost::move_detail::enable_if_c
      < ::methcla_boost::move_detail::is_same
...
struct iterator_enable_if_convertible_tag
   : ::methcla_boost::move_detail::enable_if_c
      < ::methcla_boost::move_detail::is_same_or_convertible
         < typename get_std_category_from_it<I>::type
         , Tag
         >::value &&
        !::methcla_boost::move_detail::is_same_or_convertible
...
struct iterator_enable_if_tag_difference_type
   : iterator_enable_if_tag<I, Tag, typename methcla_boost::intrusive::iter_difference<I>::type>
{};

template<class I, class Tag>
struct iterator_disable_if_tag_difference_type
   : iterator_disable_if_tag<I, Tag, typename methcla_boost::intrusive::iter_difference<I>::type>
{};
