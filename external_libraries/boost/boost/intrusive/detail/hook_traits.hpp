...
struct mhtraits
{
   ...
   inline static pointer to_value_ptr(node_ptr n)
   {
      return pointer_traits<pointer>::pointer_to
         (*detail::parent_from_member<T, Hook>
            (static_cast<Hook*>(methcla_boost::movelib::to_raw_pointer(n)), P));
   }
   ...
   inline static const_pointer to_value_ptr(const_node_ptr n)
   {
      return pointer_traits<const_pointer>::pointer_to
         (*detail::parent_from_member<T, Hook>
            (static_cast<const Hook*>(methcla_boost::movelib::to_raw_pointer(n)), P));
   }
};
...
struct fhtraits
{
   ...
   inline static node_ptr to_node_ptr(reference value)
   {  return static_cast<node*>(methcla_boost::movelib::to_raw_pointer(Functor::to_hook_ptr(value)));  }

   inline static const_node_ptr to_node_ptr(const_reference value)
   {  return static_cast<const node*>(methcla_boost::movelib::to_raw_pointer(Functor::to_hook_ptr(value)));  }
