...
////////////////////////////
   ...
   }}} //namespace methcla_boost::intrusive::detail
   ...
   template<>
   struct builtin_clz_dispatch< ::methcla_boost::ulong_long_type >
   {
      static ::methcla_boost::ulong_long_type call(::methcla_boost::ulong_long_type n)
      {  return (::methcla_boost::ulong_long_type)__builtin_clzll(n); }
   };
   #endif
