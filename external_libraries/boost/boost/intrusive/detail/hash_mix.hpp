...
#include <boost/cstdint.hpp>      //methcla_boost::uint64_t
#include <cstddef>
#include <climits>
...
{
    inline static methcla_boost::uint64_t fn( methcla_boost::uint64_t x )
    {
        methcla_boost::uint64_t const m = 0xe9846af9b1a615d;
...
{
    inline static methcla_boost::uint32_t fn( methcla_boost::uint32_t x )
    {
        methcla_boost::uint32_t const m1 = 0x21f0aaad;
        methcla_boost::uint32_t const m2 = 0x735a2d97;
