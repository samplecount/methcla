...
{
   typedef ::methcla_boost::intrusive::detail::identity<T> type;
};
   ...
   :  public bstbase<ValueTraits, VoidOrKeyOfValue, VoidOrKeyComp, ConstantTimeSize, SizeType, AlgoType, HeaderHolder>
{
   ...
   typedef BOOST_INTRUSIVE_IMPDEF(methcla_boost::intrusive::reverse_iterator<iterator>)                 reverse_iterator;
   typedef BOOST_INTRUSIVE_IMPDEF(methcla_boost::intrusive::reverse_iterator<const_iterator>)           const_reverse_iterator;
   ...
   bstree_impl(BOOST_RV_REF(bstree_impl) x)
      : data_type(::methcla_boost::move(x.get_comp()), ::methcla_boost::move(x.get_value_traits()))
   {
      this->swap(x);
   }
   ...
   {
      //This can throw
      ::methcla_boost::adl_move_swap(this->get_comp(), other.get_comp());
      //These can't throw
