...
namespace methcla_boost { namespace numeric { namespace convdetail
{
  ...
  typedef methcla_boost::integral_constant<int_float_mixture_enum, integral_to_integral> int2int_c ;
  typedef methcla_boost::integral_constant<int_float_mixture_enum, integral_to_float>    int2float_c ;
  typedef methcla_boost::integral_constant<int_float_mixture_enum, float_to_integral>    float2int_c ;
  typedef methcla_boost::integral_constant<int_float_mixture_enum, float_to_float>       float2float_c ;
