...
namespace methcla_boost { namespace numeric {
    ...
    #define BOOST_NUMERIC_CONVERSION_SEQ_A() BOOST_NUMERIC_CONVERSION_BASE_BUILTIN_TYPES()(methcla_boost::long_long_type)(methcla_boost::ulong_long_type)
	#define BOOST_NUMERIC_CONVERSION_SEQ_B() (methcla_boost::long_long_type)(methcla_boost::ulong_long_type)
