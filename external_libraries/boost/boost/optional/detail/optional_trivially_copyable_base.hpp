...
class tc_optional_base : public optional_tag
{
  ...
  protected :
    ...
    void construct ( Expr&& factory, in_place_factory_base const* )
     {
       methcla_boost_optional_detail::construct<value_type>(factory, methcla_boost::addressof(m_storage));
       m_initialized = true ;
     }
    ...
    void construct ( Expr&& factory, typed_in_place_factory_base const* )
     {
       factory.apply(methcla_boost::addressof(m_storage)) ;
       m_initialized = true ;
     }
    ...
    pointer_const_type get_ptr_impl() const { return methcla_boost::addressof(m_storage); }
    pointer_type       get_ptr_impl()       { return methcla_boost::addressof(m_storage); }
