...
class aligned_storage
{
    ...
    union BOOST_MAY_ALIAS dummy_u
    {
        ...
        BOOST_DEDUCED_TYPENAME type_with_alignment<
          ::methcla_boost::alignment_of<T>::value >::type aligner_;
    } dummy_ ;
  ...
  public:
    ...
    T const& ref() const { return *methcla_boost::core::launder(ptr_ref()); }
    T &      ref()       { return *methcla_boost::core::launder(ptr_ref()); }
} ;
