...
#else
# define BOOST_OPTIONAL_TT_PREFIX methcla_boost
# define BOOST_OPTIONAL_REQUIRES(...) BOOST_DEDUCED_TYPENAME methcla_boost::enable_if_c<__VA_ARGS__::value, bool>::type = false
#endif
...
template <class U>
struct is_optional_< ::methcla_boost::optional<U> >
{
...
public:
    ...
    : ptr_(methcla_boost::addressof(rhs)) {}
    ...
    constexpr T& value() const
    {
      return this->is_initialized() ?
             this->get() :
             (methcla_boost::throw_exception(methcla_boost::bad_optional_access()), this->get());
    }
    ...
    template <class R, BOOST_OPTIONAL_REQUIRES(detail::no_unboxing_cond<T, R>)>
        ...
        : ptr_(methcla_boost::addressof(r)) { detail::prevent_binding_rvalue<R>(); }
    ...
    template <class R, BOOST_OPTIONAL_REQUIRES(detail::is_no_optional<R>)>
        ...
        : ptr_(cond ? methcla_boost::addressof(r) : 0) { detail::prevent_binding_rvalue<R>(); }

    template <class R, BOOST_OPTIONAL_REQUIRES(detail::is_no_optional<R>)>
        BOOST_CXX14_CONSTEXPR optional<T&>&
        operator=(R&& r) BOOST_NOEXCEPT { detail::prevent_binding_rvalue<R>(); ptr_ = methcla_boost::addressof(r); return *this; }

    template <class R, BOOST_OPTIONAL_REQUIRES(detail::is_no_optional<R>)>
        BOOST_CXX14_CONSTEXPR void emplace(R&& r) BOOST_NOEXCEPT
        { detail::prevent_binding_rvalue<R>(); ptr_ = methcla_boost::addressof(r); }
    ...
    template <class U,
      ...
      : ptr_(methcla_boost::addressof(v)) { }
    ...
    template <class U,
      ...
      BOOST_CXX14_CONSTEXPR optional(bool cond, U& v) BOOST_NOEXCEPT : ptr_(cond ? methcla_boost::addressof(v) : 0) {}
    ...
    template <class U,
      ...
      optional<T&>& operator=(U& v) BOOST_NOEXCEPT
      {
        ...
        ptr_ = methcla_boost::addressof(v); return *this;
      }
