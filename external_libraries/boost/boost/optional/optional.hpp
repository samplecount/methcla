...
{
  static_assert(sizeof(CharType) == 0, "If you want to output methcla_boost::optional, include header <boost/optional/optional_io.hpp>");
  return os;
}
...
class optional_base : public optional_tag
{
  ...
  protected :
    ...
    typedef typename methcla_boost::remove_const<T>::type unqualified_value_type;
  ...
  protected:
    ...
    BOOST_NOEXCEPT_IF(::methcla_boost::is_nothrow_move_constructible<T>::value)
      :
      m_initialized(false)
    {
      if ( rhs.is_initialized() )
    ...
    BOOST_NOEXCEPT_IF(::methcla_boost::is_nothrow_move_constructible<T>::value && ::methcla_boost::is_nothrow_move_assignable<T>::value)
    {
  ...
  protected :
    ...
    void construct ( Expr&& factory, in_place_factory_base const* )
     {
       methcla_boost_optional_detail::construct<value_type>(factory, m_storage.address());
       m_initialized = true ;
     }
...
struct is_optional_or_tag
  : methcla_boost::conditional< methcla_boost::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME methcla_boost::decay<U>::type>::value
                     || methcla_boost::is_same<BOOST_DEDUCED_TYPENAME methcla_boost::decay<U>::type, none_t>::value
                     || methcla_boost::is_same<BOOST_DEDUCED_TYPENAME methcla_boost::decay<U>::type, in_place_init_t>::value
                     || methcla_boost::is_same<BOOST_DEDUCED_TYPENAME methcla_boost::decay<U>::type, in_place_init_if_t>::value,
    methcla_boost::true_type, methcla_boost::false_type>::type
{};

template <typename T, typename U>
struct has_dedicated_constructor
  : methcla_boost::disjunction<is_optional_or_tag<U>, methcla_boost::is_same<T, BOOST_DEDUCED_TYPENAME methcla_boost::decay<U>::type> >
{};

template <typename U>
struct is_factory
  : methcla_boost::disjunction< is_in_place_factory<U>, is_typed_in_place_factory<U> >
{};
...
struct is_factory_or_constructible_to_T
  : methcla_boost::disjunction< is_factory<U>, methcla_boost::is_constructible<T, U&&> >
{};

template <typename T, typename U>
struct is_optional_constructible : methcla_boost::is_constructible<T, U>
{};

#else

template <typename, typename>
struct is_factory_or_constructible_to_T : methcla_boost::true_type
{};

template <typename T, typename U>
struct is_optional_constructible : methcla_boost::true_type
{};
...
struct is_opt_assignable
  : methcla_boost::conjunction<methcla_boost::is_convertible<U&&, T>, methcla_boost::is_assignable<T&, U&&> >
{};

#else

template <typename T, typename U>
struct is_opt_assignable : methcla_boost::is_convertible<U, T>
{};
...
struct is_factory_or_opt_assignable_to_T
  : methcla_boost::disjunction< is_factory<U>, is_opt_assignable<T, U> >
{};
...
struct optional_uses_direct_storage_for
  : methcla_boost::conditional<(methcla_boost::is_scalar<T>::value && !methcla_boost::is_const<T>::value && !methcla_boost::is_volatile<T>::value)
                      , methcla_boost::true_type, methcla_boost::false_type>::type
{};
...
#  define BOOST_OPTIONAL_BASE_TYPE(T) methcla_boost::conditional< optional_config::optional_uses_direct_storage_for<T>::value, \
  ...
  : public BOOST_OPTIONAL_BASE_TYPE(T)
{
  ...
  public :
    ...
    explicit optional ( optional<U> const& rhs
                        ...
                        ,BOOST_DEDUCED_TYPENAME methcla_boost::enable_if< optional_detail::is_optional_constructible<T, U const&>, bool>::type = true
#endif
                      )
      :
      base()
...
#ifndef BOOST_OPTIONAL_DETAIL_NO_SFINAE_FRIENDLY_CONSTRUCTORS
                        ,BOOST_DEDUCED_TYPENAME methcla_boost::enable_if< optional_detail::is_optional_constructible<T, U>, bool>::type = true
#endif
                      )
      :
      base()
  ...
  explicit optional ( Expr&& expr,
                      BOOST_DEDUCED_TYPENAME methcla_boost::enable_if< optional_detail::is_optional_val_init_candidate<T, Expr>, bool>::type = true
  )
    : base(optional_detail::forward_<Expr>(expr),methcla_boost::addressof(expr))
    {}
    ...
    template<class Expr>
    BOOST_DEDUCED_TYPENAME methcla_boost::enable_if<optional_detail::is_optional_val_assign_candidate<T, Expr>, optional&>::type
    operator= ( Expr&& expr )
      {
        this->assign_expr(optional_detail::forward_<Expr>(expr),methcla_boost::addressof(expr));
        return *this ;
      }
    ...
    BOOST_DEDUCED_TYPENAME methcla_boost::enable_if<methcla_boost::is_same<T, BOOST_DEDUCED_TYPENAME methcla_boost::decay<T_>::type>, optional&>::type
    operator= ( T_&& val )
      {
    ...
    void swap( optional & arg )
      BOOST_NOEXCEPT_IF(::methcla_boost::is_nothrow_move_constructible<T>::value && ::methcla_boost::is_nothrow_move_assignable<T>::value)
      {
        ...
        methcla_boost::core::invoke_swap(*this, arg);
      }
