...
{
    using std::get;
    methcla_boost::hash_combine( seed, get<I>( v ) );

    methcla_boost::hash_detail::hash_combine_tuple_like<I + 1>( seed, v );
}
...
inline std::size_t hash_tuple_like( T const& v )
{
    ...
    methcla_boost::hash_detail::hash_combine_tuple_like<0>( seed, v );
...
{
    return methcla_boost::hash_detail::hash_tuple_like( v );
}
