...
#define BOOST_THREAD_DEFINES_THREAD_ATTRIBUTES_NATIVE_HANDLE
    ...
    namespace detail
    {
        ...
        typedef methcla_boost::shared_ptr<thread_data_base> thread_data_ptr;
            ...
            enable_shared_from_this<thread_data_base>
        {
            ...
            methcla_boost::mutex data_mutex;
            methcla_boost::condition_variable done_condition;
            bool done;
            bool join_started;
            bool joined;
            methcla_boost::detail::thread_exit_callback_node* thread_exit_callbacks;
            std::map<void const*,methcla_boost::detail::tss_data_node> tss_data;
