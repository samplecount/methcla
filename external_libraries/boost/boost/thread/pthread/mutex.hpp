...
namespace methcla_boost
{
    ...
    public:
        ...
        mutex()
        {
            ...
            if(res)
            {
                methcla_boost::throw_exception(thread_resource_error(res, "methcla_boost:: mutex constructor failed in pthread_mutex_init"));
            }
        }
        ~mutex()
        {
        ...
        void lock() BOOST_THREAD_ACQUIRE()
        {
            ...
            if (res)
            {
                methcla_boost::throw_exception(lock_error(res,"boost: mutex lock failed in pthread_mutex_lock"));
            }
        }
...
#define BOOST_THREAD_DEFINES_MUTEX_NATIVE_HANDLE
    ...
    public:
        ...
        timed_mutex()
        {
            ...
            if(res)
            {
                methcla_boost::throw_exception(thread_resource_error(res, "methcla_boost:: timed_mutex constructor failed in pthread_mutex_init"));
            }
#ifndef BOOST_THREAD_USES_PTHREAD_TIMEDLOCK
            ...
            {
                BOOST_VERIFY(!posix::pthread_mutex_destroy(&m));
                methcla_boost::throw_exception(thread_resource_error(res2, "methcla_boost:: timed_mutex constructor failed in pthread_cond_init"));
            }
            is_locked=false;
#endif
        }
