...
//#endif
    ...
    public:
    //private: // used by methcla_boost::thread::try_join_until
...
//#if defined BOOST_THREAD_PROVIDES_INTERRUPTIONS
            ...
            if(res)
            {
                methcla_boost::throw_exception(thread_resource_error(res, "methcla_boost::condition_variable::condition_variable() constructor failed in pthread_mutex_init"));
            }
//#endif
...
//#endif
                methcla_boost::throw_exception(thread_resource_error(res, "methcla_boost::condition_variable::condition_variable() constructor failed in pthread_cond_init"));
            }
        }
        ~condition_variable()
        {
...
//#endif
        ...
        bool timed_wait(
            unique_lock<mutex>& m,
            methcla_boost::system_time const& abs_time)
        {
        ...
        bool timed_wait(
            unique_lock<mutex>& m,
            ::methcla_boost::xtime const& abs_time)
        {
        ...
        bool timed_wait(
            unique_lock<mutex>& m,
            methcla_boost::system_time const& abs_time,predicate_type pred)
        {
#if defined BOOST_THREAD_WAIT_BUG
            const detail::real_platform_timepoint ts(abs_time + BOOST_THREAD_WAIT_BUG);
#else
        ...
        bool timed_wait(
            unique_lock<mutex>& m,
            ::methcla_boost::xtime const& abs_time,predicate_type pred)
        {
