...
namespace methcla_boost
{
    ...
    public:
        ...
        recursive_mutex()
        {
            ...
            if(init_attr_res)
            {
                methcla_boost::throw_exception(thread_resource_error(init_attr_res, "methcla_boost:: recursive_mutex constructor failed in pthread_mutexattr_init"));
            }
            int const set_attr_res=pthread_mutexattr_settype(&attr,PTHREAD_MUTEX_RECURSIVE);
            if(set_attr_res)
            {
                BOOST_VERIFY(!pthread_mutexattr_destroy(&attr));
                methcla_boost::throw_exception(thread_resource_error(set_attr_res, "methcla_boost:: recursive_mutex constructor failed in pthread_mutexattr_settype"));
            }
            ...
            {
                BOOST_VERIFY(!pthread_mutexattr_destroy(&attr));
                methcla_boost::throw_exception(thread_resource_error(res, "methcla_boost:: recursive_mutex constructor failed in pthread_mutex_init"));
            }
            BOOST_VERIFY(!pthread_mutexattr_destroy(&attr));
#else
            ...
            if(res2)
            {
                ...
                methcla_boost::throw_exception(thread_resource_error(res2, "methcla_boost:: recursive_mutex constructor failed in pthread_cond_init"));
            }
            is_locked=false;
            count=0;
#endif
...
#define BOOST_THREAD_DEFINES_RECURSIVE_MUTEX_NATIVE_HANDLE
        ...
        void lock()
        {
            methcla_boost::pthread::pthread_mutex_scoped_lock const local_lock(&m);
    ...
    public:
        ...
        recursive_timed_mutex()
        {
            ...
            if(init_attr_res)
            {
                methcla_boost::throw_exception(thread_resource_error(init_attr_res, "methcla_boost:: recursive_timed_mutex constructor failed in pthread_mutexattr_init"));
            }
            int const set_attr_res=pthread_mutexattr_settype(&attr,PTHREAD_MUTEX_RECURSIVE);
            if(set_attr_res)
            {
                methcla_boost::throw_exception(thread_resource_error(set_attr_res, "methcla_boost:: recursive_timed_mutex constructor failed in pthread_mutexattr_settype"));
            }
            ...
            {
                BOOST_VERIFY(!pthread_mutexattr_destroy(&attr));
                methcla_boost::throw_exception(thread_resource_error(res, "methcla_boost:: recursive_timed_mutex constructor failed in pthread_mutex_init"));
            }
            BOOST_VERIFY(!pthread_mutexattr_destroy(&attr));
#else
            int const res=posix::pthread_mutex_init(&m);
            ...
            {
                BOOST_VERIFY(!posix::pthread_mutex_destroy(&m));
                methcla_boost::throw_exception(thread_resource_error(res2, "methcla_boost:: recursive_timed_mutex constructor failed in pthread_cond_init"));
            }
            is_locked=false;
            count=0;
#endif
