...
#pragma warning(pop)
            ...
            void lock() BOOST_THREAD_ACQUIRE()
            {
                ...
                if(old_count&lock_flag_value)
                {
                    ...
                    do
                    {
                        if(winapi::WaitForSingleObjectEx(sem,::methcla_boost::detail::win32::infinite,0)==0)
                        {
        ...
        public:
            ...
            bool timed_lock(methcla_boost::xtime const& timeout)
            {
                return timed_lock(methcla_boost::system_time(timeout));
            }
#endif
#ifdef BOOST_THREAD_USES_CHRONO
        ...
        private:
            ...
            void* get_event()
            {
                void* current_event=::methcla_boost::detail::interlocked_read_acquire(&event);
