...
namespace methcla_boost
{
            ...
            for(;;)
            {
                ...
                for(;;)
                {
                    ...
                    if(new_state.exclusive || new_state.exclusive_waiting_blocked)
                    {
                        ...
                        {
                            methcla_boost::throw_exception(methcla_boost::lock_error());
                        }
                    }
                    else
                    {
                ...
                BOOST_VERIFY(winapi::WaitForSingleObjectEx(semaphores[unlock_sem],::methcla_boost::detail::win32::infinite,0)==0);
            }
        }
    ...
    public:
        ...
        bool timed_lock_shared(methcla_boost::system_time const& wait_until)
        {
        ...
        void lock()
        {
            for(;;)
            {
                ...
                #endif
                BOOST_VERIFY(winapi::WaitForMultipleObjectsEx(2,semaphores,wait_all,::methcla_boost::detail::win32::infinite,0)<2);
            }
        }
...
#if defined BOOST_THREAD_USES_DATETIME
        bool timed_lock(methcla_boost::system_time const& wait_until)
        {
            const detail::real_platform_timepoint t(wait_until);
