...
// BOOST_CLASS_IMPLEMENTATION(methcla_boost::uuids::uuid, methcla_boost::serialization::primitive_type)
...
template<> struct implementation_level_impl<const uuids::uuid>: methcla_boost::integral_constant<int, 1> {};
...
template<> struct hash<methcla_boost::uuids::uuid>
{
    BOOST_CXX14_CONSTEXPR std::size_t operator()( methcla_boost::uuids::uuid const& value ) const noexcept
    {
        return methcla_boost::uuids::hash_value( value );
    }
};
