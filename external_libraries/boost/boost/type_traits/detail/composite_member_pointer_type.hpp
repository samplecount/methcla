...
template<class C1, class C2> struct common_member_class
{
    typedef typename methcla_boost::conditional<
        ...
        methcla_boost::is_base_of<C1, C2>::value,
        C2,
        typename methcla_boost::conditional<methcla_boost::is_base_of<C2, C1>::value, C1, void>::type
...
private:
    ...
    typedef typename methcla_boost::remove_pointer<CPT>::type CT;
