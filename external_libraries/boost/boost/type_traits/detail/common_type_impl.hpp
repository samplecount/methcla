...
{
    BOOST_STATIC_CONSTANT( bool, ct = methcla_boost::is_class<T>::value || methcla_boost::is_union<T>::value );
    BOOST_STATIC_CONSTANT( bool, cu = methcla_boost::is_class<U>::value || methcla_boost::is_union<U>::value );
...
template<class T, class U> struct common_type_class: public methcla_boost::conditional<

    methcla_boost::is_convertible<T, U>::value && !methcla_boost::is_convertible<U, T>::value,
    methcla_boost::type_identity<U>,

    typename methcla_boost::conditional<

        methcla_boost::is_convertible<U, T>::value && !methcla_boost::is_convertible<T, U>::value,
        methcla_boost::type_identity<T>,
...
template<class T, class U> struct common_type_impl: public methcla_boost::conditional<
    ct_class<T, U>::value,
...
template<class T, class U> struct common_type_impl3: public methcla_boost::conditional<
    methcla_boost::is_pointer<T>::value || methcla_boost::is_pointer<U>::value,
...
template<class T, class U> struct common_type_impl4: public methcla_boost::conditional<
    methcla_boost::is_member_pointer<T>::value || methcla_boost::is_member_pointer<U>::value,
