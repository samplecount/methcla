...
{
template <class T> struct is_nothrow_swappable : methcla_boost::integral_constant<bool,
    methcla_boost::is_scalar<T>::value && !methcla_boost::is_const<T>::value> {};
...
template<class T, class U> struct is_nothrow_swappable_with: methcla_boost_type_traits_swappable_detail::is_nothrow_swappable_with_helper<T, U>::type
{
};

template<class T> struct is_nothrow_swappable: methcla_boost_type_traits_swappable_detail::is_nothrow_swappable_helper<T>::type
{
};
