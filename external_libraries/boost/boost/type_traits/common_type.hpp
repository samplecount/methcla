...
template<class T> struct common_type<T>: methcla_boost::decay<T>
{
   BOOST_STATIC_ASSERT_MSG(::methcla_boost::is_complete<T>::value || ::methcla_boost::is_void<T>::value || ::methcla_boost::is_array<T>::value, "Arguments to common_type must both be complete types");
};
...
template<class T1, class T2> using builtin_common_type = typename methcla_boost::decay<decltype( methcla_boost::declval<bool>()? methcla_boost::declval<T1>(): methcla_boost::declval<T2>() )>::type;
...
template<class T1, class T2> using builtin_common_type = decltype( methcla_boost::declval<bool>()? methcla_boost::declval<T1>(): methcla_boost::declval<T2>() );

template<class T1, class T2> struct common_type_impl_2: mp_defer<builtin_common_type, T1, T2>
{
};

template<class T1, class T2> using decay_common_type = typename methcla_boost::decay<typename common_type_impl_2<T1, T2>::type>::type;
...
template<class T1, class T2> struct common_type_impl: methcla_boost::decay<decltype( methcla_boost::declval<bool>()? methcla_boost::declval<T1>(): methcla_boost::declval<T2>() )>
{
};
...
template<class T1, class T2, class T1d = typename methcla_boost::decay<T1>::type, class T2d = typename methcla_boost::decay<T2>::type> struct common_type_decay_helper: methcla_boost::common_type<T1d, T2d>
{
};
...
{
   BOOST_STATIC_ASSERT_MSG(::methcla_boost::is_complete<T1>::value || ::methcla_boost::is_void<T1>::value || ::methcla_boost::is_array<T1>::value, "Arguments to common_type must both be complete types");
   BOOST_STATIC_ASSERT_MSG(::methcla_boost::is_complete<T2>::value || ::methcla_boost::is_void<T2>::value || ::methcla_boost::is_array<T2>::value, "Arguments to common_type must both be complete types");
};
