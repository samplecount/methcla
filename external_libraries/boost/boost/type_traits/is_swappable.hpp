...
template<class T, class U> struct is_swappable_with : methcla_boost_type_traits_swappable_detail::is_swappable_with_helper<T, U>::type
{
};

template<class T> struct is_swappable : methcla_boost_type_traits_swappable_detail::is_swappable_helper<T>::type
{
};
...
template<class T> struct is_swappable
    : methcla_boost::conjunction<
        methcla_boost::negation< methcla_boost::is_const<T> >,
        methcla_boost::is_constructible<T, T&&>,
        methcla_boost::is_assignable<T&, T&&>
    >::type {};
...
template<class T> struct is_swappable : methcla_boost::is_scalar<T> {};
