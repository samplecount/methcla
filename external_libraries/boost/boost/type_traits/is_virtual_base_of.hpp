...
#pragma GCC system_header
      ...
      template<class T, class U,
         typename methcla_boost::make_void<decltype((U*)(std::declval<T*>()))>::type* =
         nullptr>
   ...
   struct is_virtual_base_of : public
      methcla_boost::integral_constant<
      bool,
      methcla_boost::is_base_of<T, U>::value &&
   ...
   {
      typedef methcla_boost::integral_constant<bool, (methcla_boost::is_base_of<Base, Derived>::value && !methcla_boost::is_same<Base, Derived>::value)> tag_type;
...
template <class Base, class Derived> struct is_virtual_base_of : public integral_constant<bool, (::methcla_boost::detail::is_virtual_base_of_impl2<Base, Derived>::value)> {};
