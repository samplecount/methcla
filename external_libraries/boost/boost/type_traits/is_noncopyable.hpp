...
//
//  is_noncopyable<T> returns whether T is derived from methcla_boost::noncopyable
//
...
// methcla_boost::noncopyable derives from noncopyable_::base_token to enable us
