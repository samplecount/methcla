...
{
   BOOST_STATIC_ASSERT_MSG(methcla_boost::is_complete<T>::value, "Arguments to is_nothrow_move_assignable must be complete types");
};
...
struct false_or_cpp11_noexcept_move_assignable: public ::methcla_boost::false_type {};

template <class T>
struct false_or_cpp11_noexcept_move_assignable <
        T,
        typename ::methcla_boost::enable_if_<sizeof(T) && BOOST_NOEXCEPT_EXPR(::methcla_boost::declval<T&>() = ::methcla_boost::declval<T>())>::type
    > : public ::methcla_boost::integral_constant<bool, BOOST_NOEXCEPT_EXPR(::methcla_boost::declval<T&>() = ::methcla_boost::declval<T>())>
{};

}

template <class T>
struct is_nothrow_move_assignable : public integral_constant<bool, ::methcla_boost::detail::false_or_cpp11_noexcept_move_assignable<T>::value>
{
   BOOST_STATIC_ASSERT_MSG(methcla_boost::is_complete<T>::value, "Arguments to is_nothrow_move_assignable must be complete types");
};

template <class T> struct is_nothrow_move_assignable<T const> : public ::methcla_boost::false_type {};
template <class T> struct is_nothrow_move_assignable<T const volatile> : public ::methcla_boost::false_type{};
template <class T> struct is_nothrow_move_assignable<T volatile> : public ::methcla_boost::false_type{};
template <class T> struct is_nothrow_move_assignable<T&> : public ::methcla_boost::false_type{};
...
struct is_nothrow_move_assignable : public integral_constant<bool,
   (::methcla_boost::has_trivial_move_assign<T>::value || ::methcla_boost::has_nothrow_assign<T>::value) &&  ! ::methcla_boost::is_array<T>::value>
{
   BOOST_STATIC_ASSERT_MSG(methcla_boost::is_complete<T>::value, "Arguments to is_nothrow_move_assignable must be complete types");
};
