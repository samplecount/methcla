...
private:
    ...
    void set_library_version(methcla_boost::serialization::library_version_type archive_library_version) BOOST_OVERRIDE {
    ...
    void load(methcla_boost::long_long_type & t) BOOST_OVERRIDE {
        ArchiveImplementation::load(t);
    }
    void load(methcla_boost::ulong_long_type & t) BOOST_OVERRIDE {
        ArchiveImplementation::load(t);
    }
