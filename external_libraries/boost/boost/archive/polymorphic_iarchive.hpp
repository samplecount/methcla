...
public:
    ...
    virtual void load(methcla_boost::long_long_type & t) = 0;
    virtual void load(methcla_boost::ulong_long_type & t) = 0;
...
public:
    ...
    virtual void set_library_version(
        methcla_boost::serialization::library_version_type archive_library_version
    ) = 0;
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(methcla_boost::archive::polymorphic_iarchive)
