...
class escape :
    public methcla_boost::iterator_adaptor<
        Derived,
        Base,
        typename methcla_boost::iterator_value<Base>::type,
        single_pass_traversal_tag,
        typename methcla_boost::iterator_value<Base>::type
    >
{
    typedef typename methcla_boost::iterator_value<Base>::type base_value_type;
    typedef typename methcla_boost::iterator_reference<Base>::type reference_type;
