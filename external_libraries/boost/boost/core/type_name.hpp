...
// std::string methcla_boost::core::type_name<T>()
//
...
{
    std::string r = methcla_boost::core::demangle( n );
...
template<> struct tn_holder<methcla_boost::long_long_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
template<> struct tn_holder<methcla_boost::ulong_long_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
template<> struct tn_holder<methcla_boost::int128_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
template<> struct tn_holder<methcla_boost::uint128_type>
{
    static std::string type_name( std::string const& suffix )
    {
