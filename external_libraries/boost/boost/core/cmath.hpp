...
{
    return methcla_boost::core::isnormal( static_cast<double>( x ) );
}
...
inline int fpclassify( float x )
{
    ...
    default:
        ...
        return methcla_boost::core::isnormal( x )? fp_normal: fp_subnormal;
    }
}
...
{
    return methcla_boost::core::fpclassify( static_cast<double>( x ) );
}
...
template<class T> T copysign( T x, T y )
{
    return methcla_boost::core::detail::copysign_impl( x, y );
}
