...
{
    methcla_boost::allocator_destroy_n(a, p, n);
}
...
{
    methcla_boost::allocator_construct(a, p, std::forward<U>(u),
        std::forward<V>(v)...);
}
#else
...
{
    methcla_boost::allocator_construct(a, p, u);
}
...
{
    methcla_boost::allocator_construct_n(a, p, n);
}
...
{
    methcla_boost::allocator_construct_n(a, p, n, l, m);
}
...
{
    methcla_boost::allocator_construct_n(a, p, n, b);
}
