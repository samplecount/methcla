...
addressof(T& o) BOOST_NOEXCEPT
{
    ...
    return methcla_boost::detail::addrof<T>::get(o, 0);
#else
    return methcla_boost::detail::addrof<T>::get(methcla_boost::detail::addrof_ref<T>(o), 0);
#endif
}
...
BOOST_FORCEINLINE typename methcla_boost::detail::addrof_result<T[N]>::type
...
addressof(T& o) BOOST_NOEXCEPT
{
    return methcla_boost::detail::addressof(o);
}
#endif
