...
union system_timeofday_information
{
   struct data_t
   {
      ...
      ::methcla_boost::ulong_long_type ullBootTimeBias;
      ::methcla_boost::ulong_long_type ullSleepTimeBias;
   } data;
...
typedef methcla_boost::winapi::LONG_ LSTATUS;

typedef methcla_boost::winapi::DWORD_ (__stdcall *LPTHREAD_START_ROUTINE_)
   (methcla_boost::winapi::LPVOID_ lpThreadParameter);


//#ifndef BOOST_USE_WINDOWS_H
//typedef methcla_boost::winapi::LARGE_INTEGER_ LARGE_INTEGER_EXT;
//#else
//typedef LARGE_INTEGER LARGE_INTEGER_EXT;
//#endif

}} //namespace methcla_boost::ipwinapiext
...
//Error handling
BOOST_SYMBOL_IMPORT BOOST_WINAPI_DETAIL_VOID BOOST_WINAPI_WINAPI_CC SetLastError(methcla_boost::winapi::DWORD_ dwErrCode);

//File management
BOOST_SYMBOL_IMPORT methcla_boost::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC GetFileType(methcla_boost::winapi::HANDLE_ hTemplateFile);
BOOST_SYMBOL_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC FlushFileBuffers(methcla_boost::winapi::HANDLE_ hFile);

//threading

BOOST_SYMBOL_IMPORT methcla_boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC CreateThread
   ( ::_SECURITY_ATTRIBUTES* lpThreadAttributes
   , methcla_boost::winapi::SIZE_T_ dwStackSize
   , methcla_boost::ipwinapiext::LPTHREAD_START_ROUTINE_ lpStartAddress
   , methcla_boost::winapi::LPVOID_ lpParameter
   , methcla_boost::winapi::DWORD_ dwCreationFlags
   , methcla_boost::winapi::LPDWORD_ lpThreadId
   );

//Virtual Memory
BOOST_SYMBOL_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC VirtualLock(methcla_boost::winapi::LPVOID_ lpAddress, methcla_boost::winapi::SIZE_T_ dwSize);
BOOST_SYMBOL_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC VirtualUnlock(methcla_boost::winapi::LPVOID_ lpAddress, methcla_boost::winapi::SIZE_T_ dwSize);
BOOST_SYMBOL_IMPORT methcla_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC VirtualProtect( methcla_boost::winapi::LPVOID_ lpAddress, methcla_boost::winapi::SIZE_T_ dwSize
                                                                              , methcla_boost::winapi::DWORD_ flNewProtect, methcla_boost::winapi::PDWORD_ lpflOldProtect);
//registry.hpp
BOOST_WINAPI_DETAIL_DECLARE_HANDLE(HKEY);


BOOST_SYMBOL_IMPORT methcla_boost::ipwinapiext::LSTATUS BOOST_WINAPI_WINAPI_CC RegOpenKeyExA
   (::HKEY hKey, const char *lpSubKey, methcla_boost::winapi::DWORD_ ulOptions, methcla_boost::winapi::DWORD_ samDesired, ::HKEY *phkResult);
BOOST_SYMBOL_IMPORT methcla_boost::ipwinapiext::LSTATUS BOOST_WINAPI_WINAPI_CC RegOpenKeyExW
   (::HKEY hKey, const wchar_t *lpSubKey, methcla_boost::winapi::DWORD_ ulOptions, methcla_boost::winapi::DWORD_ samDesired, ::HKEY *phkResult);
BOOST_SYMBOL_IMPORT methcla_boost::ipwinapiext::LSTATUS BOOST_WINAPI_WINAPI_CC RegQueryValueExA
   (::HKEY hKey, const char *lpValueName, methcla_boost::winapi::DWORD_ *lpReserved, methcla_boost::winapi::DWORD_ *lpType, methcla_boost::winapi::BYTE_ *lpData, methcla_boost::winapi::DWORD_ *lpcbData);
BOOST_SYMBOL_IMPORT methcla_boost::ipwinapiext::LSTATUS BOOST_WINAPI_WINAPI_CC RegQueryValueExW
   (::HKEY hKey, const wchar_t *lpValueName, methcla_boost::winapi::DWORD_ *lpReserved, methcla_boost::winapi::DWORD_ *lpType, methcla_boost::winapi::BYTE_ *lpData, methcla_boost::winapi::DWORD_ *lpcbData);
BOOST_SYMBOL_IMPORT methcla_boost::ipwinapiext::LSTATUS BOOST_WINAPI_WINAPI_CC RegCloseKey(::HKEY hKey);


//Event Log
BOOST_SYMBOL_IMPORT methcla_boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC OpenEventLogA(const char* lpUNCServerName, const char* lpSourceName);
BOOST_SYMBOL_IMPORT methcla_boost::winapi::HANDLE_ BOOST_WINAPI_WINAPI_CC OpenEventLogW(const wchar_t* lpUNCServerName, const wchar_t* lpSourceName);
BOOST_SYMBOL_IMPORT methcla_boost::winapi::BOOL_   BOOST_WINAPI_WINAPI_CC CloseEventLog(methcla_boost::winapi::HANDLE_ hEventLog);
BOOST_SYMBOL_IMPORT methcla_boost::winapi::BOOL_   BOOST_WINAPI_WINAPI_CC ReadEventLogA
   ( methcla_boost::winapi::HANDLE_ hEventLog, methcla_boost::winapi::DWORD_ dwReadFlags, methcla_boost::winapi::DWORD_ dwRecordOffset, void* lpBuffer
   , methcla_boost::winapi::DWORD_ nNumberOfBytesToRead, methcla_boost::winapi::DWORD_ *pnBytesRead, methcla_boost::winapi::DWORD_ *pnMinNumberOfBytesNeeded);
BOOST_SYMBOL_IMPORT methcla_boost::winapi::BOOL_   BOOST_WINAPI_WINAPI_CC ReadEventLogW
   ( methcla_boost::winapi::HANDLE_ hEventLog, methcla_boost::winapi::DWORD_ dwReadFlags, methcla_boost::winapi::DWORD_ dwRecordOffset, void* lpBuffer
   , methcla_boost::winapi::DWORD_ nNumberOfBytesToRead, methcla_boost::winapi::DWORD_ *pnBytesRead, methcla_boost::winapi::DWORD_ *pnMinNumberOfBytesNeeded); 
...
//Threads
BOOST_FORCEINLINE methcla_boost::winapi::HANDLE_ CreateThread
   ( methcla_boost::winapi::SECURITY_ATTRIBUTES_* lpThreadAttributes
   , methcla_boost::winapi::SIZE_T_ dwStackSize
   , methcla_boost::ipwinapiext::LPTHREAD_START_ROUTINE_ lpStartAddress
   , methcla_boost::winapi::LPVOID_ lpParameter
   , methcla_boost::winapi::DWORD_ dwCreationFlags
...
//Error handling
BOOST_FORCEINLINE BOOST_WINAPI_DETAIL_VOID SetLastError(methcla_boost::winapi::DWORD_ dwErrCode)
{  ::SetLastError(dwErrCode); }

//File management
BOOST_FORCEINLINE methcla_boost::winapi::DWORD_ GetFileType(methcla_boost::winapi::HANDLE_ hTemplateFile)
{  return ::GetFileType(hTemplateFile);   }

BOOST_FORCEINLINE methcla_boost::winapi::BOOL_ FlushFileBuffers(methcla_boost::winapi::HANDLE_ hFile)
{  return ::FlushFileBuffers(hFile);   }

//Virtual Memory
BOOST_FORCEINLINE methcla_boost::winapi::BOOL_ VirtualLock(methcla_boost::winapi::LPVOID_ lpAddress, methcla_boost::winapi::SIZE_T_ dwSize)
{  return ::VirtualLock(lpAddress, dwSize);  }

BOOST_FORCEINLINE methcla_boost::winapi::BOOL_ VirtualUnlock(methcla_boost::winapi::LPVOID_ lpAddress, methcla_boost::winapi::SIZE_T_ dwSize)
{  return ::VirtualUnlock(lpAddress, dwSize);   }

BOOST_FORCEINLINE methcla_boost::winapi::BOOL_ VirtualProtect( methcla_boost::winapi::LPVOID_ lpAddress, methcla_boost::winapi::SIZE_T_ dwSize
                                                     , methcla_boost::winapi::DWORD_ flNewProtect, methcla_boost::winapi::PDWORD_ lpflOldProtect)
{  return ::VirtualProtect(lpAddress, dwSize, flNewProtect, lpflOldProtect);  }

//registry.hpp
BOOST_FORCEINLINE methcla_boost::ipwinapiext::LSTATUS RegOpenKeyExA
   (methcla_boost::ipwinapiext::HKEY_ hKey, const char *lpSubKey, methcla_boost::winapi::DWORD_ ulOptions, methcla_boost::winapi::DWORD_ samDesired, methcla_boost::ipwinapiext::HKEY_ *phkResult)
{
   return ::RegOpenKeyExA(reinterpret_cast< ::HKEY >(hKey), lpSubKey, ulOptions, samDesired, reinterpret_cast< ::HKEY* >(phkResult));
}

BOOST_FORCEINLINE methcla_boost::ipwinapiext::LSTATUS RegOpenKeyExW
   (methcla_boost::ipwinapiext::HKEY_ hKey, const wchar_t *lpSubKey, methcla_boost::winapi::DWORD_ ulOptions, methcla_boost::winapi::DWORD_ samDesired, methcla_boost::ipwinapiext::HKEY_ *phkResult)
{
   return ::RegOpenKeyExW(reinterpret_cast< ::HKEY >(hKey), lpSubKey, ulOptions, samDesired, reinterpret_cast< ::HKEY* >(phkResult));
}

BOOST_FORCEINLINE methcla_boost::ipwinapiext::LSTATUS RegQueryValueExA
   (methcla_boost::ipwinapiext::HKEY_ hKey, const char *lpValueName, methcla_boost::winapi::DWORD_ *lpReserved, methcla_boost::winapi::DWORD_ *lpType, methcla_boost::winapi::BYTE_ *lpData, methcla_boost::winapi::DWORD_ *lpcbData)
{
   return ::RegQueryValueExA(reinterpret_cast< ::HKEY >(hKey), lpValueName, lpReserved, lpType, lpData, lpcbData);
}

BOOST_FORCEINLINE methcla_boost::ipwinapiext::LSTATUS RegQueryValueExW
   (methcla_boost::ipwinapiext::HKEY_ hKey, const wchar_t *lpValueName, methcla_boost::winapi::DWORD_ *lpReserved, methcla_boost::winapi::DWORD_ *lpType, methcla_boost::winapi::BYTE_ *lpData, methcla_boost::winapi::DWORD_ *lpcbData)
{
   return ::RegQueryValueExW(reinterpret_cast< ::HKEY >(hKey), lpValueName, lpReserved, lpType, lpData, lpcbData);
}

BOOST_FORCEINLINE methcla_boost::ipwinapiext::LSTATUS RegCloseKey(methcla_boost::ipwinapiext::HKEY_ hKey)
{
   return ::RegCloseKey(reinterpret_cast< ::HKEY >(hKey));
}

BOOST_FORCEINLINE void GetSystemInfo(methcla_boost::winapi::LPSYSTEM_INFO_ lpSystemInfo)
...
typedef methcla_boost::winapi::SYSTEM_INFO_ interprocess_system_info;
typedef methcla_boost::winapi::OVERLAPPED_ interprocess_overlapped;
typedef methcla_boost::winapi::FILETIME_ interprocess_filetime;
typedef methcla_boost::winapi::WIN32_FIND_DATAA_ win32_find_data_a;
typedef methcla_boost::winapi::WIN32_FIND_DATAW_ win32_find_data_w;
typedef methcla_boost::winapi::SECURITY_ATTRIBUTES_ interprocess_security_attributes;
typedef methcla_boost::winapi::SECURITY_DESCRIPTOR_ interprocess_security_descriptor;
typedef methcla_boost::winapi::BY_HANDLE_FILE_INFORMATION_ interprocess_by_handle_file_information;
typedef methcla_boost::winapi::HMODULE_ hmodule;
typedef methcla_boost::ipwinapiext::HKEY_ hkey;
typedef methcla_boost::winapi::FARPROC_ farproc_t;
...
class interprocess_all_access_security
{
   ...
   interprocess_all_access_security()
      : initialized(false)
   {
      if(!methcla_boost::winapi::InitializeSecurityDescriptor(&sd, security_descriptor_revision))
         return;
      if(!methcla_boost::winapi::SetSecurityDescriptorDacl(&sd, true, 0, false))
         return;
...
inline void * create_file_mapping (void * handle, unsigned long access, ::methcla_boost::ulong_long_type file_offset, const char * name, interprocess_security_attributes *psec)
{
   const methcla_boost::winapi::DWORD_ high_size = methcla_boost::winapi::DWORD_(file_offset >> 32);
   const methcla_boost::winapi::DWORD_ low_size  = methcla_boost::winapi::DWORD_(file_offset);
   return CreateFileMappingA (handle, psec, access, high_size, low_size, name);
}

inline void * create_file_mapping (void * handle, unsigned long access, ::methcla_boost::ulong_long_type file_offset, const wchar_t * name, interprocess_security_attributes *psec)
{
   const methcla_boost::winapi::DWORD_ high_size = methcla_boost::winapi::DWORD_(file_offset >> 32);
   const methcla_boost::winapi::DWORD_ low_size  = methcla_boost::winapi::DWORD_(file_offset);
...
inline void *map_view_of_file_ex(void *handle, unsigned long file_access, ::methcla_boost::ulong_long_type offset, std::size_t numbytes, void *base_addr)
{
   const methcla_boost::winapi::DWORD_ offset_low  = methcla_boost::winapi::DWORD_(offset & ((::methcla_boost::ulong_long_type)0xFFFFFFFF));
   const methcla_boost::winapi::DWORD_ offset_high = methcla_boost::winapi::DWORD_(offset >> 32);
...
inline void *create_file(const CharT *name, unsigned long access, unsigned long creation_flags, unsigned long attributes, interprocess_security_attributes *psec)
{
   for (unsigned int attempt(0); attempt < error_sharing_violation_tries; ++attempt){
      void * const handle = methcla_boost::winapi::create_file(name, access,
...
{  methcla_boost::ipwinapiext::GetSystemInfo(info); }

inline bool flush_view_of_file(void *base_addr, std::size_t numbytes)
{  return 0 != methcla_boost::winapi::FlushViewOfFile(base_addr, numbytes); }

inline bool virtual_unlock(void *base_addr, std::size_t numbytes)
{  return 0 != methcla_boost::ipwinapiext::VirtualUnlock(base_addr, numbytes); }

inline bool virtual_protect(void *base_addr, std::size_t numbytes, unsigned long flNewProtect, unsigned long &lpflOldProtect)
{  return 0 != methcla_boost::ipwinapiext::VirtualProtect(base_addr, numbytes, flNewProtect, &lpflOldProtect); }

inline bool flush_file_buffers(void *handle)
{  return 0 != methcla_boost::ipwinapiext::FlushFileBuffers(handle); }

inline bool get_file_size(void *handle, __int64 &size)
{  return 0 != methcla_boost::winapi::GetFileSizeEx(handle, (methcla_boost::winapi::LARGE_INTEGER_*)&size);  }

template<class CharT>
inline bool create_directory(const CharT *name)
{
   interprocess_all_access_security sec;
   return 0 != methcla_boost::winapi::create_directory(name, sec.get_attributes());
}

template<class CharT>
inline bool remove_directory(const CharT *lpPathName)
{  return 0 != methcla_boost::winapi::remove_directory(lpPathName);   }

template<class CharT>
inline unsigned long get_temp_path(unsigned long length, CharT *buffer)
{  return methcla_boost::winapi::get_temp_path(length, buffer);   }

inline int set_end_of_file(void *handle)
{  return 0 != methcla_boost::winapi::SetEndOfFile(handle);   }

inline bool set_file_pointer(void *handle, __int64 distance, __int64 *new_file_pointer, unsigned long move_method)
{
   methcla_boost::winapi::LONG_ highPart = methcla_boost::winapi::LONG_(distance >> 32u);
   methcla_boost::winapi::DWORD_ r = methcla_boost::winapi::SetFilePointer(handle, (long)distance, &highPart, move_method);
   bool br = r != methcla_boost::winapi::INVALID_SET_FILE_POINTER_ || methcla_boost::winapi::GetLastError() != 0;
...
{  return 0 != methcla_boost::winapi::LockFileEx(hnd, flags, reserved, size_low, size_high, overlapped); }
...
{  return 0 != methcla_boost::winapi::UnlockFileEx(hnd, reserved, size_low, size_high, overlapped);  }
...
{  return 0 != methcla_boost::winapi::WriteFile(hnd, buffer, bytes_to_write, bytes_written, overlapped);  }
...
{  return 0 != methcla_boost::winapi::ReadFile(hnd, buffer, bytes_to_read, bytes_read, overlapped);  }

inline bool get_file_information_by_handle(void *hnd, interprocess_by_handle_file_information *info)
{  return 0 != methcla_boost::winapi::GetFileInformationByHandle(hnd, info);  }
...
{  return methcla_boost::winapi::LoadLibraryA(name); }

inline bool free_library(hmodule module)
{  return 0 != methcla_boost::winapi::FreeLibrary(module); }

inline farproc_t get_proc_address(hmodule module, const char *name)
{  return methcla_boost::winapi::GetProcAddress(module, name); }

inline void *get_current_process()
{  return methcla_boost::winapi::GetCurrentProcess();  }

inline hmodule get_module_handle(const char *name)
{  return methcla_boost::winapi::GetModuleHandleA(name); }
...
{  return methcla_boost::ipwinapiext::RegOpenKeyExA(hKey, lpSubKey, ulOptions, samDesired, phkResult); }
...
{  return methcla_boost::ipwinapiext::RegOpenKeyExW(hKey, lpSubKey, ulOptions, samDesired, phkResult); }
...
{  return methcla_boost::ipwinapiext::RegQueryValueExA(hKey, lpValueName, lpReserved, lpType, lpData, lpcbData); }
...
{  return methcla_boost::ipwinapiext::RegQueryValueExW(hKey, lpValueName, lpReserved, lpType, lpData, lpcbData); }

inline long reg_close_key(hkey hKey)
{  return methcla_boost::ipwinapiext::RegCloseKey(hKey); }
...
class nt_query_mem_deleter
{
   ...
   static const std::size_t rename_suffix =
      (SystemTimeOfDayInfoLength + sizeof(unsigned long) + sizeof(methcla_boost::winapi::DWORD_))*2;
...
inline bool unlink_file(const CharT *filename)
{
   ...
   BOOST_INTERPROCESS_TRY{
      ...
      handle_closer h_closer(fh);
      {
         ...
         static volatile methcla_boost::uint32_t u32_count = 0;
         interlocked_decrement(reinterpret_cast<volatile long*>(&u32_count));
         buffer_to_wide_str(const_cast<const methcla_boost::uint32_t *>(&u32_count), sizeof(methcla_boost::uint32_t), &pfri->FileName[filename_string_length]);
         filename_string_length += sizeof(methcla_boost::uint32_t)*2;
...
{
   return 0 != methcla_boost::winapi::QueryPerformanceCounter(reinterpret_cast<methcla_boost::winapi::LARGE_INTEGER_*>(lpPerformanceCount));
}

inline bool query_performance_frequency(__int64 *lpFrequency)
{
   return 0 != methcla_boost::winapi::QueryPerformanceFrequency(reinterpret_cast<methcla_boost::winapi::LARGE_INTEGER_*>(lpFrequency));
}
