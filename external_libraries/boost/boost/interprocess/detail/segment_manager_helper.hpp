...
struct block_header
{
   ...
   size_type total_named_size_with_header(std::size_t namelen) const
   {
      ...
      return get_rounded_size
               ...
               , size_type(::methcla_boost::container::dtl::alignment_of<block_header<size_type> >::value))
   ...
   static block_header *block_header_from_value(T *value)
   {
      ...
      const std::size_t algn = ::methcla_boost::container::dtl::alignment_of<T>::value;
      block_header* hdr =
   ...
   static block_header *from_first_header(Header *header)
   {
      block_header * hdr =
       ...
       get_rounded_size( size_type(sizeof(Header))
                       , size_type(::methcla_boost::container::dtl::alignment_of<block_header >::value)));
      //Some sanity checks
      return hdr;
   }
...
struct sm_between_headers
{
   BOOST_STATIC_CONSTEXPR std::size_t value
      = sizeof(Header)
      + ct_rounded_size< sizeof(BlockHeader), methcla_boost::move_detail::alignment_of<Header>::value>::value
      - sizeof(BlockHeader);
};
...
struct sg_offsets_with_header
{
   ...
   BOOST_INTERPROCESS_STATIC_ASSERT((front_space % methcla_boost::move_detail::alignment_of<Header>::value) == 0);
   BOOST_INTERPROCESS_STATIC_ASSERT((block_header_prefix % methcla_boost::move_detail::alignment_of<BlockHeader>::value) == 0);
...
struct block_header
{
   ...
   size_type total_named_size(std::size_t namelen) const
   {
      ...
      return block_header_prefix
         + name_offset< ::methcla_boost::move_detail::alignment_of<CharType>::value>()
   ...
   CharType *name() const
   {
      return const_cast<CharType*>(move_detail::force_ptr<const CharType*>
         (reinterpret_cast<const char*>(this) +
          this->template name_offset< ::methcla_boost::move_detail::alignment_of<CharType>::value>()));
   }
   ...
   static block_header *block_header_from_value(T *value)
   {
      BOOST_ASSERT(is_ptr_aligned(value, ::methcla_boost::container::dtl::alignment_of<T>::value));
      block_header* hdr =
         const_cast<block_header*>
   ...
   size_type name_length_offset() const
   {
      return this->value_offset() +
         get_rounded_size( size_type(m_value_bytes)
                         , size_type(::methcla_boost::move_detail::alignment_of<name_len_t>::value));
   }
};
...
struct index_key
{
   ...
   typedef CharT                                         char_type;
   typedef typename methcla_boost::intrusive::pointer_traits<const_char_ptr_t>::difference_type difference_type;
   typedef typename methcla_boost::move_detail::make_unsigned<difference_type>::type size_type;
