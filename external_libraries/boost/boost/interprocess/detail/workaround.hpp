...
}} //namespace methcla_boost::interprocess {
...
#define BOOST_INTERPROCESS_STATIC_ASSERT(B) \
         typedef ::methcla_boost::interprocess::dtl::static_assert_test<\
            (unsigned)sizeof(::methcla_boost::interprocess::dtl::STATIC_ASSERTION_FAILURE<bool(B)>)>\
