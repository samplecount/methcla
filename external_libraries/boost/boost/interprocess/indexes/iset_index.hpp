...
//!\file
//!Describes index adaptor of methcla_boost::intrusive::set container, to use it
...
//!Index type based in methcla_boost::intrusive::set.
//!Just derives from methcla_boost::intrusive::set
...
struct is_intrusive_index
   <methcla_boost::interprocess::iset_index<MapConfig> >
{
