...
namespace methcla_boost { namespace heap {
namespace detail {
...
typedef parameter::parameters< methcla_boost::parameter::optional< tag::allocator >,
                               methcla_boost::parameter::optional< tag::compare >,
                               methcla_boost::parameter::optional< tag::stable >,
                               methcla_boost::parameter::optional< tag::store_parent_pointer >,
                               methcla_boost::parameter::optional< tag::stability_counter_type >,
                               methcla_boost::parameter::optional< tag::constant_time_size >,
                               methcla_boost::parameter::optional< tag::mutable_ > >
    skew_heap_signature;
...
struct make_skew_heap_base
{
    ...
    static const bool store_parent_pointer
        = parameter::binding< BoundArgs, tag::store_parent_pointer, methcla_boost::false_type >::type::value || is_mutable;

    typedef skew_heap_node< typename base_type::internal_type, store_parent_pointer > node_type;

    typedef typename methcla_boost::allocator_rebind< allocator_argument, node_type >::type allocator_type;
 ...
 * - \c methcla_boost::heap::compare<>, defaults to \c compare<std::less<T> >
 * - \c methcla_boost::heap::stable<>, defaults to \c stable<false>
 * - \c methcla_boost::heap::stability_counter_type<>, defaults to \c stability_counter_type<methcla_boost::uintmax_t>
 * - \c methcla_boost::heap::allocator<>, defaults to \c allocator<std::allocator<T> >
 * - \c methcla_boost::heap::constant_time_size<>, defaults to \c constant_time_size<true>
 * - \c methcla_boost::heap::store_parent_pointer<>, defaults to \c store_parent_pointer<true>. Maintaining a parent pointer
 * adds some maintenance and size overhead, but iterating a heap is more efficient.
 * - \c methcla_boost::heap::mutable<>, defaults to \c mutable<false>.
 *
 */
...
#else
template < typename T,
           class A0 = methcla_boost::parameter::void_,
           class A1 = methcla_boost::parameter::void_,
           class A2 = methcla_boost::parameter::void_,
           class A3 = methcla_boost::parameter::void_,
           class A4 = methcla_boost::parameter::void_,
           class A5 = methcla_boost::parameter::void_,
           class A6 = methcla_boost::parameter::void_ >
#endif
class skew_heap :
    private detail::make_skew_heap_base< T, typename detail::skew_heap_signature::bind< A0, A1, A2, A3, A4, A5, A6 >::type >::type
{
    ...
    struct implementation_defined : detail::extract_allocator_types< typename base_maker::allocator_argument >
    {
        ...
        typedef typename methcla_boost::allocator_pointer< allocator_type >::type       node_pointer;
        typedef typename methcla_boost::allocator_const_pointer< allocator_type >::type const_node_pointer;
...
public:
    ...
    /// \copydoc methcla_boost::heap::priority_queue::iterator
    ...
    /// \copydoc methcla_boost::heap::priority_queue::priority_queue(value_compare const &)
    explicit skew_heap( value_compare const& cmp = value_compare() ) :
        super_t( cmp ),
        root( nullptr )
    {}

    /// \copydoc methcla_boost::heap::priority_queue::priority_queue(allocator_type const &)
    explicit skew_heap( allocator_type const& alloc ) :
        super_t( alloc ),
        root( 0 )
    {}

    /// \copydoc methcla_boost::heap::priority_queue::priority_queue(priority_queue const &)
    ...
    /// \copydoc methcla_boost::heap::priority_queue::operator=(priority_queue const & rhs)
    ...
    /// \copydoc methcla_boost::heap::priority_queue::priority_queue(priority_queue &&)
    ...
    /// \copydoc methcla_boost::heap::priority_queue::operator=(priority_queue &&)
    ...
    /// \copydoc methcla_boost::heap::priority_queue::empty
    bool empty( void ) const
    {
        return root == nullptr;
    }

    /// \copydoc methcla_boost::heap::binomial_heap::size
    ...
    /// \copydoc methcla_boost::heap::priority_queue::max_size
    size_type max_size( void ) const
    {
        const allocator_type& alloc = *this;
        return methcla_boost::allocator_max_size( alloc );
    }

    /// \copydoc methcla_boost::heap::priority_queue::clear
    void clear( void )
    {
        if ( empty() )
            return;
    ...
    /// \copydoc methcla_boost::heap::priority_queue::get_allocator
    allocator_type get_allocator( void ) const
    {
        return *this;
    }

    /// \copydoc methcla_boost::heap::priority_queue::swap
    ...
    /// \copydoc methcla_boost::heap::priority_queue::top
    ...
    /// \copydoc methcla_boost::heap::priority_queue::begin
    iterator begin( void ) const
    {
        return iterator( root, super_t::value_comp() );
    }

    /// \copydoc methcla_boost::heap::priority_queue::end
    iterator end( void ) const
    {
        return iterator();
    }

    /// \copydoc methcla_boost::heap::fibonacci_heap::ordered_begin
    ...
    /// \copydoc methcla_boost::heap::priority_queue::value_comp
    value_compare const& value_comp( void ) const
    {
        return super_t::value_comp();
    }

    /// \copydoc methcla_boost::heap::priority_queue::operator<(HeapType const & rhs) const
    ...
    /// \copydoc methcla_boost::heap::d_ary_heap::s_handle_from_iterator
