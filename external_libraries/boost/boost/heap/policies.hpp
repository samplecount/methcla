...
template < bool T >
struct stable : methcla_boost::parameter::template_keyword< tag::stable, std::integral_constant< bool, T > >
{};
...
template < bool T >
struct mutable_ : methcla_boost::parameter::template_keyword< tag::mutable_, std::integral_constant< bool, T > >
{};
...
template < bool T >
struct constant_time_size :
    methcla_boost::parameter::template_keyword< tag::constant_time_size, std::integral_constant< bool, T > >
{};
...
template < bool T >
struct store_parent_pointer :
    methcla_boost::parameter::template_keyword< tag::store_parent_pointer, std::integral_constant< bool, T > >
{};
...
struct arity : methcla_boost::parameter::template_keyword< tag::arity, std::integral_constant< int, T > >
{};
...
template < unsigned int T >
struct objects_per_page : methcla_boost::parameter::template_keyword< tag::objects_per_page, std::integral_constant< int, T > >
{};
...
struct has_arg
{
    typedef typename methcla_boost::parameter::binding< bound_args, tag_type, void >::type type;
