...
template < class C >
struct PriorityQueue : methcla_boost::ForwardContainer< C >
{
    ...
    {
        BOOST_CONCEPT_ASSERT( (methcla_boost::Assignable< value_type >));
        BOOST_CONCEPT_ASSERT( (methcla_boost::Container< C >));
        BOOST_CONCEPT_ASSERT( (methcla_boost::EqualityComparable< C >));
        BOOST_CONCEPT_ASSERT( (methcla_boost::Comparable< C >));

        BOOST_CONCEPT_ASSERT( (methcla_boost::Const_BinaryPredicate< value_compare, value_type, value_type >));
...
struct MutablePriorityQueue : PriorityQueue< C >
{
    ...
    {
        BOOST_CONCEPT_ASSERT( (methcla_boost::Assignable< typename MutablePriorityQueue::handle_type >));
