...
private:
    ...
    typedef methcla_boost::intrusive::list< detail::heap_node_base< true >, methcla_boost::intrusive::constant_time_size< false > >
        node_child_list;
#endif
...
public:
    ...
    /// \copydoc methcla_boost::heap::d_ary_heap_mutable::s_handle_from_iterator
