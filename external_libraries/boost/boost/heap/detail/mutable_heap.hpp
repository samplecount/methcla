...
private:
    ...
    typedef std::list< node_type, typename methcla_boost::allocator_rebind< allocator_type, node_type >::type > object_list;
...
public:
    ...
    class iterator_base :
        public methcla_boost::iterator_adaptor< iterator_base< iterator_type >,
                                        iterator_type,
                                        value_type const,
                                        methcla_boost::bidirectional_traversal_tag >
    {
        typedef methcla_boost::iterator_adaptor< iterator_base< iterator_type >,
                                         iterator_type,
                                         value_type const,
                                         methcla_boost::bidirectional_traversal_tag >
            super_t;
    ...
    class ordered_iterator :
        public methcla_boost::iterator_adaptor< ordered_iterator, const_list_iterator, value_type const, methcla_boost::forward_traversal_tag >,
        q_type::ordered_iterator_dispatcher
    {
        typedef methcla_boost::iterator_adaptor< ordered_iterator, const_list_iterator, value_type const, methcla_boost::forward_traversal_tag >
            adaptor_type;
    ...
    private:
        ...
        std::priority_queue< iterator,
                             std::vector< iterator, typename methcla_boost::allocator_rebind< allocator_type, iterator >::type >,
