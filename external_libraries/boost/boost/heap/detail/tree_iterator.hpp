...
struct unordered_tree_iterator_storage
{
    ...
    std::vector< HandleType, typename methcla_boost::allocator_rebind< Alloc, HandleType >::type > data_;
};
...
struct ordered_tree_iterator_storage : ValueExtractor
{
    ...
    std::priority_queue< HandleType,
                         std::vector< HandleType, typename methcla_boost::allocator_rebind< Alloc, HandleType >::type >,
...
class recursive_tree_iterator :
    public methcla_boost::iterator_adaptor< recursive_tree_iterator< Node, NodeIterator, ValueType, ValueExtractor, IteratorCoverter >,
                                    NodeIterator,
                                    ValueType const,
