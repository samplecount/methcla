...
typedef parameter::parameters< methcla_boost::parameter::required< tag::arity >,
                               methcla_boost::parameter::optional< tag::allocator >,
    ...
    make_heap_base< T, BoundArgs, false >::type
{
    ...
    typedef typename methcla_boost::allocator_rebind< typename heap_base_maker::allocator_argument, internal_type >::type
    ...
    struct rebind
    {
        typedef d_ary_heap< U,
                            typename d_ary_heap_signature::bind<
                                methcla_boost::heap::stable< heap_base_maker::is_stable >,
                                methcla_boost::heap::stability_counter_type< typename heap_base_maker::stability_counter_type >,
                                methcla_boost::heap::arity< D >,
                                methcla_boost::heap::compare< V >,
                                methcla_boost::heap::allocator< W > >::type,
                            X >
            other;
    };
 ...
 * - \c methcla_boost::heap::arity<>, required
 ...
 * - \c methcla_boost::heap::mutable_<>, defaults to \c mutable_<false>
 *
 */
...
public:
    ...
    /// \copydoc methcla_boost::heap::priority_queue::operator=(priority_queue const &)
    ...
    /// \copydoc methcla_boost::heap::priority_queue::size
    size_type size( void ) const
    {
        return super_t::size();
    }
    ...
    /// \copydoc methcla_boost::heap::priority_queue::pop
    void pop( void )
    {
        super_t::pop();
    }
    ...
    /// \copydoc methcla_boost::heap::fibonacci_heap::ordered_end
    ordered_iterator ordered_end( void ) const
    {
        return super_t::ordered_end();
    }

    /// \copydoc methcla_boost::heap::priority_queue::reserve
    void reserve( size_type element_count )
    {
