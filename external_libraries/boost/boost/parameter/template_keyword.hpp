...
namespace methcla_boost { namespace parameter {
    ...
    struct template_keyword : ::methcla_boost::parameter::aux::template_keyword_base
    {
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using reference = typename ::methcla_boost::mp11::mp_eval_if<
        ...
        typedef typename ::methcla_boost::mpl::eval_if<
            typename ::methcla_boost::mpl::if_<
                ::methcla_boost::is_function<value_type>
              , ::methcla_boost::mpl::true_
              , ::methcla_boost::is_array<value_type>
            >::type
          , ::methcla_boost::add_lvalue_reference<value_type>
          , ::methcla_boost::mpl::identity<value_type>
        >::type reference;
...
#define BOOST_PARAMETER_TEMPLATE_KEYWORD(name)                               \
    ...
    template <typename T>                                                    \
    struct name : ::methcla_boost::parameter::template_keyword<tag::name,T>          \
    {                                                                        \
    };
/**/
