...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    struct empty_arg_list
    {
        struct tagged_arg
        {
            typedef ::methcla_boost::parameter::void_ value_type;
        };
        ...
        static ::methcla_boost::parameter::aux::no_tag has_key(KW*);
        ...
        inline BOOST_CONSTEXPR Default&
            operator[](::methcla_boost::parameter::aux::default_<K,Default> x) const
        {
            return x.value;
        }
        ...
        template <typename K, typename Default>
        inline BOOST_CONSTEXPR Default&&
            operator[](::methcla_boost::parameter::aux::default_r_<K,Default> x) const
        {
        ...
        typename ::methcla_boost::parameter::aux::result_of0<F>::type
        ...
        // MPL sequence support
        typedef ::methcla_boost::parameter::aux::empty_arg_list type; // convenience
        // For dispatching to sequence intrinsics
        typedef ::methcla_boost::parameter::aux::arg_list_tag tag;
    };
}}} // namespace methcla_boost::parameter::aux
...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    template <
        typename TaggedArg
      , typename Next = ::methcla_boost::parameter::aux::empty_arg_list
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
      , typename EmitsErrors = ::methcla_boost::mp11::mp_true
#else
      , typename EmitsErrors = ::methcla_boost::mpl::true_
#endif
    >
    class arg_list : public Next
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _holds_maybe = typename ::methcla_boost::parameter::aux
     ...
     public:
        ...
        typedef ::methcla_boost::parameter::aux::arg_list<TaggedArg,Next> self;
        typedef typename TaggedArg::key_type key_type;

#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using reference = typename ::methcla_boost::mp11::mp_if<
            _holds_maybe
          , ::methcla_boost::parameter::aux
            ::get_reference<typename TaggedArg::value_type>
          , ::methcla_boost::parameter::aux::get_reference<TaggedArg>
        >::type;

        using value_type = ::methcla_boost::mp11
        ...
        inline BOOST_CONSTEXPR arg_list(
            ::methcla_boost::parameter::aux::value_type_is_not_void
          , A0&& a0
        ) : Next(
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
                ...
                typename ::methcla_boost::mpl::if_<
                    ::methcla_boost::is_same<
                      ...
                      , ::methcla_boost::parameter::void_
                    >
                  , ::methcla_boost::parameter::aux::value_type_is_void
                  , ::methcla_boost::parameter::aux::value_type_is_not_void
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
                >()
#else
        ...
        inline BOOST_CONSTEXPR arg_list(
          ...
          , arg(::methcla_boost::parameter::aux::void_reference())
        {
        }
        ...
        struct binding
        {
            ...
            {
                typedef typename ::methcla_boost::mpl::eval_if<
                    ::methcla_boost::is_same<KW,key_type>
                  , ::methcla_boost::mpl::if_<Reference,reference,value_type>
                  , ::methcla_boost::mpl
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            template <typename KW, typename Default, typename Reference>
            using fn = ::methcla_boost::mp11::mp_if<
                ::std::is_same<KW,key_type>
              , ::methcla_boost::mp11::mp_if<Reference,reference,value_type>
              , ::methcla_boost::mp11::mp_apply_q<
                    next_binding
                  , ::methcla_boost::mp11::mp_list<KW,Default,Reference>
                >
            >;
#endif
        };
        ...
        static ::methcla_boost::parameter::aux::yes_tag has_key(key_type*);
        using Next::has_key;

     private:
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _has_unique_key = ::methcla_boost::mp11::mp_bool<
#else
        typedef ::methcla_boost::mpl::bool_<
            ...
            ) == sizeof(::methcla_boost::parameter::aux::no_tag)
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        >;
#else
        > _has_unique_key;
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            get_default(D const&, ::methcla_boost::mp11::mp_false) const
#else
            get_default(D const&, ::methcla_boost::mpl::false_) const
#endif
        {
        ...
        inline BOOST_CONSTEXPR reference
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            get_default(D const& d, ::methcla_boost::mp11::mp_true) const
#else
            get_default(D const& d, ::methcla_boost::mpl::true_) const
#endif
        {
            return (
                this->arg.get_value()
     ...
     public:
        inline BOOST_CONSTEXPR reference
            operator[](::methcla_boost::parameter::keyword<key_type> const&) const
        {
    ...
    !BOOST_WORKAROUND(BOOST_MSVC, < 1910)
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::methcla_boost::parameter::aux::default_<key_type,Default> const& d
            ) const
        {
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::methcla_boost::parameter::aux::default_r_<key_type,Default> const& d
            ) const
        {
            return this->get_default(d, _holds_maybe());
        }
    ...
    !BOOST_WORKAROUND(BOOST_MSVC, < 1910)
        ...
        static typename ::methcla_boost::lazy_enable_if<
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            ::methcla_boost::mp11::mp_if<
                EmitsErrors
              ...
              , _has_unique_key
            >
          , ::methcla_boost::parameter::aux::augment_predicate_mp11<
#else
            typename ::methcla_boost::mpl::if_<
                EmitsErrors
              ...
              , _has_unique_key
            >::type
          , ::methcla_boost::parameter::aux::augment_predicate<
#endif
                Predicate
              , reference
              , key_type
        ...
        >::type
            satisfies(
                ::methcla_boost::parameter::aux::parameter_requirements<
                    key_type
                  , Predicate
                  , HasDefault
                >*
        ...
        inline BOOST_CONSTEXPR ::methcla_boost::parameter::aux::arg_list<
            ::methcla_boost::parameter::aux::tagged_argument<KW,T2>
          , self
        >
            operator,(
                ::methcla_boost::parameter::aux::tagged_argument<KW,T2> const& x
            ) const
        {
            return ::methcla_boost::parameter::aux::arg_list<
                ::methcla_boost::parameter::aux::tagged_argument<KW,T2>
              , self
            >(x, *this);
        }
        ...
        template <typename KW, typename T2>
        inline BOOST_CONSTEXPR ::methcla_boost::parameter::aux::arg_list<
            ::methcla_boost::parameter::aux::tagged_argument_rref<KW,T2>
          , self
        >
            operator,(
                ::methcla_boost::parameter::aux::tagged_argument_rref<KW,T2> const& x
            ) const
        {
            return ::methcla_boost::parameter::aux::arg_list<
                ::methcla_boost::parameter::aux::tagged_argument_rref<KW,T2>
    ...
    struct empty_arg_list
    {
        ...
        inline BOOST_CONSTEXPR empty_arg_list(
            BOOST_PP_ENUM_PARAMS(
              ...
              , ::methcla_boost::parameter::void_ BOOST_PP_INTERCEPT
            )
        )
        {
        }
        ...
        struct key_owner
        {
            ...
            struct apply
            {
                typedef ::methcla_boost::parameter::aux::empty_arg_list type;
            };
        };
...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    class arg_list : public Next
    {
     ...
     public:
        ...
        inline BOOST_CONSTEXPR arg_list(
            ...
            BOOST_PP_ENUM_BINARY_PARAMS(
              ...
              , ::methcla_boost::parameter::aux::void_reference()
            )
          , arg(a0)
        {
        }
     ...
     public:
            ...
            struct apply
            {
                typedef typename ::methcla_boost::mpl::eval_if<
                  ...
                  , ::methcla_boost::mpl::identity<
                        ::methcla_boost::parameter::aux::arg_list<TaggedArg,Next>
                    >
                  , ::methcla_boost::mpl::apply_wrap1<next_key_owner,KW>
                >::type type;
            };
        };
        ...
        // get() function.
        template <typename KW>
        inline BOOST_CONSTEXPR typename ::methcla_boost::mpl::apply_wrap3<
            binding
          , KW
          , ::methcla_boost::parameter::void_
          , ::methcla_boost::mpl::true_
        >::type
            operator[](::methcla_boost::parameter::keyword<KW> const& x) const
        {
            typename ::methcla_boost::mpl::apply_wrap1<key_owner,KW>::type const&
                sublist = *this;
        ...
        >::type
            operator[](
                ::methcla_boost::parameter::aux::default_<KW,Default> const& x
            ) const
        {
            typename ::methcla_boost::mpl::apply_wrap1<key_owner,KW>::type const&
                sublist = *this;
        ...
        // fails.
        inline BOOST_CONSTEXPR reference
            get(::methcla_boost::parameter::keyword<key_type> const&) const
        {
            BOOST_MPL_ASSERT_NOT((_holds_maybe));
            return this->arg.get_value();
        }
...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    struct arg_list_cons<>
    {
        using type = ::methcla_boost::parameter::aux::empty_arg_list;
    };

    template <typename ArgTuple0, typename ...Tuples>
    struct arg_list_cons<ArgTuple0,Tuples...>
    {
        using type = ::methcla_boost::parameter::aux::arg_list<
            typename ArgTuple0::tagged_arg
          , typename ::methcla_boost::parameter::aux::arg_list_cons<Tuples...>::type
    ...
    class flat_like_arg_list
      : public ::methcla_boost::parameter::aux::arg_list_cons<ArgTuples...>::type
    {
        using _base_type = typename ::methcla_boost::parameter::aux
     ...
     public:
        ...
        inline BOOST_CONSTEXPR ::methcla_boost::parameter::aux::flat_like_arg_list<
            ::methcla_boost::parameter::aux::flat_like_arg_tuple<
        ...
        {
            return ::methcla_boost::parameter::aux::flat_like_arg_list<
                ::methcla_boost::parameter::aux::flat_like_arg_tuple<
                    typename TaggedArg::base_type::key_type
                  , typename TaggedArg::base_type
                >
    ...
    template <>
    class flat_like_arg_list<>
      : public ::methcla_boost::parameter::aux::empty_arg_list
    {
        using _base_type = ::methcla_boost::parameter::aux::empty_arg_list;
...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    {
        typedef ::methcla_boost::mpl::forward_iterator_tag category;

        // The incremented iterator
        typedef ::methcla_boost::parameter::aux
    ...
    template <>
    struct arg_list_iterator< ::methcla_boost::parameter::aux::empty_arg_list>
    {
    };
}}} // namespace methcla_boost::parameter::aux
...
namespace methcla_boost { namespace mpl {
    ...
    template <>
    struct begin_impl< ::methcla_boost::parameter::aux::arg_list_tag>
    {
        template <typename S>
        struct apply
        {
            typedef ::methcla_boost::parameter::aux::arg_list_iterator<S> type;
        };
    };

    template <>
    struct end_impl< ::methcla_boost::parameter::aux::arg_list_tag>
    {
        template <typename>
        struct apply
        {
            typedef ::methcla_boost::parameter::aux::arg_list_iterator<
                ::methcla_boost::parameter::aux::empty_arg_list
            > type;
        };
    };
...
namespace methcla_boost { namespace mpl {
    ...
    template <>
    struct has_key_impl< ::methcla_boost::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
            typedef typename ::methcla_boost::mpl::if_<
                ::methcla_boost::is_void<
                    typename ::methcla_boost::parameter
...
namespace methcla_boost { namespace mpl {
    ...
    template <>
    struct count_impl< ::methcla_boost::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
            typedef typename ::methcla_boost::mpl::if_<
                ::methcla_boost::is_void<
                    ...
                    ::value_type<ArgList,Keyword,void>::type
                >
              , ::methcla_boost::mpl::int_<0>
              , ::methcla_boost::mpl::int_<1>
            >::type type;
        };
    };
}} // namespace methcla_boost::mpl
...
namespace methcla_boost { namespace mpl {
    ...
    template <>
    struct key_type_impl< ::methcla_boost::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
            typedef typename ::methcla_boost::mpl::eval_if<
                ...
                >
              , void
              , ::methcla_boost::mpl::identity<Keyword>
            >::type type;
        };
    };
}} // namespace methcla_boost::mpl
...
namespace methcla_boost { namespace mpl {
    ...
    template <>
    struct value_type_impl< ::methcla_boost::parameter::aux::arg_list_tag>
      : ::methcla_boost::mpl::key_type_impl< ::methcla_boost::parameter::aux::arg_list_tag>
    {
    };
}} // namespace methcla_boost::mpl
...
namespace methcla_boost { namespace mpl {
    ...
    template <>
    struct at_impl< ::methcla_boost::parameter::aux::arg_list_tag>
      : ::methcla_boost::mpl::key_type_impl< ::methcla_boost::parameter::aux::arg_list_tag>
    {
    };
}} // namespace methcla_boost::mpl
...
namespace methcla_boost { namespace mpl {
    ...
    template <>
    struct order_impl< ::methcla_boost::parameter::aux::arg_list_tag>
    {
        template <typename ArgList, typename Keyword>
        struct apply
        {
            typedef typename ::methcla_boost::mpl::find<ArgList,Keyword>::type Itr;
            typedef typename ::methcla_boost::mpl::eval_if<
                ::methcla_boost::is_void<
                    typename ::methcla_boost::parameter
                    ::value_type<ArgList,Keyword,void>::type
                >
              , ::methcla_boost::mpl::identity< ::methcla_boost::mpl::void_>
              , ::methcla_boost::mpl::distance<
                    Itr
                  , ::methcla_boost::parameter::aux::arg_list_iterator<
                        ::methcla_boost::parameter::aux::empty_arg_list
                    >
                >
            >::type type;
