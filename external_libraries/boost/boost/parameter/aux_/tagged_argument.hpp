...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
    using tagged_argument_type = ::methcla_boost::mp11::mp_if<
        ::methcla_boost::mp11::mp_if<
          ...
          , ::std::is_same<
            ...
            >
        >
      , ::methcla_boost::parameter::aux::error_lvalue_bound_to_consume_parameter
      , ::methcla_boost::mp11::mp_if<
            ::std::is_const<Arg>
          , ::methcla_boost::mp11::mp_if<
                ::std::is_same<
            ...
            >
          , ::methcla_boost::mp11::mp_identity<Arg>
        >
    >;
    ...
    struct tagged_argument_type
      : ::methcla_boost::mpl::eval_if<
            ::methcla_boost::is_same<
              ...
              , ::methcla_boost::parameter::out_reference
            >
          , ::methcla_boost::parameter::aux::error_const_lvalue_bound_to_out_parameter
          , ::methcla_boost::remove_const<Arg>
        >
    {
    };
...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    class tagged_argument
      : public ::methcla_boost::parameter::aux::tagged_argument_base
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using arg_type = typename ::methcla_boost::parameter::aux
        ::tagged_argument_type<Keyword,Arg>::type;
#else
        typedef typename ::methcla_boost::mpl::eval_if<
            typename ::methcla_boost::mpl::eval_if<
                ::methcla_boost::is_scalar<Arg>
          ...
          , ::methcla_boost::parameter::aux::error_lvalue_bound_to_consume_parameter
          , ::methcla_boost::mpl::eval_if<
                ::methcla_boost::is_const<Arg>
              , ::methcla_boost::parameter::aux::tagged_argument_type<Keyword,Arg>
              , ::methcla_boost::mpl::identity<Arg>
            >
        >::type arg_type;
#endif  // BOOST_PARAMETER_CAN_USE_MP11
     ...
     public:
        ...
        // a methcla_boost::function or a std::function. -- Cromwell D. Enage
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using value_type = ::methcla_boost::mp11::mp_if<
        ...
        typedef typename ::methcla_boost::mpl::if_<
            ::methcla_boost::is_function<arg_type>
#if defined(BOOST_NO_CXX11_HDR_FUNCTIONAL)
          , ::methcla_boost::function<arg_type>
#else
          , ::std::function<arg_type>
#endif
          , Arg
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using reference = ::methcla_boost::mp11::mp_if<
            ::std::is_function<arg_type>
          , value_type const&
          , Arg&
        >;
     ...
     public:
        ...
        struct binding
        {
            ...
            struct apply
              : ::methcla_boost::mpl::eval_if<
                  ...
                  , ::methcla_boost::mpl::identity<Default>
                >
            {
            };
        ...
        inline BOOST_CONSTEXPR ::methcla_boost::parameter::aux::arg_list<
          ...
          , ::methcla_boost::parameter::aux::arg_list<
                ::methcla_boost::parameter::aux::tagged_argument<Keyword2,Arg2>
            >
        >
            operator,(
                ::methcla_boost::parameter::aux
            ...
            ) const
        {
            ...
            >(
              ...
              , ::methcla_boost::parameter::aux::arg_list<
                    ::methcla_boost::parameter::aux::tagged_argument<Keyword2,Arg2>
                >(x, ::methcla_boost::parameter::aux::empty_arg_list())
            );
        }
        ...
        inline BOOST_CONSTEXPR ::methcla_boost::parameter::aux::arg_list<
            ::methcla_boost::parameter::aux::tagged_argument<Keyword,Arg>
          , ::methcla_boost::parameter::aux::arg_list<
                ::methcla_boost::parameter::aux::tagged_argument_rref<Keyword2,Arg2>
            >
        >
            operator,(
                ::methcla_boost::parameter::aux
        ...
        inline BOOST_CONSTEXPR reference
            operator[](::methcla_boost::parameter::keyword<Keyword> const&) const
        {
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::methcla_boost::parameter::aux::default_<key_type,Default> const&
            ) const
        {
            return this->get_value();
        }
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::methcla_boost::parameter::aux::default_r_<key_type,Default> const&
            ) const
        {
            return this->get_value();
        }
        ...
        inline BOOST_CONSTEXPR reference
            operator[](
                ::methcla_boost::parameter::aux::lazy_default<key_type,F> const&
            ) const
        {
            return this->get_value();
        }
        ...
        inline BOOST_CONSTEXPR Default&&
            operator[](
                ::methcla_boost::parameter::aux::default_r_<KW,Default> const& x
            ) const
        {
        ...
        typename ::methcla_boost::parameter::aux::result_of0<F>::type
            operator[](
                ::methcla_boost::parameter::aux::lazy_default<KW,F> const& x
            ) const
        {
        ...
        typename ::methcla_boost::mpl::apply_wrap1<Predicate,value_type>::type
            satisfies(
        ...
        typedef ::methcla_boost::parameter::aux::tagged_argument<Keyword,Arg> type;
        // For the benefit of iterators
        typedef ::methcla_boost::parameter::aux::empty_arg_list tail_type;
    ...
    using tagged_argument_rref_key = ::methcla_boost::mp11::mp_if<
        ::std::is_same<
            typename Keyword::qualifier
          , ::methcla_boost::parameter::out_reference
        >
      , ::methcla_boost::parameter::aux::error_rvalue_bound_to_out_parameter
      , ::methcla_boost::mp11::mp_identity<Keyword>
    >;
#endif
    ...
    struct tagged_argument_rref
      : ::methcla_boost::parameter::aux::tagged_argument_base
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using key_type = typename ::methcla_boost::parameter::aux
     ...
     public:
            ...
            ) const
        {
            ...
            >(
                *this
              , ::methcla_boost::parameter::aux::arg_list<
                    ::methcla_boost::parameter::aux::tagged_argument_rref<
                        Keyword2
                      , Arg2
                    >
                >(x, ::methcla_boost::parameter::aux::empty_arg_list())
...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    class tagged_argument
      : public ::methcla_boost::parameter::aux::tagged_argument_base
    {
        typedef typename ::methcla_boost::remove_const<Arg>::type arg_type;
     ...
     public:
        ...
        // Useful for argument lists with undetermined length.
        template <typename Keyword2, typename Arg2>
        inline ::methcla_boost::parameter::aux::arg_list<
            ::methcla_boost::parameter::aux::tagged_argument<Keyword,Arg>
          , ::methcla_boost::parameter::aux::arg_list<
                ::methcla_boost::parameter::aux::tagged_argument<Keyword2,Arg2>
            >
    ...
    struct tagged_argument_list_of_1 : public TaggedArg
    {
            ...
            operator,(TA2 const& x) const
        {
            ...
            >(
              ...
              , ::methcla_boost::parameter::aux::arg_list<typename TA2::base_type>(
