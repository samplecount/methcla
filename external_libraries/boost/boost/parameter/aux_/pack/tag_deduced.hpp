...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using type = ::methcla_boost::mp11::mp_list<
            ::methcla_boost::mp11::mp_apply_q<
                TagFn
              , ::methcla_boost::mp11::mp_list<
                    typename ::methcla_boost::parameter::aux::tag_type<Spec>::type
                  , Arg
                >
            >
#else
        typedef ::methcla_boost::mpl::pair<
            typename ::methcla_boost::mpl::apply_wrap2<
                TagFn
              , typename ::methcla_boost::parameter::aux::tag_type<Spec>::type
              , Arg
            >::type
#endif  // BOOST_PARAMETER_CAN_USE_MP11
          , typename ::methcla_boost::parameter::aux::insert_<
                UsedArgs
              , typename ::methcla_boost::parameter::aux::tag_type<Spec>::type
            >::type
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
