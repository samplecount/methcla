...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
    using make_items = ::methcla_boost::mp11::mp_if<
        ::std::is_same<Arg,::methcla_boost::parameter::void_>
      , ::methcla_boost::mp11::mp_identity< ::methcla_boost::parameter::void_>
      , ::methcla_boost::parameter::aux::make_item<Spec,Arg,Tail>
    >;
#else
    struct make_items
      : ::methcla_boost::mpl::eval_if<
            ::methcla_boost::is_same<Arg,::methcla_boost::parameter::void_>
