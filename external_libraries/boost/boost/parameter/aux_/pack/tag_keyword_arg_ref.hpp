...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    struct tag_ref<Keyword,ActualArg,::methcla_boost::mpl::false_>
    {
...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    struct tag_keyword_arg_ref
    {
        ...
        struct apply
        {
            typedef typename ::methcla_boost::parameter::aux::tag_ref<K,T>::type type;
        };

#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        template <typename K, typename T>
        using fn = typename ::methcla_boost::parameter::aux::tag_ref<K,T>::type;
#endif
    };
