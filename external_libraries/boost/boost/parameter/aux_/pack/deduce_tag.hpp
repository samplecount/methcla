...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    struct deduce_tag_condition_mpl
      : ::methcla_boost::mpl::apply_wrap2<
            typename ::methcla_boost::mpl::lambda<
                Predicate
...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    struct deduce_tag_condition_mp11
    {
        using type = ::methcla_boost::mp11::mp_apply_q<
            Predicate
          , ::methcla_boost::mp11::mp_list<Argument,ArgumentPack>
        >;
    };

    template <typename Predicate, typename Argument, typename ArgumentPack>
    using deduce_tag_condition = ::methcla_boost::mp11::mp_if<
    ...
    class deduce_tag0
    {
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        typedef typename ::methcla_boost::parameter::aux::deduce_tag_condition<
            typename _spec::predicate
#else
        typedef typename ::methcla_boost::mpl::apply_wrap2<
            typename ::methcla_boost::mpl::lambda<
                typename _spec::predicate
              , ::methcla_boost::parameter::aux::lambda_tag
            >::type
        ...
        BOOST_MPL_ASSERT((
            typename ::methcla_boost::mpl::eval_if<
                typename ::methcla_boost::parameter::aux::has_key_<
                    UsedArgs
                  , typename ::methcla_boost::parameter::aux::tag_type<_spec>::type
                >::type
...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    struct deduce_tag
      ...
      : ::methcla_boost::mp11::mp_if<
            ::std::is_same<DeducedArgs,::methcla_boost::parameter::void_>
          , ::methcla_boost::mp11::mp_identity<
                ::methcla_boost::mp11::mp_list< ::methcla_boost::parameter::void_,UsedArgs>
            >
#else
      : ::methcla_boost::mpl::eval_if<
            ::methcla_boost::is_same<DeducedArgs,::methcla_boost::parameter::void_>
          , ::methcla_boost::mpl::pair< ::methcla_boost::parameter::void_,UsedArgs>
#endif
          , ::methcla_boost::parameter::aux::deduce_tag0<
                Argument
              , ArgumentPack
              , DeducedArgs
              , UsedArgs
