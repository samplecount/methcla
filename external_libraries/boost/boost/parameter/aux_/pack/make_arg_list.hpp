...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    {
        using type = ::methcla_boost::mp11::mp_push_front<
            ArgumentPack
...
#endif
    {
        ...
        >::type;
        using _is_tagged = ::methcla_boost::parameter::aux
        ::is_named_argument<_argument>;
#else
        typedef typename ::methcla_boost::remove_const<
            typename ::methcla_boost::remove_reference<_argument>::type
        >::type _arg_type;
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _is_positional = ::methcla_boost::mp11::mp_if<
            IsPositional
          , ::methcla_boost::mp11::mp_if<
                ::methcla_boost::parameter::aux::is_deduced<_parameter_spec>
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _used_args = typename ::methcla_boost::mp11::mp_if<
            _is_tagged
          , ::methcla_boost::parameter::aux::insert_tagged<UsedArgs,_arg_type>
          , ::methcla_boost::mp11::mp_identity<UsedArgs>
        >::type;
#else
        typedef typename ::methcla_boost::mpl::eval_if<
            _is_tagged
          , ::methcla_boost::parameter::aux::insert_tagged<UsedArgs,_arg_type>
          , ::methcla_boost::mpl::identity<UsedArgs>
        >::type _used_args;
#endif
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _deduced_data = typename ::methcla_boost::mp11::mp_if<
            ::methcla_boost::mp11::mp_if<
                _is_tagged
              , ::methcla_boost::mp11::mp_true
              , _is_positional
          ...
          , ::methcla_boost::mp11::mp_identity<
                ::methcla_boost::mp11::mp_list< ::methcla_boost::parameter::void_,_used_args>
            >
#else
        typedef typename ::methcla_boost::mpl::eval_if<
            typename ::methcla_boost::mpl::if_<
              ...
              , _is_positional
            >::type
          , ::methcla_boost::mpl::pair< ::methcla_boost::parameter::void_,_used_args>
#endif
          , ::methcla_boost::parameter::aux::deduce_tag<
                _argument
              , ArgumentPack
              , DeducedArgs
              , _used_args
        ...
        using _tagged = ::methcla_boost::mp11::mp_if<
            _is_tagged
            // ... just use it
          , _arg_type
            // ... else ...
          , ::methcla_boost::mp11::mp_if<
              ...
              , ::methcla_boost::mp11::mp_apply_q<
                    TagFn
                  , ::methcla_boost::mp11::mp_list<_tag,_argument>
                >
                // ... else, use the deduced tag
              , ::methcla_boost::mp11::mp_at_c<_deduced_data,0>
            >
        >;
#else   // !defined(BOOST_PARAMETER_CAN_USE_MP11)
        // If this parameter is explicitly tagged ...
        typedef typename ::methcla_boost::mpl::eval_if<
            _is_tagged
            // ... just use it
          , ::methcla_boost::mpl::identity<_arg_type>
            // ... else ...
          , ::methcla_boost::mpl::eval_if<
                // if positional matching is turned on ...
                _is_positional
                // ... tag it positionally
              , ::methcla_boost::mpl::apply_wrap2<TagFn,_tag,_argument>
                // ... else, use the deduced tag
              , ::methcla_boost::mpl::first<_deduced_data>
            >
        >::type _tagged;
#endif  // BOOST_PARAMETER_CAN_USE_MP11
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _error = ::methcla_boost::mp11::mp_if<
            ::methcla_boost::mp11::mp_if<
                ::std::is_same<Error,::methcla_boost::parameter::void_>
              , ::std::is_same<_tagged,::methcla_boost::parameter::void_>
              , ::methcla_boost::mp11::mp_false
            >
#else
        typedef typename ::methcla_boost::mpl::if_<
            typename ::methcla_boost::mpl::if_<
                ::methcla_boost::is_same<Error,::methcla_boost::parameter::void_>
              , ::methcla_boost::is_same<_tagged,::methcla_boost::parameter::void_>
              , ::methcla_boost::mpl::false_
            >::type
#endif
          , ::methcla_boost::parameter::aux::unmatched_argument<_argument>
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using _argument_pack = typename ::methcla_boost::mp11::mp_if<
            ::std::is_same<_tagged,::methcla_boost::parameter::void_>
          , ::methcla_boost::mp11::mp_identity<ArgumentPack>
        ...
        typedef typename ::methcla_boost::mpl::if_<
          ...
          , ::methcla_boost::parameter::aux::arg_list<_tagged,ArgumentPack>
#else
          , ::methcla_boost::parameter::aux
     ...
     public:
        typedef typename ::methcla_boost::parameter::aux::make_arg_list_aux<
            typename List::tail
          , DeducedArgs
          , TagFn
          , _is_positional
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
          , ::methcla_boost::mp11::mp_at_c<_deduced_data,1>
#else
    ...
    struct make_arg_list0
    {
        typedef typename ::methcla_boost::mpl::eval_if<
          ...
          , ::methcla_boost::parameter::aux::make_arg_list00<
                List
              , DeducedArgs
              , TagFn
              , IsPositional
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
      : ::methcla_boost::mp11::mp_if<
            ::std::is_same<List,::methcla_boost::parameter::void_>
          , ::methcla_boost::mp11::mp_identity<
                ::methcla_boost::mp11::mp_list<ArgumentPack,Error>
            >
#else
      : ::methcla_boost::mpl::eval_if<
            ::methcla_boost::is_same<List,::methcla_boost::parameter::void_>
          , ::methcla_boost::mpl::identity< ::methcla_boost::mpl::pair<ArgumentPack,Error> >
#endif
          , ::methcla_boost::parameter::aux::make_arg_list0<
                List
              , DeducedArgs
              , TagFn
              , IsPositional
...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    >
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
    using make_arg_list = ::methcla_boost::parameter::aux::make_arg_list_aux<
#else
    struct make_arg_list
      : ::methcla_boost::parameter::aux::make_arg_list_aux<
#endif
            List
          , DeducedArgs
          , TagFn
          ...
          , ::methcla_boost::mpl::true_
#endif
          , ::methcla_boost::parameter::aux::set0
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
          , ::methcla_boost::parameter::aux::flat_like_arg_list<>
#else
