...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    {
        typedef ::methcla_boost::parameter::aux::parameter_requirements<
            typename ::methcla_boost::parameter::aux::tag_type<ParameterSpec>::type
          , typename ::methcla_boost::parameter::aux::predicate<ParameterSpec>::type
          , ::methcla_boost::parameter::aux::has_default<ParameterSpec>
        > type;
    };
