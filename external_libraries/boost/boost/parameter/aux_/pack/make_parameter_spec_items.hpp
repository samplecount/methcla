...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    {
        typedef ::methcla_boost::parameter::void_ type;
    };
}}} // namespace methcla_boost::parameter::aux
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            ::methcla_boost::mp11::mp_front<SpecSeq>
#else
            typename ::methcla_boost::mpl::front<SpecSeq>::type
#endif
          , ::methcla_boost::parameter::aux::make_deduced_list<
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
                ::methcla_boost::mp11::mp_pop_front<SpecSeq>
#else
                typename ::methcla_boost::mpl::pop_front<SpecSeq>::type
#endif
            >
        >
    {
...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    struct make_deduced_list
      ...
      : ::methcla_boost::mp11::mp_if<
            ::methcla_boost::mp11::mp_empty<SpecSeq>
          , ::methcla_boost::mp11::mp_identity< ::methcla_boost::parameter::void_>
#else
      : ::methcla_boost::mpl::eval_if<
            ::methcla_boost::mpl::empty<SpecSeq>
          , ::methcla_boost::mpl::identity< ::methcla_boost::parameter::void_>
#endif
          , ::methcla_boost::parameter::aux::make_deduced_list_not_empty<SpecSeq>
        >
    {
    };
}}} // namespace methcla_boost::parameter::aux
    ...
    struct is_arg_pack_error_void
      : ::methcla_boost::mpl::if_<
            ::methcla_boost::is_same<
                typename ::methcla_boost::mpl::second<ArgumentPackAndError>::type
...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    template <typename ArgumentPackAndError, typename SpecSeq>
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
    using match_parameters_base_cond = ::methcla_boost::mp11::mp_if<
        ::methcla_boost::mp11::mp_empty<SpecSeq>
      , ::std::is_same<
            ::methcla_boost::mp11::mp_at_c<ArgumentPackAndError,1>
          , ::methcla_boost::parameter::void_
        >
      , ::methcla_boost::parameter::aux::match_parameters_base_cond_helper<
...
namespace methcla_boost { namespace parameter { namespace aux {
    ...
    struct match_parameters_base_cond_helper
      ...
      : ::methcla_boost::mpl::eval_if<
#endif
            ::methcla_boost::parameter::aux::satisfies_requirements_of<
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
                ::methcla_boost::mp11::mp_at_c<ArgumentPackAndError,0>
              , ::methcla_boost::mp11::mp_front<SpecSeq>
#else
                typename ::methcla_boost::mpl::first<ArgumentPackAndError>::type
              , typename ::methcla_boost::mpl::front<SpecSeq>::type
#endif
            >
          , ::methcla_boost::parameter::aux::match_parameters_base_cond<
                ArgumentPackAndError
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
              , ::methcla_boost::mp11::mp_pop_front<SpecSeq>
#else
    ...
    template <typename SpecSeq, typename ...Args>
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
    using make_parameter_spec_items = ::methcla_boost::mp11::mp_if<
        ::methcla_boost::mp11::mp_empty<SpecSeq>
      , ::methcla_boost::mp11::mp_identity< ::methcla_boost::parameter::void_>
      , ::methcla_boost::parameter::aux
...
#endif
          , A0
          , ::methcla_boost::parameter::aux::make_parameter_spec_items<
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
                ::methcla_boost::mp11::mp_pop_front<SpecSeq>
#else
                typename ::methcla_boost::mpl::pop_front<SpecSeq>::type
