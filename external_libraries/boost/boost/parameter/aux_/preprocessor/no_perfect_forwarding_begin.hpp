...
//         , ... methcla_boost::mpl::identity<methcla_boost::parameter::aux::empty_arg_list>
//    ...>
//   >
...
#define BOOST_PARAMETER_template_args(z, n, prefix)                          \
    typename BOOST_PP_CAT(prefix, n) = ::methcla_boost::parameter::void_
/**/
...
#define BOOST_PARAMETER_make_arg_items_R(r, prefix, i, elem)                 \
    ::methcla_boost::parameter::aux::item<BOOST_PP_CAT(prefix, i),                   \
...
#define BOOST_PARAMETER_function_call_arg_list_R(r, seq)                     \
    ::methcla_boost::parameter::aux::make_arg_list<                                  \
