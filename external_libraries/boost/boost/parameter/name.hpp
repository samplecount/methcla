...
#define BOOST_PARAMETER_NAME_TAG(tag_namespace, tag, q)                      \
    ...
    {                                                                        \
        ...
        {                                                                    \
            ...
            using qualifier = ::methcla_boost::parameter::q;                         \
        };                                                                   \
    }
/**/
...
#define BOOST_PARAMETER_NAME_TAG(tag_namespace, tag, q)                      \
    ...
    {                                                                        \
        ...
        {                                                                    \
            ...
            typedef ::methcla_boost::parameter::q qualifier;                         \
        };                                                                   \
    }
/**/
...
#define BOOST_PARAMETER_NAME_KEYWORD(tag_namespace, tag, name)               \
    namespace                                                                \
    {                                                                        \
        ::methcla_boost::parameter::keyword<tag_namespace::tag> const& name          \
            = ::methcla_boost::parameter::keyword<tag_namespace::tag>::instance;     \
    }
/**/
