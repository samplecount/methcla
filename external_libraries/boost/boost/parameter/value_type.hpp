...
namespace methcla_boost { namespace parameter {
    ...
    struct value_type0
    {
        ...
        using type = ::methcla_boost::mp11::mp_apply_q<
          ...
          , ::methcla_boost::mp11::mp_list<Keyword,Default,::methcla_boost::mp11::mp_false>
        >;
...
namespace methcla_boost { namespace parameter {
    ...
    struct value_type
      ...
      : ::methcla_boost::mpl::eval_if<
          ...
          , ::methcla_boost::parameter::value_type0<Parameters,Keyword,Default>
        >
#endif
    {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        using type = typename ::methcla_boost::mp11::mp_if<
          ...
          , ::methcla_boost::mp11::mp_if<
              ...
              , ::methcla_boost::parameter::value_type1<Parameters,Keyword,Default>
              , ::methcla_boost::parameter::value_type0<Parameters,Keyword,Default>
            >
        >::type;
#endif
