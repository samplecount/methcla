...
#define BOOST_PARAMETER_VARIADIC_MPL_SEQUENCE ::methcla_boost::mp11::mp_list
#else
...
#define BOOST_PARAMETER_VARIADIC_MPL_SEQUENCE ::methcla_boost::fusion::list
#else
...
#include <boost/fusion/mpl.hpp>
#define BOOST_PARAMETER_VARIADIC_MPL_SEQUENCE ::methcla_boost::fusion::deque
#else
#include <boost/mpl/vector.hpp>
#define BOOST_PARAMETER_VARIADIC_MPL_SEQUENCE ::methcla_boost::mpl::vector
    ...
    struct parameters
    {
        ...
        struct match_base
          ...
          : ::methcla_boost::mpl::if_<
                typename ::methcla_boost::parameter::aux::match_parameters_base_cond<
                    ArgumentPackAndError
                  , parameter_spec
                >::type
              , ::methcla_boost::mpl::identity<
                    ::methcla_boost::parameter::parameters<Spec...>
                >
              , ::methcla_boost::parameter::void_
            >
#endif
        ...
        struct match
          : ::methcla_boost::parameter::parameters<Spec...>
            ::BOOST_NESTED_TEMPLATE match_base<
                typename ::methcla_boost::parameter::aux::make_arg_list<
                    typename ::methcla_boost::parameter::aux
                    ::make_parameter_spec_items<parameter_spec,Args...>::type
                  , deduced_list
                  , ::methcla_boost::parameter::aux::tag_keyword_arg
        ...
        struct bind
#if !defined(BOOST_PARAMETER_CAN_USE_MP11)
          : ::methcla_boost::mpl::first<
                typename ::methcla_boost::parameter::aux::make_arg_list<
                    typename ::methcla_boost::parameter::aux
                    ::make_parameter_spec_items<parameter_spec,Args...>::type
                  , deduced_list
                  , ::methcla_boost::parameter::aux::tag_template_keyword_arg
                >::type
            >
#endif
        {
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            using type = ::methcla_boost::mp11::mp_at_c<
                typename ::methcla_boost::parameter::aux::make_arg_list<
                    typename ::methcla_boost::parameter::aux
                    ::make_parameter_spec_items<parameter_spec,Args...>::type
                  , deduced_list
        ...
        inline ::methcla_boost::parameter::aux::empty_arg_list operator()() const
        {
            return ::methcla_boost::parameter::aux::empty_arg_list();
        }

        template <typename A0, typename ...Args>
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
        inline ::methcla_boost::mp11::mp_at_c<
#else
        inline typename ::methcla_boost::mpl::first<
#endif
            typename ::methcla_boost::parameter::aux::make_arg_list<
                typename ::methcla_boost::parameter::aux
        ...
        {
            typedef typename ::methcla_boost::parameter::aux::make_arg_list<
                typename ::methcla_boost::parameter::aux
                ::make_parameter_spec_items<parameter_spec,A0,Args...>::type
              , deduced_list
              , ::methcla_boost::parameter::aux::tag_keyword_arg
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
            using result_type = ::methcla_boost::mp11::mp_at_c<list_error_pair,0>;

            using error = ::methcla_boost::mp11::mp_at_c<list_error_pair,1>;
#else
            typedef typename ::methcla_boost::mpl
...
namespace methcla_boost { namespace parameter {
    ...
    struct parameters
    {
        typedef typename BOOST_PARAMETER_build_deduced_list(
            BOOST_PARAMETER_MAX_ARITY
          , ::methcla_boost::parameter::aux::make_deduced_items
          , PS
        )::type deduced_list;
    ...
    !BOOST_WORKAROUND(BOOST_BORLANDC, BOOST_TESTED_AT(0x592))
        ...
        struct match_base
          : ::methcla_boost::mpl::if_<
              ...
              , ::methcla_boost::mpl::identity<
                    ::methcla_boost::parameter::parameters<
    ...
    !BOOST_WORKAROUND(BOOST_BORLANDC, BOOST_TESTED_AT(0x592))
            ...
            >::BOOST_NESTED_TEMPLATE match_base<
                typename ::methcla_boost::parameter::aux::make_arg_list<
                    typename BOOST_PARAMETER_build_arg_list(
                        BOOST_PARAMETER_MAX_ARITY
                      , ::methcla_boost::parameter::aux::make_items
                      , PS
                      , A
                    )::type
                  , deduced_list
...
#else
        {
            typedef ::methcla_boost::parameter::parameters<
                BOOST_PP_ENUM_PARAMS(BOOST_PARAMETER_MAX_ARITY, PS)
            > type;
        };
#endif  // SFINAE enabled, not Borland
        ...
        struct bind
        {
            ...
            typedef typename ::methcla_boost::mpl::first<result>::type type;
        };
...
#include BOOST_PP_ITERATE()
        ...
        inline typename ::methcla_boost::mpl::first<
            typename ::methcla_boost::parameter::aux::make_arg_list<
                ::methcla_boost::parameter::aux::item<
                    PS0,A0
                >
              , deduced_list
              , ::methcla_boost::parameter::aux::tag_keyword_arg_ref
            >::type
        >::type
            operator()(A0& a0) const
        {
            ...
            typedef typename ::methcla_boost::mpl::first<result>::type result_type;
            typedef typename ::methcla_boost::mpl::second<result>::type error;
            error();
            ...
            return result_type(
                ...
                BOOST_PP_ENUM_TRAILING_PARAMS(
                  ...
                  , ::methcla_boost::parameter::aux::void_reference() BOOST_PP_INTERCEPT
                )
            );
        }
