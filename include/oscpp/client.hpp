...
namespace OSCPP { namespace Client {
    ...
    public:
        ...
        /*!
         */
        Packet(void* buffer, size_t size) { reset(buffer, size); }
         ...
         */
        size_t size() const { return m_args.consumed(); }
        ...
        void reset() { reset(m_buffer, m_capacity); }
    ...
    public:
        ...
        ~DynamicPacket() { delete[] static_cast<char*>(data()); }
    };
